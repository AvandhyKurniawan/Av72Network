        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1-1" data-toggle="tab" onclick="INTERNETPACKAGEDATA.ajax.reload(null, false);">Daftar Data Paket Internet</a></li>
              <li><a href="#tab_2-2" data-toggle="tab">Tambah Data Paket Internet</a></li>
