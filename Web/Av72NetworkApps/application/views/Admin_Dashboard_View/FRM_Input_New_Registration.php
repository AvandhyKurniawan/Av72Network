        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1-1" data-toggle="tab" onclick="CLIENTREGISTRATIONDATA.ajax.reload(null, false);">Daftar Data Pelanggan</a></li>
              <li><a href="#tab_2-2" data-toggle="tab">Tambah Data Pelanggan</a></li>
              <li class="pull-right header"><i class="fa fa-th"></i> Menu Data Pelanggan</li>
            </ul>
