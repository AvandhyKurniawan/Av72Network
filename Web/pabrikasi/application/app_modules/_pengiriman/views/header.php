          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              ...
              <div class="form-group" style="text-align: center; width: 100%; display: flex; justify-content: center;">
                <button class="btn btn-md btn-flat btn-primary" id="btnKirimParsial" onclick="kirimBarangParsial()" style="float:left; width:130px;"><i class="fa fa-send"></i> Kirim</button>
              </div>
            </div>
