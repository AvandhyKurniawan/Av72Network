                  ...
                  <div class="col-md-12">
                    <table class="table table-responsive" style="margin-bottom:0;">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtJumlahPayungKuning" class="form-control number" placeholder="Masukan Jumlah Payung Kuning">
                          </div>
                        </td>
                      </tr>
                    </table>
              ...
              <div class="modal-body">
                <table class="table table-responsive">
                  ...
                  <!-- <tr class="hiddenRow" style="display: none;">
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" class="form-control number" id="txtBerat">
                      </div>
                    </td>
                  </tr>
                  <tr class="hiddenRow" style="display: none;">
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" class="form-control number" id="txtBobin">
                      </div>
                    </td>
                  </tr>
                  <tr class="hiddenRow" style="display: none;">
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" class="form-control number" id="txtPayung">
                      </div>
                    </td>
                  </tr>
                  <tr class="hiddenRow" style="display: none;">
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" class="form-control number" id="txtPayungKuning">
                      </div>
                    </td>
                  </tr> -->
                  <!-- <tr>
