    ...
    <div>
      ...
      <table style="border:1px solid #4a4a4a; font-size:12pt;" width='100%'>
        ...
        foreach ($ListBon as $value) {
          if($value["kd_gd_roll"] != $value["kd_gd_roll_tumpuk"]){
            ...
            }else if($value["warna_plastik"]=="pink"){
              $arrValue["Pink"] += floatval($value["apal"]);
            }else{
      ...
      <div class="wrapper">
          ...
          <ul>
            ...
            foreach ($ListTotalSubBon as $value) {
              if($value["jenis"]=="STRIP" || $value["jenis"]=="STRIP"){
                ...
                if($value["sub_jenis"]=="PUTIH POLOS"){
            ...
            <li><label id="liPink">Pink = <?php echo $arrValue["Pink"]; ?></label></li>
            <?php if ($jenis == "POLOS") {?>
        ...
        <div class="col-md-4">
          <ul>
            ...
            <li>
              <label id="liPutih">
                Putih = <?php echo abs($arrValue["Putih"]); ?>
              </label>
            </li>
          </ul>
        </div>
