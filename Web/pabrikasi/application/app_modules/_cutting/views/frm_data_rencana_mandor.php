<div class="content-wrapper">
  <section class="content-header">
    ...
    <section class="content">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <table class="table table-responsive">
                    ...
                    <tr id="apalLainnya" style="display:none;">
                      <td>Apal Lainnya</td>
                      <td>:</td>
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" id="txtJumlahApalLainnya" class="form-control number" placeholder="Masukan Jumlah Apal">
                        </div>
                      </td>
                    </tr>
                    <tr>
      ...
      <div class="modal fade" id="modalCopyRencana" role="dialog" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" data-target="#modalCopyRencana">&times;</button>
              <h4 class="modal-title text-blue">Copy Rencana</h4>
            </div>
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-responsive">
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" class="form-control" id="txtKodeRencanaCopyDST" readonly>
                          <input type="hidden" id="txtKodeRencanaCopySRC" value="">
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <div class="input-group date">
                            <input type="text" class="form-control" id="txtTglRencanaCopy" placeholder="Pilih Tanggal Rencana" readonly>
                            <div class="input-group-addon">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" class="form-control number" id="txtJumlahMesinCopy" value="">
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" class="form-control" id="txtNomorMesinCopy" value="">
                        </div>
                      </td>
                    </tr>
                  </table>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-primary" onclick="saveCopyRencana()"><i class="fa fa-check"></i> Simpan</button>
            </div>
          </div>
        </div>
      </div>
