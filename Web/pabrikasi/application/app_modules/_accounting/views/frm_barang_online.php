      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <button type="button" class="btn btn-md btn-flat btn-primary margin" data-toggle="modal" data-target="#modalCariHistoryBarangKanvas" data-backdrop="static" onclick="modalCariHistoryOnline()"><i class="fa fa-search"></i> Cari History</button>
          </div>
