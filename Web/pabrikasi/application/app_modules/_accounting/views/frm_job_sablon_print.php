...
<table width="100%" border="1">
  <thead>
    ...
    <th>Hasil Lembar</th>
    <th>Hasil Berat</th>
    <th>Pengambilan Lembar</th>
    <th>Pengambilan Berat</th>
    <th>Kembalian Lembar</th>
    <th>Kembalian Berat</th>
  </thead>
  <tbody>
    <?php foreach ($Data as $arrValue): ?>
      <tr>
        ...
        <td><?php echo number_format($arrValue["lembar_pengambilan"],0); ?></td>
        <td><?php echo number_format($arrValue["berat_pengambilan"],2); ?></td>
        <td><?php echo number_format($arrValue["lembar_kembalian"],0); ?></td>
        <td><?php echo number_format($arrValue["berat_kembalian"],2); ?></td>
      </tr>
    <?php endforeach; ?>
  </tbody>
</table>
