...
//================================ MODAL METHOD (START) ============================//
        ...
        function modalCariHistoryKanvas(){
          $("input").empty();
          $(".date").datepicker("setDate",null);
          $("#listBarangKanvas").select2({
              placeholder : "Pilih Ukuran Kanvas",
              dropdownParent : $("#modalCariHistoryBarangKanvas"),
              width : "100%",
              cache:true,
              allowClear:true,
              ajax:{
                url : "<?php echo base_url(); ?>_accounting/main/getBarangKanvas",
                dataType : "JSON",
                delay : 0,
        ...
        function modalCariHistoryOnline(){
          $("input").empty();
          $(".date").datepicker("setDate",null);
          $("#listBarangKanvas").select2({
              placeholder : "Pilih Ukuran Kanvas",
              ...
              allowClear:true,
              ajax:{
                url : "<?php echo base_url(); ?>_accounting/main/getBarangOnline",
                dataType : "JSON",
                delay : 0,
                processResults : function(data){
                  return{
...
//================================ SEARCH METHOD (START) ============================//
        ...
        function searchHistoryBarangKanvas(){
          var tglAwal  = $("#txtTglAwal").val();
          var tglAkhir = $("#txtTglAkhir").val();
          var kd_gd_hasil = $("#listBarangKanvas").val();
          ...
          if (!tglAwal||!tglAkhir||!kd_gd_hasil) {
            ...
            datatableListBarangKanvasMasuk(tglAwal,tglAkhir,kd_gd_hasil)
            datatableListBarangKanvasKeluar(tglAwal,tglAkhir,kd_gd_hasil)
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url("_accounting/main/saldoAwalKanvas")?>",
              data : {tglAwal:tglAwal,tglAkhir:tglAkhir,kd_gd_hasil:kd_gd_hasil},
              dataType : "JSON",
              success:function(response){
                $("#modalCariHistoryBarangKanvas").modal("hide");
                $(".date").datepicker("setDate",null);
                $("input").empty();
                $("#listBarangKanvas").empty();
                if (response["totalLembarMasuk"]==null||response["totalBeratMasuk"]==null) {
                ...
                $("#dataAwalBerat").text(parseFloat(response["saldoAwalBerat"]).toLocaleString());
                $("#dataAwalLembar").text(parseFloat(response["saldoAwalLembar"]).toLocaleString());
                $("#totalBeratMasuk").text(parseFloat(response["saldoMasukBerat"]).toLocaleString());
                $("#totalLembarMasuk").text(parseFloat(response["saldoMasukLembar"]).toLocaleString());
                $("#totalBeratKeluar").text(parseFloat(response["saldoKeluarBerat"]).toLocaleString());
                $("#totalLembarKeluar").text(parseFloat(response["saldoKeluarLembar"]).toLocaleString());
                $("#saldoLembarAkhir").text(parseFloat(response["saldoAkhirBerat"]).toLocaleString());
                $("#saldoBeratAkhir").text(parseFloat(response["saldoAkhirLembar"]).toLocaleString());
              }
            });
          }
        }
...
//================================ DATATABLE METHOD (START) ============================//
              ...
              $.each(response, function(AvIndex, AvValue){
                $("#tableListJobSablon > tbody:last-child").append(
                  "<tr>"+
                    ...
                    "<td>"+parseFloat(AvValue.lembar_pengambilan).toLocaleString()+"</td>"+
                    "<td>"+parseFloat(AvValue.berat_pengambilan).toLocaleString()+"</td>"+
                    "<td>"+parseFloat(AvValue.lembar_kembalian).toLocaleString()+"</td>"+
                    "<td>"+parseFloat(AvValue.berat_kembalian).toLocaleString()+"</td>"+
                  "</tr>"
                );
              })
            },
      ...
      function tableListHistoryGudangSparePart(param1, param2){
        ...
        function datatableListBarangKanvasMasuk(param1,param2,param3){
          $("#tableDataBarangSablonMasuk").dataTable().fnDestroy();
          $("#tableDataBarangSablonMasuk").dataTable({
            // "fixedHeader" : true,
            "autoWidth" : false,
            ...
            "bServerSide" : true,
            "sPaginationType": "full_numbers",
            "sAjaxSource":"<?php echo base_url(); ?>_accounting/main/getListDataBarangKanvasMasuk",
            "columns":[
              {"data" : "kd_gd_hasil","name":"kd_gd_hasil"},
              {"data" : "tgl_transaksi","name":"tgl_transaksi"},
              {"data" : "jumlah_berat","name":"jumlah_berat"},
        ...
        function datatableListBarangKanvasKeluar(param1,param2,param3){
          $("#tableDataBarangSablonKeluar").dataTable().fnDestroy();
          $("#tableDataBarangSablonKeluar").dataTable({
            // "fixedHeader" : true,
            "autoWidth" : false,
            ...
            "bServerSide" : true,
            "sPaginationType": "full_numbers",
            "sAjaxSource":"<?php echo base_url(); ?>_accounting/main/getListDataBarangKanvasKeluar",
            "columns":[
              {"data" : "kd_gd_hasil","name":"kd_gd_hasil"},
              {"data" : "tgl_transaksi","name":"tgl_transaksi"},
              {"data" : "jumlah_berat","name":"jumlah_berat"},
