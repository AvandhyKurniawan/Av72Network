<div class="content-wrapper">
  ...
  <section class="content">
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <button type="button" class="btn btn-md btn-flat btn-primary margin" data-toggle="modal" data-target="#modalCariHistoryBarangKanvas" data-backdrop="static" onclick="modalCariHistoryKanvas()"><i class="fa fa-search"></i> Cari History</button>
          </div>
          <div class="box-body" style="display: none;">
            ...
            <h3 class="box-title text-center">Detail Barang Masuk Kanvas</h3>
                ...
                <h3 class="box-title text-center">Detail Barang Keluar Kanvas</h3>
    ...
    <div class="modal fade" id="modalCariHistoryBarangKanvas" role="dialog" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
              ...
              <div class="col-md-12">
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group">
                        <select class="form-control" id="listBarangKanvas">
          ...
          <div class="modal-footer">
            <button type="button" id="btnCariHistory" class="btn btn-md btn-flat btn-success" onclick="searchHistoryBarangKanvas()"><i class="fa fa-search"></i> Cari</button>
          </div>
        </div>
      </div>
    </div>
