              ...
              <div class="col-md-12">
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" id="txtShift" class="form-control" placeholder="Masukan Shift" autocomplete="off">
                      </div>
                    </td>
                  </tr>
                  <tr>
                ...
                <table class="table table-responsive">
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <div class="input-group date">
                          <input type="text" id="txtTanggalCari" class="form-control" placeholder="Pilih Tanggal" readonly autocomplete="off">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                        </div>
