              ...
              <div class="col-md-12">
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" id="txtJumlahPermintaan" class="form-control number" placeholder="Masukan Jumlah Permintaan (KG)" autocomplete="off">
                      </div>
                    </td>
                  </tr>
                </table>
                ...
                <table class="table table-responsive">
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <div class="input-group date">
                          <input type="text" id="txtTanggalTambah" class="form-control" placeholder="Pilih Tanggal" readonly autocomplete="off">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" id="txtJumlahPermintaanBaru" class="form-control number" placeholder="Masukan Jumlah Permintaan (KG)" autocomplete="off">
                      </div>
                    </td>
                  </tr>
                </table>
                ...
                <table class="table table-responsive">
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <div class="input-group date">
                          <input type="text" id="txtTanggalAwal" class="form-control" placeholder="Pilih Tanggal Awal" readonly autocomplete="off">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <div class="input-group date">
                          <input type="text" id="txtTanggalAkhir" class="form-control" placeholder="Pilih Tanggal Akhir" readonly autocomplete="off">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                        </div>
