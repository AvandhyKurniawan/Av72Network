              ...
              <div class="col-md-12">
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" id="txtJumlah" class="form-control number" placeholder="Masukan Jumlah Kembalian (KG)" autocomplete="off">
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <div class="input-group date">
                          <input type="text" id="txtTanggal" class="form-control" placeholder="Pilih Tanggal Pengembalian" readonly autocomplete="off">
