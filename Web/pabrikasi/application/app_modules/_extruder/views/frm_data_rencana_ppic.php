                  ...
                  <div class="col-md-12">
                    <table class="table table-responsive">
                      <tr>
                        ...
                        <td>
                          <div class="form-group">
                            <input type="text" id="txtPermintaan" class="form-control number" style="width:80%; float:left;" readonly autocomplete="off">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-group">
                            <input type="text" id="txtUkuran" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group">
                            <input type="text" id="txtBerat" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group">
                            <input type="text" id="txtTebal" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtSatuanKilo" class="form-control" style="width:80%; float:left;" placeholder="Masukan Jumlah Konversi" autocomplete="off">
                  ...
                  <div class="col-md-6">
                    <table class="table table-responsive">
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtKodeExtruder" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <div class="input-group date">
                              <input type="text" id="txtTglPengerjaan" class="form-control" placeholder="Pilih Tanggal Pengerjaan" readonly autocomplete="off">
                              <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                              </div>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtNamaCustomer" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtUkuranOrder" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtWarna" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtTebalOrder" class="form-control" placeholder="Masukan Tebal Plastik" autocomplete="off">
                          </div>
                        </td>
                      </tr>
                    </table>
                  ...
                  <div class="col-md-6">
                    <table class="table table-responsive">
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtPrioritasOrder" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtJumlahRencanaPembuatan" class="form-control number" placeholder="Masukan Jumlah Yang Mau Dibuat (KG)" autocomplete="off">
                          </div>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-group">
                            <input type="text" id="txtBeratOrder" class="form-control" readonly autocomplete="off">
                          </div>
                        </td>
                      </tr>
                    </table>
