 autocomplete="off"<div class="content-wrapper">
              ...
              <div class="col-md-12">
                <table class="table table-responsive">
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <div class="input-group date">
                          <input type="text" id="txtTgl" class="form-control" placeholder="Masukan Tanggal" readonly autocomplete="off">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" id="txtJumlahKembalian" class="form-control number" placeholder="Masukan Jumlah Permintaan (KG)" autocomplete="off">
                      </div>
                    </td>
                  </tr>
                </table>
                ...
                <table class="table table-responsive">
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <div class="input-group date">
                          <input type="text" id="txtTglAwal" class="form-control" placeholder="Masukan Tanggal Awal" readonly autocomplete="off">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <div class="input-group date">
                          <input type="text" id="txtTglAkhir" class="form-control" placeholder="Masukan Tanggal Akhir" readonly autocomplete="off">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                        </div>
