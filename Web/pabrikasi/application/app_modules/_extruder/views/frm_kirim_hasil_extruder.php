        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="col-md-4 pull-right">
              <button type="button" id="btnKirimDataBonRollPolosPerShift" class="btn btn-md btn-flat btn-primary"><i class="fa fa-send"></i> Kirim Hasil Ke Gudang Roll</button>
              <button type="button" id="btnKirimHasilExtruder" class="btn btn-md btn-flat btn-success" onclick="saveKirimHasilKePpic();"><i class="fa fa-send"></i> Kirim</button>
            </div>
          </div>
        </div>
      </div>
