        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-target="#modalCariData" data-backdrop="static">
              <i class="fa fa-search"></i> Cari Data Apal
            </button>
          </div>
          <div class="box-body">
            <div class="row">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-md btn-flat btn-primary" onclick="cariDataApalGlobal()"><i class="fa fa-search"></i> Cari</button>
          </div>
        </div>
      </div>
    </div>
