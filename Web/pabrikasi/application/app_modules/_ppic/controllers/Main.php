...
class Main extends MX_Controller{
  ...
  public function updateKirimKeGudang(){
    ...
    if($isLogin){
      ...
      $result = $this->Ppic_Model->updateKirimKeGudang($data);
      echo $result;
    }else{
      echo "<script>alert('Session anda habis atau anda tidak memiliki hak akses!');</script>";
      redirect("_main/main","refresh");
  ...
  public function cetakFakturProduksi($param){
    ...
    if($isLogin){
      ...
      $pesananDetail = $this->Ppic_Model->selectPesananDetails($param);
      $arrListItem = $this->Ppic_Model->selectAllListItemAneka($pesananDetail[0]['kd_pack']);
      $result = array("arrDataPesanan" => $arrDataPesanan,
                      "arrDataPesananDetail" => $arrDataPesananDetail,
                      "arrListItem"=>$arrListItem
                    );
      // $css = "assets/bootstrap/css/bootstrap.min.css";
      // $page = $this->load->view("frm_print_faktur_produksi",$result,true);
      if($arrListItem){
        $this->load->view("frm_print_faktur_produksi_variasi", $result);
      } else {
  ...
  public function cetakFakturPesananProduksi($param){
    ...
    if($isLogin){
      ...
      $css = "assets/bootstrap/css/bootstrap.min.css";
      if($arrListItem){
        $page = $this->load->view("frm_print_faktur_produksi_m_variasi", $result, true);
      } else {
  ...
  public function printSpk($param1, $param2, $param3){
    $isLogin = $this->isLogin();
    if($isLogin){
      $param = array("tgl_awal"   => $param1,
                     "tgl_akhir"  => $param2,
                     "bagian"     => $param3);
      $result["Data"] = json_decode($this->Ppic_Model->selectListSpkPeriode($param), TRUE);
      $result["Parameter"] = $param;
      $this->load->view("frm_print_rencana",$result);
    }else{
      echo "<script>alert('Session anda habis atau anda tidak memiliki hak akses!');</script>";
      redirect("_main/main","refresh");
    }
  ...
  public function getCountOrderDeadline(){
    $isLogin = $this->isLogin();
    if($isLogin){
      $result = $this->Ppic_Model->selectCountOrderDeadline();
      echo $result;
    }else{
      echo "<script>alert('Session anda habis atau anda tidak memiliki hak akses!');</script>";
      redirect("_main/main","refresh");
  ...
  public function getOrderDeadline(){
    $isLogin = $this->isLogin();
    if($isLogin){
      $result = $this->Ppic_Model->selectOrderDeadline();
      echo $result;
    }else{
      echo "<script>alert('Session anda habis atau anda tidak memiliki hak akses!');</script>";
      redirect("_main/main","refresh");
  ...
  public function getLihatPesanan(){
    ...
    if($isLogin){
      ...
      echo json_encode($this->Ppic_Model->selectLihatPesanan($no_order));
    }else{
      echo "<script>alert('Session anda habis atau anda tidak memiliki hak akses!');</script>";
      redirect("_main/main","refresh");
    }
  ...
  public function getLihatPesananDetail(){
    ...
    if($isLogin){
      ...
      echo $this->Ppic_Model->selectLihatPesananDetails($no_order);
    }else{
      echo "<script>alert('Session anda habis atau anda tidak memiliki hak akses!');</script>";
      redirect("_main/main","refresh");
    }
