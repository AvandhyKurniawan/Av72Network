...
<!--===============================================On Load External Modal Function (Start) ===============================================-->
      <script type="text/javascript">
        ...
        function clearPreviewImage(param, param2=""){
          $("#"+param).val("");
          $("#preview-"+param).attr('src',"");
          if(param2 != ""){
            $.ajax({
              type : "POST",
              url : "<?php echo base_url('_ppic/main/hapusGambar'); ?>",
              dataType : "TEXT",
              data : {
                kdPpic : param2
              },
        ...
        function reloadCounterOrderDeadline(){
          $.ajax({
            url : "<?php echo base_url('_ppic/main/getCountOrderDeadline'); ?>",
            dataType : "JSON",
            success : function(response){
        ...
        function lihatDetailPesanan(param){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_ppic/main/getLihatPesanan",
            dataType : "JSON",
            data : {no_order : param},
            success : function(response){
              ...
              $("#tabel-lihat-pesanan-detail").dataTable({
                ...
                "sAjaxSource" : "<?php echo base_url(); ?>_ppic/main/getLihatPesananDetail?no_order="+param,
                "columns" : [
...
//================================ MODAL FUNCTION (START) ============================//
        ...
        function modalKirimKeGudang(param, param2){
          ...
          $("#tableDetailPesanan").dataTable({
            ...
            "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
              ...
              $("td:eq(1)",nRow).text(parseFloat(aData["jumlah"]).toLocaleString()+" "+aData["satuan"]);
          ...
          $("#cmbBarangCutting").on("select2:select",function(){
            ...
            $.ajax({
              ...
              success : function(response){
                ...
                $("#txtKetMerek").val(response[0].keterangan);
                switch (response[0].merek.toUpperCase()) {
                  case 'ZIPPIN': $("#cmbStrip").val("Pink");break;
                  case 'KP': $("#cmbStrip").val("Merah Orange");break;
                  case 'MP': $("#cmbStrip").val("Merah Putih");break;
                  default: $("#cmbStrip").val("#");break;
                }
              }
            });
          });
        ...
        function modalEditSpkExtruder(param,param2){
          ...
          $.ajax({
            ...
            success : function(response){
              ...
              var arrUkuran = response[0].ukuran.split("x");
              $("#txtUkuran").val(arrUkuran[0]);
              $("#txtLebar").val(arrUkuran[1]);
        ...
        function modalEditSpkCutting(param,param2){
          ...
          $.ajax({
            ...
            data : {kd_ppic:param},
            success : function(response){
              $("#clearImage").attr("onclick","clearPreviewImage('fileFoto','"+response[0].kd_ppic+"')");
        ...
        function modalShowOrderDeadline(){
          ...
          $('#tableListPesananLewatTglEstimasi').dataTable({
            ...
            "autoWidth": false,
            "sPaginationType": "full_numbers",
            "sAjaxSource":"<?php echo base_url(); ?>_ppic/main/getOrderDeadline",
            "columns":[
...
//================================ SEARCH FUNCTION (START) ============================//
        ...
        function cariSpkExtruder(){
          ...
          if(tglAwal == "" && tglAkhir == ""){
            ...
            $("#btnPrint").attr("href","<?php echo base_url('_ppic/main/printSpk/'); ?>"+tglAwal+'/'+tglAkhir+'/'+'EXTRUDER');
          }
        }
        ...
        function cariSpkCutting(){
          ...
          if(tglAwal == "" && tglAkhir == ""){
            ...
            $("#btnPrint").attr("href","<?php echo base_url('_ppic/main/printSpk/'); ?>"+tglAwal+'/'+tglAkhir+'/'+'POTONG');
          }
        }
        ...
        function cariSpkPrinting(){
          ...
          if(tglAwal == "" && tglAkhir == ""){
            ...
            $("#btnPrint").attr("href","<?php echo base_url('_ppic/main/printSpk/'); ?>"+tglAwal+'/'+tglAkhir+'/'+'CETAK');
          }
        }
        ...
        function cariSpkSablon(){
          ...
          if(tglAwal == "" && tglAkhir == ""){
            ...
            $("#txt_tgl_akhir").val("");
            $("#modal-cari-spk-extruder").modal("hide");
            $("#btnPrint").attr("href","<?php echo base_url('_ppic/main/printSpk/'); ?>"+tglAwal+'/'+tglAkhir+'/'+'SABLON');
          }
        }
...
//================================ RESET FORM FUNCTION (START) ============================//
        ...
        function resetFormTambahSpkCutting(){
          ...
          $(".date").datepicker("setDate",null);
          $("button[data-id='txtNmCustomer']").click();
          $("button[data-id='cmbStrip']").click();
          // removeCustomCombo();
          // removeStripCustom();
          $("#txtNmCustomer").val("").trigger("change");
          $("#txtTglRencana").val("");
          $("#cmbBarangCutting").empty();
          $("#txtMerek").val("");
          $("#txtWarnaPlastik").val("");
          $("#txtPermintaan").val("");
          $("#txtUkuran").val("");
...
//================================ SAVE FUNCTION (START) ============================//
        function saveSpkExtruder(){
          ...
          var panjang = $("#txtUkuran").val();
          var lebar = $("#txtLebar").val();
          if(panjang=="" || lebar==""){
            var ukuran = "";
          }else{
            var ukuran = panjang+"x"+lebar;
          }
          ...
          if(kdPpic == "" || nmCust == "" || tglRencana == "" || kdGdRoll == "" ||
             merek == "" || warnaPlastik == "" || permintaan == "" ||
             ukuran == "" || tebal == "" || berat == "" || jmlPermintaan == "" ||
             satuan == "" || strip == "" || status == ""
          ){
            $("#modal-notif").addClass("modal-warning");
            $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
        ...
        function saveSpkCutting(){
          ...
          if(kdPpic == "" || nmCust == "" || tglRencana == "" || kdGdHasil == "" ||
            merek == "" || ukuran == "" || warnaPlastik == "" || permintaan == "" ||
            tebal == "" || berat == "" || jmlPermintaan == "" || jmlMesin == "" ||
            satuan == "" || strip == "" || status == ""
          ){
            $("#modal-notif").addClass("modal-warning");
            $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
        ...
        function saveSpkPrinting(){
          ...
          var panjang = $("#txtUkuran").val();
          var lebar = $("#txtLebar").val();
          if(panjang=="" || lebar=="" || panjang==" " || lebar==" "){
            var ukuran = "";
          }else{
            var ukuran = panjang+"x"+lebar;
          }
          ...
          if(kdPpic == "" || nmCust == "" || tglRencana == "" || kdGdRoll == "" ||
            merek == "" || warnaPlastik == "" || permintaan == "" || ukuran == "" ||
            tebal == "" || berat == "" || jmlPermintaan == "" || satuan == "" ||
            strip == "" || status == "" || warnaCat == ""
          ){
            $("#modal-notif").addClass("modal-warning");
            $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
            $("#modal-notif").modal("show");
...
//================================ EDIT FUNCTION (START) ============================//
        function editSpkExtruder(){
          ...
          if(kdPpic == "" || nmCust == "" || tglRencana == "" || merek == "" ||
            warnaPlastik == "" || permintaan == "" || ukuran == "" || tebal == "" ||
            berat == "" || jmlPermintaan == "" || satuan == "" || strip == "" ||
            status == ""
          ){
            $("#modal-notif").addClass("modal-warning");
            $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
                ...
                if(jQuery.trim(response) === "Berhasil"){
                  if(fileFoto == "" || fileFoto == null){
                    ...
                    setTimeout(function(){
                      ...
                      // dataTableListSpkExtruder();
                      $(".active a[aria-controls='table-list-spk-extruder']").click();
                      $("#modal-tambah-spk-extruder").modal("hide");
                    },2000);
                  }else{
                    var formData = new FormData();
        ...
        function editSpkCutting(){
          ...
          if(kdPpic == "" || nmCust == "" || tglRencana == "" || merek == "" ||
            ukuran == "" || warnaPlastik == "" || permintaan == "" || tebal == "" ||
            berat == "" || jmlPermintaan == "" || jmlMesin == "" || satuan == "" ||
            strip == "" || status == ""
          ){
            $("#modal-notif").addClass("modal-warning");
            $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
                ...
                if(jQuery.trim(response) === "Berhasil"){
                  if(fileFoto == "" || fileFoto == null){
                    ...
                    setTimeout(function(){
                      ...
                      $(".active a[aria-controls='table-list-spk-cutting']").click();
                      $("#modal-tambah-spk-cutting").modal("hide");
                    },2000);
                  }else{
                    var formData = new FormData();
                    ...
                    success : function(response){
                      if(jQuery.trim(response) === "Berhasil"){
                        ...
                        setTimeout(function(){
                          ...
                          $("#modalNotifContent").text("");
                          resetFormTambahSpkPrinting();
                          $(".active a[aria-controls='table-list-spk-printing']").click();
                          $("#modal-tambah-spk-printing").modal("hide");
                        },2000);
                      }else if(jQuery.trim(response) === "Gagal"){
                        $("#modal-notif").addClass("modal-warning");
        ...
        function editSpkSablon(){
          ...
          if(kdPpic == "" || nmCust == "" || tglRencana == "" || merek == "" ||
            warnaPlastik == "" || permintaan == "" || ukuran == "" || tebal == "" ||
            berat == "" || jmlPermintaan == "" || satuan == "" || warnaCetak == "" ||
            strip == "" || status == ""
          ){
            $("#modal-notif").addClass("modal-warning");
            $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
                    ...
                    success : function(response){
                      if(jQuery.trim(response) === "Berhasil"){
                        ...
                        setTimeout(function(){
                          ...
                          resetFormTambahSpkSablon();
                          // dataTableListSpkSablon();
                          $(".active a[aria-controls='table-list-spk-sablon']").click();
                          $("#modal-tambah-spk-sablon").modal("hide");
                        },2000);
                      }else if(jQuery.trim(response) === "Gagal"){
                        $("#modal-notif").addClass("modal-warning");
...
//================================ UNSPECIFIED FUNCTION (START) ============================//
        ...
        function changeStripCustom(e){
          if(e.value == "Custom"){
            $("#td-strip-wrapper").html(
              '<div class="form-group has-warning">'+
                '<div class="input-group" id="inputGroup2" style="width:100%;float:left;">'+
                  '<input type="text" class="form-control" id="'+e.id+'" style="width:98%; float:left;" autocomplete="off">'+
...
//================================ DATATABLE FUNCTION (START) ============================//
        ...
        function dataTableOrderMarketingTerkirim(){
          ...
          $("#tableOrderMarketingTerkirim").dataTable({
            ...
            "columns":[
              ...
              {"data" : "sisa","name":"C.nm_perusahaan_update"},
              {"data" : "ukuran","name":"GH.ukuran"},
              {"data" : "warna_plastik","name":"GH.warna_plastik"},
              {"data" : "warna_cetak","name":"P.kd_order"},
              {"data" : "merek","name":"PD.merek"},
              {"data" : "dll","name":"PD.dll"},
            ...
            "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
              $("td:eq(1)",nRow).html(aData["nm_perusahaan"]+" ("+
                                      aData["nm_pemesan"]+") <label class='text-red'>["+
                                      aData["no_order"]+"]</label>"+
                                      "<label class='text-blue'>"+aData["kd_order"]+"</label>");
              if(aData["sts_pesanan"]=="PROGRESS"){
                $("td:eq(10)",nRow).css({"background-color":"#dd4b39","color":"#FFF"});
              }else if(aData["sts_pesanan"]=="PACKING"){
                $("td:eq(10)",nRow).css({"background-color":"#269abc","color":"#FFF"});
              }else if(aData["sts_pesanan"]=="FINISH"){
                $("td:eq(10)",nRow).css({"background-color":"#00a65a","color":"#FFF"});
              }else{
              ...
              if(aData["sts_print"] == "FALSE"){
                $("td:eq(11)",nRow).html("<button class='btn btn-md btn-flat btn-info btn-sm margin' onclick=printOut('"+aData["no_order"]+"')>Print Out</button><button class='btn btn-md btn-flat btn-info margin' onclick=print_out_produksi('"+aData["no_order"]+"')>Faktur Pesanan</button>");
              }else{
                $("td:eq(11)",nRow).html("<button class='btn btn-flat btn-warning btn-sm margin' onclick=printOut('"+aData["no_order"]+"')>Sudah Di Print Out</button><button class='btn btn-md btn-flat btn-info margin' onclick=print_out_produksi('"+aData["no_order"]+"')>Faktur Pesanan</button>");
              }
            }
          });
        }
          ...
          $("#table-order-marketing").dataTable({
            ...
            "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
              $("td:eq(1)",nRow).html(aData["nm_perusahaan"]+
                                      ...
                                      " <label class='text-red'>"+aData["kd_order"]+"</label>");
              $("td:eq(2)",nRow).text(parseFloat(aData["jumlah"]).toLocaleString() + " "+ aData["satuan"]);
              $("td:eq(6)",nRow).html("<label class='text-red'>"+aData["jns_brg"]+"</label>");
              if(aData["ket_proof"] == null){
                var ket_proof = "";
              }else{
                var ket_proof = aData["ket_proof"];
              }
              $("td:eq(11)",nRow).html(aData["note"]+"<label class='text-red'>["+aData["proof"]+"]["+ket_proof+"]</label>")
              if (!aData["foto_1"]) {
        ...
        function dataTableOrderCabang(thnBln="<?php echo date("Y-m"); ?>"){
          $("#table-order-cabang").dataTable({
            ...
            "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
              ...
              $("td:eq(3)",nRow).text(parseFloat(aData["jumlah"]).toLocaleString() + " "+ aData["satuan"]);
              $("td:eq(6)",nRow).html("<label class='text-red'>"+aData["jns_brg"]+"</label>");
              if(aData["kirim_gudang"] == "FALSE"){
                $("td:eq(12)",nRow).html("<button class='btn btn-md btn-flat btn-primary' onclick=modalKirimKeGudang('"+aData["no_order"]+"','PROGRESS')>Kirim Ke Gudang</button>");
              }else{
        ...
        function dataTableListSpkCutting(param=""){
          ...
          $("#table-list-spk-cutting").dataTable({
            ...
            "columns":[
              ...
              {"data" : "tgl_rencana","name":"RP.tgl_rencana"},
              {"data" : "nm_cust","name":"RP.nm_cust"},
              {"data" : "merek","name":"RP.jns_permintaan"},
              {"data" : "jns_permintaan","name":"RP.ukuran"},
              {"data" : "ukuran","name":"RP.warna_plastik"},
              {"data" : "warna_plastik","name":"RP.tebal"},
              {"data" : "berat","name":"RP.merek"},
              {"data" : "tebal","name":"RP.ket_merek"},
              {"data" : "jumlah_permintaan","name":"RP.berat"},
              {"data" : "sisa","name":"RP.jumlah_permintaan"},
              {"data" : "strip","name":"RP.sisa"},
              {"data" : "permintaan_mesin","name":"RP.strip"},
              {"data" : "keterangan","name":"RP.keterangan"},
              {"data" : "foto_depan","name":"RP.keterangan"},
              {"data" : "sts_pengerjaan","name":"RP.sts_pengerjaan"},
              {"data" : "kd_ppic","name":"RP.kd_ppic"}
            ],
            "fnServerData": function (sSource, aoData, fnCallback){
        ...
        function dataTableListSpkSablon(param=""){
          ...
          $("#table-list-spk-sablon").dataTable({
            ...
            "columns":[
              ...
              {"data" : "ukuran","name":"RP.ukuran"},
              {"data" : "warna_plastik","name":"RP.warna_plastik"},
              {"data" : "warna_cetak","name":"RP.warna_cetak"},
              {"data" : "berat","name":"RP.berat"},
              {"data" : "tebal","name":"RP.tebal"},
              {"data" : "strip","name":"RP.strip"},
              {"data" : "jumlah_permintaan","name":"RP.jumlah_permintaan"},
              ...
              {"data" : "sts_pengerjaan","name":"RP.sts_pengerjaan"},
              {"data" : "keterangan","name":"RP.keterangan"},
              {"data" : "foto_depan","name":"RP.foto_depan"},
              {"data" : "kd_ppic","name":"RP.kd_ppic"}
            ],
            "fnServerData": function (sSource, aoData, fnCallback){
              if(param != ""){
        ...
        function datatablesHasilJobPotong(param1, param2, param3){
            ...
            "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            	$("td:eq(4)",nRow).html(aData["ukuran"]+" "+"<label class='text-blue'> ("+aData["kd_gd_hasil"]+")</label>");
  						var arrUkuran = aData["ukuran"].split("x");
  						$("td:eq(15)",nRow).html(aData["plusminus"]);
              if(aData["status_bon"] == "FALSE"){
                $("td:eq(17)",nRow).html("<label class='text-danger'>Belum Dikirim Ke Gudang</label>");
              }else{
                $("td:eq(17)",nRow).html("<label class='text-success'>Sudah Dikirim Ke Gudang</label>");
              }
            }
  				});
  			}
              ...
              $.each(response, function(AvIndex, AvValue){
                $("#tableHasilExtruderGlobal > tbody:last-child").append(
                  "<tr>"+
                    ...
                    "<td>"+parseFloat(AvValue.totalGlobal).toLocaleString()+"</td>"+
                    "<td>"+parseFloat(AvValue.totalApalGlobal).toLocaleString()+"</td>"+
                  "</tr>"
                );
              });
            },
