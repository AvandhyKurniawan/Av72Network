    ...
    <section class="content">
      <div class="box box-success">
        <div class="box-header">
          ...
          <button type="button" id="btn-tambah-spk-cutting" class="btn btn-flat btn-md btn-primary" onclick="modalTambahSpkCutting()" data-toggle="modal" data-target="#modal-tambah-spk-cutting" data-backdrop="static">
          ...
          <a href="<?php echo base_url('_ppic/main/printSpk/').date('Y-m-d',strtotime('+1 Days')).'/'.date('Y-m-d',strtotime('+1 Days')).'/POTONG' ?>" class="btn btn-md btn-flat btn-info" id="btnPrint" target="_blank"><i class="fa fa-print"></i> Print</a>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="modal fade" id="modal-tambah-spk-cutting" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <button class="close" id="closeSpkCutting" data-dismiss="modal" data-target="#modal-tambah-spk-cutting" onclick="resetFormTambahSpkCutting();">&times;</button>
            ...
            <div class="modal-body" style="height:550px; overflow-y:scroll;">
              <table class="table">
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <div id="comboCustomWrapper">
                        ...
                        <input type="text" class="form-control" id="txtNmCustomer" style="width:98%; float:left;" autocomplete="off">
                      </div>
                    </div>
                  </td>
                </tr>
                  ...
                  <td>
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group has-warning">
                          <input type="text" id="txtUkuran" class="form-control" placeholder="Ukuran" readonly required autocomplete="off">
                        </div>
                        <div class="form-group has-warning">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <input type="text" id="cmbPermintaan" class="form-control" placeholder="Jenis Permintaan" readonly autocomplete="off">
                        </div>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" id="txtJumlahMesin" class="form-control" required autocomplete="off">
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" id="btnBatalSpkCutting" class="btn btn-flat btn-md btn-warning" onclick="if(confirm('Apakah Anda Yakin Ingin Membersihkan Form?')){resetFormTambahSpkCutting()}">Bersihkan</button>
