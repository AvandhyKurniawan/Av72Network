<html>
  <head>
    ...
    <style>
    body{
      font-family: Tahoma, Helvetica, sans-serif, Times;
      font-weight: bold;
    }
      .col-md-6{
        width: 50%;
        ...
        <table class="table-pesanan" style="margin-top:5px;" width="100%">
          <thead>
            <tr>
              ...
              <th rowspan="2" width="10%"><center>MEREK</center></th>
            ...
            <tr>
              ...
              <th><center>WARNA CETAK</center></th>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <?php  if($arrData["satuan"] == 'PACK' || $arrData["satuan"] == 'INNER'): foreach($arrListItem as $listItem):?>
                    <p style="font-size:12px;"><?=$listItem['ukuran']. ' ' . $listItem['merek'] . ' ' . $listItem['warna_plastik']?></p>
                    <hr>
                  <?php endforeach; endif; ?>
                </td>
                <td>
                  <?php  if($arrData["satuan"] == 'PACK' || $arrData["satuan"] == 'INNER'): foreach($arrListItem as $listItem):?>
                    <p style="font-size:12px;"><?=$listItem['warna_cetak'];?></p>
                    <hr>
                  <?php endforeach; endif; ?>
                </td>
                <td>
                  <?php  if($arrData["satuan"] == 'PACK' || $arrData["satuan"] == 'INNER'): foreach($arrListItem as $listItem):?>
                    <p style="font-size:12px;"><?=$listItem['merek_aneka'];?></p>
                    <hr>
                  <?php endforeach; endif; ?>
                </td>
                <td>
                  <?php  if($arrData["satuan"] == 'PACK' || $arrData["satuan"] == 'INNER'): foreach($arrListItem as $listItem):?>
                    <p style="font-size:12px;"><?=$listItem['strip'];?></p>
                    <hr>
                  <?php endforeach; endif; ?>
                </td>
                <td>
                  <?php  if($arrData["satuan"] == 'PACK' || $arrData["satuan"] == 'INNER'): foreach($arrListItem as $listItem):?>
                    <p style="font-size:12px;"><?=$listItem['dll']?></p>
                    <hr>
                  <?php endforeach; endif; ?>
                </td>
                <?php if ($arrDataPesanan[0]["approve_cabang"] == 'TRUE') {?>
