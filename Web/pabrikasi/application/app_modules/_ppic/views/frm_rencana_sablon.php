    ...
    <section class="content">
      <div class="box box-success">
        <div class="box-header">
          ...
          <button type="button" id="btn-tambah-spk-sablon" class="btn btn-flat btn-md btn-primary" onclick="modalTambahSpkSablon('SABLON','CETAK')" data-toggle="modal" data-target="#modal-tambah-spk-sablon" data-backdrop="static">
          ...
          <a href="<?php echo base_url('_ppic/main/printSpk/').date('Y-m-d').'/'.date('Y-m-d').'/SABLON' ?>" class="btn btn-md btn-flat btn-info" id="btnPrint" target="_blank"><i class="fa fa-print"></i> Print</a>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="modal fade" id="modal-tambah-spk-sablon" role="dialog" tabindex="-1">
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" id="btnBatalSpkSablon" class="btn btn-flat btn-md btn-warning" onclick="if(confirm('Apakah Anda Yakin Ingin Membersihkan Form?')){resetFormTambahSpkSablon()}">Bersihkan</button>
