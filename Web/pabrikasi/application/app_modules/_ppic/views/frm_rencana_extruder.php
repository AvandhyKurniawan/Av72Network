    ...
    <section class="content">
      <div class="box box-success">
        <div class="box-header">
          ...
          <button type="button" id="btn-tambah-spk-extruder" class="btn btn-flat btn-md btn-primary" onclick="modalTambahSpkExtruder('POLOS')" data-toggle="modal" data-target="#modal-tambah-spk-extruder" data-backdrop="static">
          ...
          <a href="<?php echo base_url('_ppic/main/printSpk/').date('Y-m-d').'/'.date('Y-m-d').'/EXTRUDER' ?>" class="btn btn-md btn-flat btn-info" id="btnPrint" target="_blank"><i class="fa fa-print"></i> Print</a>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="modal fade" id="modal-tambah-spk-extruder" role="dialog" tabindex="-1">
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" id="btnBatalSpkExtruder" class="btn btn-flat btn-md btn-warning" onclick="if(confirm('Apakah Anda Yakin Ingin Membersihkan Form?')){resetFormTambahSpkExt()}">Bersihkan</button>
