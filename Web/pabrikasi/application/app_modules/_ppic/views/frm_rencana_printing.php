    ...
    <section class="content">
      <div class="box box-success">
        <div class="box-header">
          ...
          <button type="button" id="btn-tambah-spk-printing" class="btn btn-flat btn-md btn-primary" onclick="modalTambahSpkPrinting('CETAK')" data-toggle="modal" data-target="#modal-tambah-spk-printing" data-backdrop="static">
          ...
          <a href="<?php echo base_url('_ppic/main/printSpk/').date('Y-m-d').'/'.date('Y-m-d').'/CETAK' ?>" class="btn btn-md btn-flat btn-info" id="btnPrint" target="_blank"><i class="fa fa-print"></i> Print</a>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="modal fade" id="modal-tambah-spk-printing" role="dialog" tabindex="-1">
            ...
            <div class="modal-body" style="height:550px; overflow-y:scroll;">
              <table class="table">
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" id="txtKdPpic" value="" class="form-control" required readonly autocomplete="off">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" id="txtNmCustomer" value="" class="form-control" required autocomplete="off">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <div class="input-group date">
                        <input type="text" id="txtTglRencana" class="form-control" required readonly="" autocomplete="off">
                ...
                <tr>
                  ...
                  <td>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group has-warning">
                          <input type="text" id="txtMerek" class="form-control" placeholder="Merek" readonly required autocomplete="off">
                        </div>
                        <div class="form-group has-warning">
                          <input type="text" id="txtWarnaPlastik" class="form-control" placeholder="Warna Plastik" readonly required autocomplete="off">
                        </div>
                        <div class="form-group">
                          <input type="text" id="txtKetMerek" class="form-control" placeholder="Keterangan Merek" autocomplete="off">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group has-warning">
                          <input type="text" id="txtPermintaan" class="form-control" placeholder="Permintaan" readonly required autocomplete="off">
                        </div>
                        <div class="form-group has-warning">
                          <input type="text" id="txtUkuran" class="form-control" placeholder="Panjang" style="float:left; width:100px;" autocomplete="off">
                          <span style="float:left; margin:5px 10px 22px 10px;">x</span>
                          <input type="text" id="txtLebar" class="form-control" placeholder="Lebar" style="float:left; width:100px;" autocomplete="off">
                        </div>
                        <div class="form-group">
                          <input type="text" id="txtKetPermintaan" class="form-control" placeholder="Keterangan Permintaan" autocomplete="off">
                        </div>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" id="txtTebal" value="" class="form-control" required autocomplete="off">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" id="txtBerat" value="" class="form-control" required autocomplete="off">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" id="txtJumlahPermintaan" value="" class="form-control number" required autocomplete="off">
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" id="txtWarnaCat" value="" class="form-control" required autocomplete="off">
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" id="btnBatalSpkPrinting" class="btn btn-flat btn-md btn-warning" onclick="if(confirm('Apakah Anda Yakin Ingin Membersihkan Form?')){resetFormTambahSpkPrinting()}">Bersihkan</button>
