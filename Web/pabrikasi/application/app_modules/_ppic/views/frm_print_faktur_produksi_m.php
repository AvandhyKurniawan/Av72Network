          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><center><?php echo $arrData["nm_brg"]."<br>(".$explode1[1].")<br>(".$arrData["jns_brg"].")"; ?>

                <?php  if($arrData["satuan"] == 'PACK' || $arrData["satuan"] == 'INNER'): foreach($arrListItem as $listItem):?>
                <li><?=$listItem['ukuran']. ' ' . $listItem['merek'] . ' ' . $listItem['warna_plastik']?></li>
