...
if(!empty($Value["JnsOrder"])){
  $jns_order = array("DK"=>"","LK"=>"","LN"=>"","OL"=>"","SKV"=>"");
  switch ($Value["JnsOrder"]) {
    ...
    case 'OL': $jns_order["OL"] = "selected='selected'";break;
    case 'SKV': $jns_order["SKV"] = "selected='selected'";break;
    default:$jns_order = array("DK"=>"","LK"=>"","LN"=>"","OL"=>"","SKV"=>"");break;
  }
}
...
if($Value["StsPesanan"] == "PROGRESS" || $Value["StsPesanan"] == "PACKING" || $Value["StsPesanan"] == "FINISH"){
        ...
        <fieldset class="box box-solid">
          ...
          <div class="col-md-12" style="margin-bottom:10px;">
            <div class="form-group has-error" style="width: 220px; float:left; margin-right:5px;">
              <select class="form-control" name="cmb-jns-order" id="cmb-jns-order-edit" required>
                ...
                <option value="OL" <?php echo $jns_order["OL"]; ?>>Online</option>
                <option value="SKV" <?php echo $jns_order["SKV"]; ?>>Sales Kanvas</option>
              </select>
            </div>
          ...
          <div class="col-md-12" style="margin-bottom:10px;">
            ...
            <div class="form-group has-error" style="width: 180px; float:left; margin-right:5px;">
              <div class="input-group">
                <label>
                  <input type="radio" name="rb_proof" class="flat-red proof_edit" value="PERLU" required <?php echo $proof["PERLU"]; ?> <?php echo $disable; ?>> Perlu
                </label>
                &nbsp;&nbsp;
                <label>
                  <input type="radio" name="rb_proof" class="flat-red proof_edit" value="TIDAK" required <?php echo $proof["TIDAK PERLU"]; ?> <?php echo $disable; ?>> Tidak Perlu
                </label>
              </div>
            </div>
            <div class="form-group has-success">
          ...
          <div class="col-md-12" style="margin-bottom:10px">
            <div class="form-group has-success" style="width: 400px; float:left; margin-right:50px;">
              ...
              <textarea name="txt_note" id="txt_note_edit" rows="3" cols="80" <?php echo $disable; ?>><?php echo $Value['Note']; ?></textarea>
            </div>
...
<!--======================================================== Data Keranjang Belanja (Start) ========================================================-->
        ...
        <fieldset class="box box-solid">
          ...
          <div class="box-body">
            ...
            <center>
              <button type="button" class="btn btn-md btn-flat btn-info" name="btn-checkout" id="btn-checkout-edit">
         ...
         <div class='modal-body'>
           <div class='col-md-12'>
             ...
             <div class='form-group' style='width: 280px; float:left; margin-right:5px;'>
               <select class='form-control' name='cmb_ukuran' id='cmb_ukuran1_edit' required <?php echo $disable; ?>></select>
             </div>
             <div class='form-group has-error'>
               <input type='text' name='txt_jumlah' id='txt_jumlah1_edit' class='form-control' placeholder='Jumlah' style='width: 100px; float:left; margin-right:5px;' required <?php echo $disable; ?>>
               <select class='form-control' name='cmb_satuan' id='cmb_satuan1_edit' style='width: 100px; float:left; margin-right:5px;' required <?php echo $disable; ?>>
                 <option value='#'>--Satuan--</option>
                 <option value='BAL'>BAL</option>
                 <option value='KG'>Kilogram</option>
                 <option value='KALENG'>Kaleng</option>
           ...
           <div class='col-md-12'>
             <div class='form-group has-success' style='margin-top:15px;'>
               <input type='text' name='txt_warna_cetak' id='txt_warna_cetak1_edit' class='form-control' placeholder='Warna Cetak' style='width: 200px; float:left; margin-right:5px;' <?php echo $disable; ?>>
             </div>
             <div class='form-group has-error'>
               <input type='text' name='txt_dll' id='txt_dll1_edit' class='form-control' placeholder='DLL' style='width: 200px; float:left; margin-right:5px;' required <?php echo $disable; ?>>
               <input type='text' name='txt_strip' id='txt_strip1_edit' class='form-control' placeholder='SM' style='width: 100px; float:left; margin-right:5px;' required <?php echo $disable; ?>>
           ...
           <div class='col-md-12' style='margin-bottom:10px;'>
             ...
             <div class='form-group has-error'>
               <textarea name="txt_merek" rows="3" cols="70" id='txt_merek1_edit' class='form-control' placeholder='Merek' style='width: 250px; float:left; margin-right:5px;' required <?php echo $disable; ?>></textarea>
             </div>
           </div>
           <div class='col-md-8'>
