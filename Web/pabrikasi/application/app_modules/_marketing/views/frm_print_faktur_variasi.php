          ...
          <table class="table-pesanan" style="margin-top:5px;" width="100%">
            ...
            <tbody style="font-size:14px !important;">
              ...
              <tr>
                ...
                <td>
                  <?php foreach($arrDataListItem as $listItem):?>
                    <p style="min-height: 20px; height:20px; max-height:40px;"><?=$listItem['omset_kg'] * $jumlahPesanan?></p>
                    <hr>
                  <?php endforeach;?>
                </td>
                <td>
                  <?php foreach($arrDataListItem as $listItem):?>
                    <p style="min-height: 20px; height:20px; max-height:40px;"><?=number_format($listItem['omset_lembar']) * $jumlahPesanan?></p>
                    <hr>
                  <?php endforeach;?>
                </td>
              </tr>
