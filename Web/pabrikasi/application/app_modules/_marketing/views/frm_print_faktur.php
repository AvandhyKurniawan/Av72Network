  ...
  <body>
    ...
    <div class="col-md-6">
      <div class="col-md-6">
        ...
        <h5 style="margin:0; margin-top:3px; text-align:center;"><?php echo $arrDataPesanan[0]["no_order"]." ".$arrDataPesanan[0]["pajak"]." ".$arrDataPesanan[0]["jns_order"]; ?></h5>
      </div>
      <div class="col-md-6">
          ...
          <table class="table-pesanan" style="margin-top:5px;" width="100%">
            ...
            <tbody>
              ...
              if(strpos($arrData["ukuran"],"/") !== FALSE){
                ...
                $panjang = "<u>".str_replace(" cm","",$arrUkuranPrimer[0])."</u><br>".str_replace(" cm","",$arrUkuranSekunder[0]);
                $lebar = "<u>".str_replace(" cm","",$arrUkuranPrimer[1])."</u><br>".str_replace(" cm","",$arrUkuranSekunder[1]);
              }else{
                if(strtoupper($arrData["merekProduk"]) == "KLIP DOUBLE"){
                  if(strpos($arrData["ukuran"], " (") !== FALSE){
                    $mustBeReplace = array(" ",")");
                    $cleanData = str_replace($mustBeReplace, "", $arrData["ukuran"]);
                    $explode1 = explode("(",strtolower($cleanData));
                    $arrUkuran = explode("x",strtolower($explode1[1]));
                    $panjang = str_replace(" cm","",$arrUkuran[0]);
                    $lebar = str_replace(" cm","",$arrUkuran[1]);
                  }else{
              ...
              <tr>
                ...
                <td>
                  <?php if(!empty($arrData["namaProduk"])):?>
                    ...
                    <ul class="text-left" style="float:left !important; text-align:left !important; list-style:none !important;">
                      <?php foreach($arrDataListItem as $listItem):?>
                        <li style="font-size:7px;"><?=$listItem['ukuran']. ' ' . $listItem['merek'] . ' ' . $listItem['warna_plastik']?></li>
                      <?php endforeach;?>
                    </ul>
                  <?php endif;?>
                  <center>
                    <?php if(!empty($arrData["merekProduk"])): ?>
                      <?php
                        if(strtoupper($arrData["merekProduk"]) == "KLIP DOUBLE"){
                          if(strpos($arrData["ukuran"], " (") !== FALSE){
                            echo $arrData["merekProduk"]." ".$explode1[0];
                          }else{
                            echo $arrData["merekProduk"];
                          }
                        }else{
                          echo $arrData["merekProduk"];
                        }
