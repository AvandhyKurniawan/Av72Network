    ...
    <div class="col-md-10">
      <div class="content-wrapper">
        ...
        <table class="table-pesanan" style="margin-top:5px;" width="100%">
          <thead>
            <tr>
              <th rowspan="2" width="4%"><center>QTY</center></th>
              <th rowspan="2" width="7%"><center>SATUAN</center></th>
              <th rowspan="2" width="14%"><center>MEREK</center></th>
              <th rowspan="2" width="16%"><center>NAMA PRODUK</center></th>
              <th colspan="4"><center>ISI PRODUK</center></th>
            </tr>
            <tr>
              <th width="20%"><center>PRODUK</center></th>
              <th width="15%"><center>WARNA CETAK</center></th>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><center>
                <?php //echo $arrData["nm_brg"]; ?>

                <?php if(!empty($arrData["namaProduk"])):?>
                      <?php
                      echo $arrData["namaProduk"];
                      ?><?php  endif;?>
                    <?php if(!empty($arrData["nm_brg"])): ?>
                      <?php echo $arrData["nm_brg"]; ?><br>
                    <?php endif;?>
                </center></td>
                <td>
                  <?php foreach($arrDataListItem as $listItem):?>
                    <p> <?=$listItem['ukuran']. ' ' . $listItem['merek'] . ' ' . $listItem['warna_plastik']?></p>
                    <hr>
                  <?php endforeach;?>
                </td>
                <td>
                <?php foreach($arrDataListItem as $listItem):?>
                    <p> <?=$listItem['warna_cetak']?></p>
                    <hr>
                <?php endforeach;?>
                </td>
                <td>
