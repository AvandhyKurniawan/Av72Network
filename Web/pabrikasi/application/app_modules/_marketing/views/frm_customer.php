...
if($Header == "ADD"){
  ...
  <td>
    <select class="form-control" id="jenis" name="jenis" onchange="jnsCust();"  autofocus style="width:30%;">
      ...
      <option value="SKV">Sales Kanvas</option>
    </select>
  </td>
  ';
  $v23="";
  ...
  foreach ($Customer as $arrCustomer) {
    ...
    $readonly="readonly";
    $tglLahirOwner = $arrCustomer['tgl_lahir_owner'];
    $tglLahirPurchasing = $arrCustomer['tgl_lahir_purchasing'];
    $jenkelOwner=$arrCustomer['gender_owner'];
  }
}else{
    ...
    <section class="content">
        <div class="container">
          ...
          <?php } ?>
            ...
            <tr>
              <td>Tgl. Lahir Owner</td>
              <td>:</td>
              <td>
                <div class="form-group" style="width: 300px; float:left; margin-right:5px;">
                  <div class="input-group date">
                    <input class="form-control pull-right" type="text" name="txt_tgl_lhr_owner" id="txt_tgl_lhr_owner" required  value="<?= $tglLahirOwner; ?>" readonly placeholder="Tanggal Lahir Owner">
            ...
            <tr>
              ...
              <td>
                <div class="input-group" style="width:100%">
                  ...
                  ?>
                  <label>
                    <input type="radio" name="rb_jenkelOwner" class="flat-red" value="Pria" <?php echo $p1; ?>> Pria
                  </label>
                  &nbsp;&nbsp;
                  <label>
                    <input type="radio" name="rb_jenkelOwner" class="flat-red" value="Wanita" <?php echo $w1; ?>> Wanita
                  </label>
                  &nbsp;
                  <!-- <label class="text-danger">&lowast;</label> -->
                </div>
            ...
            <tr>
              <td>Tgl. Lahir Purchasing</td>
              <td>:</td>
              <td>
                <div class="form-group" style="width: 300px; float:left; margin-right:5px;">
                  <div class="input-group date">
                    <input class="form-control pull-right" type="text" name="txt_tgl_lhr_purchasing" id="txt_tgl_lhr_purchasing" value="<?= $tglLahirPurchasing; ?>" required readonly placeholder="Tanggal Lahir Purchasing">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                  </div>
            ...
            <tr>
              <td>Jenis Kelamin Purchasing</td>
              <td>:</td>
              <td>
                <div class="input-group" style="width:100%">
                  <?php
