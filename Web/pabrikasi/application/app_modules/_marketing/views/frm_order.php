          ...
          <?php
            ...
            switch ($jnsOrder) {
              ...
              case 'LN': $arrJnsOrder = array("DK" => "",
                                              ...
                                              "SKV" => "");
                         break;
              case 'OL': $arrJnsOrder = array("DK" => "",
                                              "LK" => "",
                                              "LN" => "",
                                              "OL" => "selected='seleted'",
                                              "SKV" => "");
                          break;
              case 'SKV': $arrJnsOrder = array("DK" => "",
                                              "LK" => "",
                                              "LN" => "",
                                              "OL" => "",
                                              "SKV" => "selected='seleted'");
                          break;
          ...
          <div class="col-md-12" style="margin-bottom:10px;">
            <div class="form-group has-error" style="width: 220px; float:left; margin-right:5px;">
              <select class="form-control" name="cmb-jns-order" id="cmb-jns-order" required>
                ...
                <option value="OL" <?php echo $arrJnsOrder["OL"]; ?>>Online</option>
                <option value="SKV" <?php echo $arrJnsOrder["SKV"]; ?>>Sales Kanvas</option>
              </select>
            </div>
          ...
          <div class="col-md-12">
            ...
            <div class="form-group has-error">
              ...
              <div class="input-group" style="width: 210px; float:left; margin-right:5px;">
                <label>
                  <input type="radio" name="rb_mata_uang" class="flat-red mata_uang" value="Rp."> Rupiah
                </label>
                &nbsp;
                <label>
                  <input type="radio" name="rb_mata_uang" class="flat-red mata_uang" value="USD."> US Dollar
                </label>
