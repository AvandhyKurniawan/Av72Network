        ...
        <table id="data-order" class="table table-bordered table-striped" style="font-size:13px; width: 100%;">
          <thead>
            ...
            <tr>
              ...
              <td style="background-color:#fcfcfc;">
                <center><b class="text-primary">NU</b></center>
              </td>
              <td style="background-color:#fcfcfc;">
                <center><b class="text-primary">NO</b></center>
              </td>
              <!-- <td style="background-color:#fcfcfc;">
        ...
        <div class="modal-dialog modal-lg" style="width:100%;">
          <div class="modal-content" style="width:100%;">
            <div class="modal-header">
              ...
              <button type="button" onclick="window.frames['cetakFakturLoad'].focus(); window.frames['cetakFakturLoad'].print();" class="btn btn-sm btn-flat bg-purple pull-right">Print</button>
            </div>
            <div class="modal-body">
              <iframe src="" id="cetakFakturLoad" name="cetakFakturLoad" style="width: 100%; height: 500px;"></iframe>
            </div>
