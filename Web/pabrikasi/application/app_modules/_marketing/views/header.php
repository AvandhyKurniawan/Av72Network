<html>
  ...
  <body class="hold-transition skin-green sidebar-mini sidebar-collapse">
            ...
            <!-- Notifications: style can be found in dropdown.less -->
              ...
              <li class="dropdown notifications-menu">
                ...
                <ul class="dropdown-menu">
                  <li class="header" id="notif-header"></li>
                  <li>
                    <!-- inner menu: contains the actual data -->
                    <ul class="menu">
                      <li>
                        <a href="#" data-toggle="modal" data-target="#modalGetListOrder" data-backdrop="static" onclick="modalShowOrderDeadline();" id="outOfDeadlineOrder">

                        </a>
                      </li>
                      <li>
                        <a href="#" id="birthdayNotif" data-toggle="modal" data-target="#modalBirthdayList" data-backdrop="static" onclick="tableBirthdayList();">
    ...
    <div class="modal fade" id="modalBirthdayList" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-lg" style="width:100%; padding:0; margin:0;">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" data-target="#modalBirthdayList">&times;</button>
            <h4 class="modal-title text-blue">Daftar Nama Owner Dan Purchasing Yang Berulang Tahun Hari Ini</h4>
          </div>
          <div class="modal-body" style="height:80%; overflow:scroll;">
            <div class="row">
              <div class="col-md-12">
                <table class="table table-responsive table-striped" id="tableBirthdayList">
                  <thead>
                    <tr>
                      <th style="vertical-align:middle;">Kode Customer</th>
                      ...
                      <th style="vertical-align:middle;">Pilihan &nbsp; <input type="checkbox" id="checkAllData" onclick="checkAllData(this)" value=""> </th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div class="modal-footer">
            <button type="button" id="btnKirimUcapanSelamatUlangTahunWhatsapp" class="btn btn-md btn-flat btn-success" disabled>
              <i class="fa fa-whatsapp"></i> Kirim Ucapan
            </button>
          </div>
        </div>
      </div>
