...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <div class="input-group input-group-sm col-md-3" style="width: 270px; font-size: 14px;">
      <input type="text" class="form-control date" id="tanggal" placeholder="Pilih Tanggal" autocomplete="false" readonly style="background-color:#fff;">
  ...
  <section class="content">
    <div class="nav-tabs-custom" style="cursor: move;">
      <ul class="nav nav-tabs pull-right ui-sortable-handle">
        ...
        <li><a href="#SKV" data-toggle="tab"  onclick="changeTitle('Sales Kanvas')">Sales Kanvas</a></li>
        ...
        <li><a href="#LN" data-toggle="tab" onclick="changeTitle('Luar Negeri')">Luar Negeri</a></li>
      </ul>
      <div class="tab-content padding">
        ...
        <div class="chart tab-pane" id="SKV">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-icon bg-green"><i class="ion ion-ios-cart-outline" style="padding-top: 23%;"></i></span>

              <div class="info-box-content">
                <span class="info-box-number" id="totalPerHariSKV"></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-12" id="table-wrapper">
            <table id="tableOrderPerHariSKV" class="table table-bordered table-responsive table-striped" style="font-size:13px;">
              <thead>
                <th style="width: 10px;">No</th>
                <th>No. Order</th>
                <th style="vertical-align: middle; text-align: center;">Kode Order</th>
        ...
        <div class="chart tab-pane" id="LN">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-number" id="totalPerHariLN"></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-12" id="table-wrapper">
            <table id="tableOrderPerHariLN" class="table table-bordered table-responsive table-striped" style="font-size:13px;">
              <thead>
                <th style="width: 10px;">No</th>
                <th>No. Order</th>
                <th style="vertical-align: middle; text-align: center;">Kode Order</th>
