                      ...
                      <div class="box box-primary">
                        ...
                        <div class="box-body">
                          <table class="table table-responsive table-striped">
                            <tr>
                              <td width="40%">Total Penggunaan Bahan</td>
                              <td width="1%">:</td>
                              <td id="tdTotalPenggunaanBahan"></td>
                            </tr>
                            <tr>
                              <td>Total Berat Apal</td>
                              <td>:</td>
                              <td id="tdTotalBeratApal"></td>
                            </tr>
                          </table>
                        </div>
                      </div>
              ...
              <div class="row">
                <table class="table">
                  <tr>
                    ...
                    <td>
                      <div class="input-group date">
                        <input type="text" id="txtTglPengambilan" class="form-control" readonly>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button type="button" id="btnBatalTambahBahan" onclick="resetTambahBahan()" class="btn btn-md btn-flat btn-danger"><i class="fa fa-undo"></i> Batal</button>
                    </td>
                  </tr>
                </table>
                <div class="col-md-12">
