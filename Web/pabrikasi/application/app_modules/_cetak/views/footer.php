...
//================================ MODAL METHOD (START) ============================//
            ...
            success : function(response){
              ...
              $.each(response.DetailRencanaMandor, function(AvIndex, AvValue){
                ...
                $("#txtKodeGdRoll").select2({
    		          ...
    		          allowClear:true,
    		          ajax:{
    		            url : "<?php echo base_url(); ?>_cetak/main/getComboBoxValueGudangRoll/POLOS/"+panjangPlastik[0]+"/"+AvValue.warna_plastik,
    		            dataType : "JSON",
    		            delay : 0,
        ...
        function modalInputHasil(param){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_cetak/main/getDetailRencanaForInputHasil'); ?>",
            dataType : "JSON",
            data : {
              idTransaksi : param
            },
            success : function(response){
              $.each(response, function(AvIndex, AvValue){
                ...
                $.ajax({
                  ...
                  data : {
                    subApal : AvValue.warna_plastik
                  },
                  dataType : "JSON",
                  success : function(response){
                    $("#txtJenisApal").empty();
                    $.each(response, function(AvIndex3, AvValue3){
                      $("#txtJenisApal").append("<option value='"+AvValue3.kd_gd_apal+"'>"+AvValue3.sub_jenis+"</option>");
                    });
                ...
                $.ajax({
                  ...
                  success : function(response2){
                    $.each(response2, function(AvIndex2, AvValue2){
                      $("#txtBeratPengambilanExtruder").val((parseFloat(AvValue2.berat) > 0) ? parseFloat(AvValue2.berat) : 0);
                      $("#txtBobinPengambilanExtruder").val((parseFloat(AvValue2.bobin) > 0) ? parseFloat(AvValue2.bobin) : 0);
                      $("#txtPayungPengambilanExtruder").val((parseFloat(AvValue2.payung) > 0) ? parseFloat(AvValue2.payung) : 0);
                      $("#txtPayungKuningPengambilanExtruder").val((parseFloat(AvValue2.payung_kuning) > 0) ? parseFloat(AvValue2.payung_kuning) : 0);
                    });
                  },
          ...
          $("#cmbJenisRoll").change(function(){
            switch ($(this).val()) {
              ...
              case "PAYUNG_BOBIN"           : $("#tablePAYUNG").css("display","none");
                                              ...
                                              break;
              case "PAYUNG_KUNING_BOBIN"      : $("#tablePAYUNG").css("display","none");
                                              $("#tablePAYUNG_KUNING").css("display","none");
                                              $("#tableBOBIN").css("display","none");
                                              $("#tablePAYUNG_KUNING_PAYUNG").css("display","none");
                                              $("#tablePAYUNG_BOBIN").css("display","block");
        ...
        function modalDetailJob(param){
          ...
          $("#cmbJenisBahan").val("").change();
            ...
            if(jenisBarang){
              var url = "<?php echo base_url(); ?>_cetak/main/getBahan/"+jenisBarang;
            }else{
              var url = "";
            }
          ...
          $("#btnTambahPenggunaanBahan").attr("onclick", "tambahBahanBaru('"+param+"')");
          $("#modalDetailJob").modal({backdrop:"static"});
        }

        function modalEditDetailJobCetak(param){
          $.get("<?= base_url('_cetak/main/getListApal'); ?>","",function(response){
            $("#txtJenisApal").empty();
            $.each(response, function(AvIndex, AvValue){
          ...
          $.ajax({
            ...
            success : function(response){
              $.each(response, function(AvIndex, AvValue){
                ...
                $("#txtBeratPengambilanExtruder").val(AvValue.jumlah_berat_pengambilan_extruder);
                $("#txtBobinPengambilanExtruder").val(AvValue.jumlah_bobin_pengambilan_extruder);
                $("#txtPayungPengambilanExtruder").val(AvValue.jumlah_payung_pengambilan_extruder);
                $("#txtPayungKuningPengambilanExtruder").val(AvValue.jumlah_payung_kuning_pengambilan_extruder);
                ...
                $("#txtJenisApal").val(AvValue.kd_gd_apal);
                ...
                switch (AvValue.jenis_roll) {
                  ...
                  case "PAYUNG_BOBIN"           : $("#txtJumlahPayungPengambilan").removeAttr("disabled");
                                                  ...
                                                  $("#txtJumlahBobinHasilCetak").removeAttr("disabled");
                                                  break;
                  case "PAYUNG_KUNING_BOBIN"    : $("#txtJumlahPayungPengambilan").attr("disabled","disabled");
                                                  $("#txtJumlahPayungKuningPengambilan").removeAttr("disabled");
                                                  $("#txtJumlahBobinPengambilan").removeAttr("disabled");
                                                  $("#txtJumlahPayungHasilCetak").attr("disabled","disabled");
                                                  $("#txtJumlahPayungKuningHasilCetak").removeAttr("disabled");
...
//================================ RESET METHOD (START) ============================//
            ...
            success : function(response){
              ...
              $.each(response, function(AvIndex, AvValue){
                ...
                $("#txtKodeGdRoll").select2({
    		          ...
    		          allowClear:true,
    		          ajax:{
    		            url : "<?php echo base_url(); ?>_cetak/main/getComboBoxValueGudangRoll/POLOS/"+panjangPlastik[0].replace(" ","_")+"/"+AvValue.warna_plastik,
    		            dataType : "JSON",
    		            delay : 0,
    		            processResults : function(data){
    		              return{
        ...
        function resetFormBuatRencanaSusulanPending(){
          ...
          $("#cmbMerek").on("select2:select", function(){
            ...
            $("#cmbMerekPolos").select2({
              ...
              allowClear:true,
              ajax:{
                url : "<?php echo base_url(); ?>_cetak/main/getComboBoxValueGudangRoll/POLOS/"+arrDataText[1]+"/"+AvValue.warna_plastik,
                dataType : "JSON",
                delay : 0,
                processResults : function(data){
                  return{
        ...
        function resetTambahBahan(){
          $("#cmbJenisBahan").val("").change();
          $("#cmbNamaBahan").val("");
          $("#txtTglPengambilan").val("");
...
//================================ SAVE METHOD (START) ============================//
        ...
        function tambahBahanBaru(param){
          var kdHasilCetak = param;
          var kdGdBahan = $("#cmbNamaBahan").val();
          var jumlahPengambilan = $("#txtJumlahBahan").val();
          var sisaPengambilan = $("#txtSisaBahan").val();
          var tglPengambilan = $("#txtTglPengambilan").val();

          if(kdGdBahan == "" || jumlahPengambilan=="" ||
             sisaPengambilan=="" || tglPengambilan==""){
            $("#modal-notif").addClass("modal-warning");
            $("#modalNotifContent").text("Semua Kolom Tidak Boleh Kosong!");
            $("#modal-notif").modal("show");
            setTimeout(function(){
            ...
            $.ajax({
              type : "POST",
              url : "<?= base_url("_cetak/main/tambahBahanBaru"); ?>",
              dataType : "TEXT",
              data : {
                kdHasilCetak      : kdHasilCetak,
                kdGdBahan         : kdGdBahan,
                jumlahPengambilan : jumlahPengambilan,
             ...
             $.ajax({
               ...
               success : function(response){
                 if($.trim(response) === "Berhasil"){
                   ...
                   $("#modal-notif").addClass("modal-danger");
                   $("#modalNotifContent").text("Maaf Periode Tersebut Sudah Di Kunci");
                   $("#modal-notif").modal("show");
                   setTimeout(function(){
                     $("#modal-notif").modal("hide");
                     $("#modal-notif").removeClass("modal-danger");
...
//================================ DATATABLE METHOD (START) ============================//
        function datatableRencanaPPIC(param1="", param2=""){
          ...
          $("#tableRencanaPPIC").dataTable({
            ...
            "fnRowCallback" : function(AvRow, AvData, AvDisplayIndex, AvDisplayIndexFull){
              ...
              $("td:eq(10)",AvRow).text(parseFloat(AvData["jumlah_permintaan"]).toLocaleString()+" "+AvData["satuan"]);
              if(AvData["satuan_kilo"]==null || AvData["satuan_kilo"]==""){
                $("td:eq(11)",AvRow).text(parseFloat(AvData["sisa"]).toLocaleString()+" "+AvData["satuan"]);
              }else{
                $("td:eq(11)",AvRow).text(parseFloat(AvData["sisa"]).toLocaleString()+" KG");
              }
        ...
        function datatablesListRencanaMandor(){
          ...
          $("#tableRencanaMandor").dataTable({
            ...
            "fnRowCallback" : function(AvRow, AvData, AvDisplayIndex, AvDisplayIndexFull){
              $("td:eq(0)",AvRow).text(++AvDisplayIndex);
              $("td:eq(9)",AvRow).text(parseFloat(AvData["stok_permintaan"]).toLocaleString()+" KG");
              $("td:eq(10)",AvRow).text(parseFloat(AvData["jml_permintaan"]).toLocaleString()+" KG");
        ...
        function datatableHasilCetak(param1, param2){
          ...
          $.ajax({
            type : "POST",
            url : "<?= base_url('_cetak/main/getListHasilCetak'); ?>",
            dataType : "JSON",
            data : {
              tglAwal : param1,
              tglAkhir : param2
            ...
            success : function(response){
              for (var i = 0; i < response.data.length; i++) {
                totalBeratBahan += parseFloat(response.data[i].jumlah_berat_pengambilan);
                totalBeratApal += parseFloat(response.data[i].jumlah_apal);
              }
              $("#tdTotalPenggunaanBahan").text(totalBeratBahan.toLocaleString());
              $("#tdTotalBeratApal").text(totalBeratApal.toLocaleString());
            }
          });
        }
          ...
          $.ajax({
            ...
            success : function(response){
              ...
              $.each(response, function(AvIndex, AvValue){
                $("#tableDataBonPengambilanBahan > tbody:last-child").append(
                  "<tr>"+
                    ...
                    "<td>"+parseFloat(AvValue.jumlah_pengambilan).toLocaleString()+"</td>"+
              ...
              for (var i = 0; i < response.length; i++) {
                totalBeratApal += parseFloat(response[i].jumlah_pengambilan);
              }
        ...
        function tableListDataPengambilanGudang(param1, param2){
          $.ajax({
            ...
            success : function(response){
              var totalBerat = 0;
              var totalBeratBobin = 0;
              var totalBeratPayung = 0;
              var totalBeratPayungKuning = 0;
              $("#tableDataBonPengambilanBahan > tbody > tr").empty();
              $.each(response, function(AvIndex, AvValue){
                $("#tableDataBonPengambilanBahan > tbody:last-child").append(
                  "<tr>"+
                    ...
                    "<td>"+AvValue.ukuran+"</td>"+
                    "<td>"+AvValue.warna_plastik+"</td>"+
                    "<td>"+parseFloat(AvValue.jumlah_berat_pengambilan).toLocaleString()+"</td>"+
                    "<td>"+parseFloat(AvValue.jumlah_bobin_pengambilan).toLocaleString()+"</td>"+
                    "<td>"+parseFloat(AvValue.jumlah_payung_pengambilan).toLocaleString()+"</td>"+
                    "<td>"+parseFloat(AvValue.jumlah_payung_kuning_pengambilan).toLocaleString()+"</td>"+
                  "</tr>"
                );
              });

              for (var i = 0; i < response.length; i++) {
                totalBerat += parseFloat(response[i].jumlah_berat_pengambilan);
                totalBeratBobin += parseFloat(response[i].jumlah_bobin_pengambilan);
                totalBeratPayung += parseFloat(response[i].jumlah_payung_pengambilan);
                totalBeratPayungKuning += parseFloat(response[i].jumlah_payung_kuning_pengambilan);
              }
              $("#thTotalBerat").text(totalBerat.toLocaleString());
              $("#thTotalBeratBobin").text(totalBeratBobin.toLocaleString());
              $("#thTotalBeratPayung").text(totalBeratPayung.toLocaleString());
              $("#thTotalBeratPayungKuning").text(totalBeratPayungKuning.toLocaleString());
            },
            error : function(response){
              $("#modal-notif").addClass("modal-danger");
              $("#modalNotifContent").text("Server Fault Error Code ( "+response.status+" ) "+response.statusText);
...
//================================ UNSPECIFIED METHOD (START) ============================//
        function hitungRollPipa(){
          ...
          if(jenisPipa == "PAYUNG"){
          ...
          }else if(jenisPipa == "PAYUNG_KUNING_BOBIN"){
            var arrUkuran = ukuran.split("x");
						var panjang = arrUkuran[0].replace(",",".");
						var arrPanjangPlastik = panjang.replace(/PON/gi,"").split("+");
            var doubleSingle = $("#txtDoubleSingle_PB").val().replace(/,/g,"");
            ...
            if(TPanjangPlastik < 40){
							var rollPipa = ((parseFloat(jumlahPayung)*4000)/1000) + ((TPanjangPlastik * parseFloat(doubleSingle) * 30 * parseFloat(jumlahBobin))/1000);
              $("#txtRollPipa").val(rollPipa);
						}else{
							var rollPipa = ((parseFloat(jumlahPayung)*5000)/1000) + ((TPanjangPlastik * parseFloat(doubleSingle) * 30 * parseFloat(jumlahBobin))/1000);
              $("#txtRollPipa").val(rollPipa);
