        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <div class="box-title">
                <h4 class="text-primary">Detail Gudang Bahan</h4>
              </div>
            ...
            <div class="box-footer" id="footer" style="display:none;">
              ...
              <button type="button" class="btn btn-md btn-flat btn-success" id="btnExport" disabled><i class="fa fa-file-excel-o"></i> Export Excel</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" id="btnCari" class="btn btn-md btn-flat btn-success" onclick="searchDataGudangBahan('<?php echo $JENIS; ?>')">Cari</button>
            </div>
          </div>
        </div>
      </div>
