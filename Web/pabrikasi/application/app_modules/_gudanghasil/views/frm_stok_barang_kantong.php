        ...
        <div class="col-md-12">
          <?php
            if(strtolower($this->session->userdata("fabricationGroup")) != "gudang hasil"){
              $TambahBarangBaru = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahGudangHasil" onclick=modalTambahBarangBaru("KANTONG");><i class="fa fa-plus"></i> Tambah Barang Baru</button>';
              $TambahDataAwal = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahDataAwal" onclick=modalTambahDataAwalGudangHasil("KANTONG")><i class="fa fa-plus"></i> Tambah Data Awal</button>';
            }else{
              $TambahBarangBaru = '';
              $TambahDataAwal='';
            }
