        ...
        <div class="col-md-12">
          <?php
            if(strtolower($this->session->userdata("fabricationGroup")) != "gudang hasil"){
              $TambahBarangBaru = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahGudangHasil" onclick=modalTambahBarangBaru("SABLON","CETAK");><i class="fa fa-plus"></i> Tambah Barang Baru</button>';
              $TambahDataAwal = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahDataAwal" onclick=modalTambahDataAwalGudangHasil("SABLON","CETAK")><i class="fa fa-plus"></i> Tambah Data Awal</button>';
            }else{
              $TambahBarangBaru = '';
              $TambahDataAwal='';
            }
          ...
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengambilanSablon" onclick="modalPengambilanKanvas('SABLON','KANVAS','CETAK')"><i class="fa fa-plus"></i> Tambah Pengambilan Kanvas</button>
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengambilanSablon" onclick="modalPengambilanKanvas('SABLON','ONLINE','CETAK')"><i class="fa fa-plus"></i> Tambah Pengambilan Online</button>
      ...
      <div class="modal fade" id="modalCariHistory" role="dialog" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="cariHistoryGudangHasil('SABLON')"><i class="fa fa-search"></i> Cari History</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              ...
              <div class="col-md-12">
                <h4 class="text-blue">Daftar Pengririman Gudang Hasil Sablon</h4>
