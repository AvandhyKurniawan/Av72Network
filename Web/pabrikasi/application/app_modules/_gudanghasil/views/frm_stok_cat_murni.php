          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <fieldset>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        ...
                        <div class="input-group textKeterangan" style="width:100%; float:left; display:none;">
                          <input type="text" id="txtKeterangan2" class="form-control" placeholder="Masukan Keterangan" style="width:98%; float:left;">
                ...
                <button type="button" class="btn btn-md btn-flat btn-warning pull-right" onclick="resetFormKoreksi('CAT_MURNI');">Batal</button>
                <small class="text-red">
                  Note : 1. Kolom Berwarna Kuning Tidak Boleh Kosong<br>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  2. Jika Tidak Ingin Mengubah Barang Maka Kolom Barang Dikosongkan Saja
