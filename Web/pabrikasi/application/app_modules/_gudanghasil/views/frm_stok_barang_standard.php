        ...
        <div class="col-md-12">
          <?php
            if(strtolower($this->session->userdata("fabricationGroup")) != "gudang hasil"){
              $TambahBarangBaru = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahGudangHasil" onclick=modalTambahBarangBaru("STANDARD");><i class="fa fa-plus"></i> Tambah Barang Baru</button>';
              $TambahDataAwal = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahDataAwal" onclick=modalTambahDataAwalGudangHasil("STANDARD")><i class="fa fa-plus"></i> Tambah Data Awal</button>';
            }else{
              $TambahBarangBaru = '';
              $TambahDataAwal='';
            }
          ...
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengambilanSablon" onclick="modalPengambilanKanvas('STANDARD','KANVAS')"><i class="fa fa-plus"></i> Tambah Pengambilan Kanvas</button>
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengambilanSablon" onclick="modalPengambilanKanvas('STANDARD','ONLINE')"><i class="fa fa-plus"></i> Tambah Pengambilan Online</button>
