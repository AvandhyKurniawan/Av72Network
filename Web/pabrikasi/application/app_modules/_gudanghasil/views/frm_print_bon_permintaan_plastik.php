  ...
  <body>
    <div>
      <div class="header">
        ...
        <center>
          <h3>Bon Permintaan Plastik HD</h3>
        </center>
        <div style="float:left; width:50%; border:0; margin-top : 50px;">
          <table width="100%" style="border:0;">
            <tr>
              ...
              <td style="border:0;"><?php echo $DataPermintaan[0]["kd_permintaan_plastik"]; ?></td>
            </tr>
            <tr>
      ...
      <table width='100%' id="table">
        <thead>
          <tr>
            ...
            <th rowspan="2" align="center">Warna</th>
            <th colspan="2" align="center">QTY</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><center><?php echo $arrValue["ukuran"]." ".$arrValue["merek"]." (".$arrValue["tebal"].")"; ?></center></td>
            <td><center><?php echo $arrValue["warna_plastik"]; ?></center></td>
            <td>
              <center>
                <?php
                  if(strpos($arrValue["jumlah_berat_permintaan"],".00") !== FALSE){
                    echo number_format(substr($arrValue["jumlah_berat_permintaan"],0,strlen($arrValue["jumlah_berat_permintaan"])-3));
                  }else{
                    echo number_format($arrValue["jumlah_berat_permintaan"],1);
                  }
                ?>
              </center>
            </td>
            <td>
              <center>
                <?php
                  echo number_format($arrValue["jumlah_lembar_permintaan"],0);
                ?>
              </center>
            </td>
