    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <?php
            if(strtolower($this->session->userdata("fabricationGroup")) != "gudang hasil"){
              $TambahBarangBaru = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahGudangHasil" onclick=modalTambahBarangBaru("SABLON","POLOS");><i class="fa fa-plus"></i> Tambah Barang Baru</button>';
              $TambahDataAwal = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahDataAwal" onclick=modalTambahDataAwalGudangHasil("SABLON","POLOS")><i class="fa fa-plus"></i> Tambah Data Awal</button>';
            }else{
              $TambahBarangBaru = '';
              $TambahDataAwal='';
            }
        ...
        <div class="col-md-12" style="margin-top: 10px;">
          ...
          <div class="col-md-6" style="display: none; cursor: pointer;" id="alertKembalianSablon">
            <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalKembalianSablon" onclick="modalKembalianHDSablon('SABLON')">
            <div class="alert alert-info">
              <h4>
      ...
      <div id="modalKembalianSablon" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-lg" style="width: 1050px;margin: auto; padding-top: 20px;">
          <!-- konten modal-->
          <div class="modal-content">
            <!-- heading modal -->
            <div class="modal-header" style="background-color:#00a65a;">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h3 class="modal-title" style="text-align: center; color: black;">&nbsp;&nbsp;Daftar Kembalian Barang Gudang Buffer<span id="title_barang"></span></h3>
            </div>
            <!-- body modal -->
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
            <div class="content">
            ...
            <!-- footer modal -->
            <div class="modal-footer" style="text-align: center; color: black;">
              <button class="btn btn-flat bg-navy margin" onclick="approveKembalianHDSablon('SABLON')" style="margin: auto; width:30%; position: relative;">APPROVE</button>
            </div>
          </div>
        </div>
      </div>
