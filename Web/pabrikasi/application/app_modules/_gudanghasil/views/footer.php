...
<!--===============================================On Load Function (Start) ===============================================-->
      <script type="text/javascript">
        $(function () {
          ...
          setInterval(reloadCounterOrderDeadline, 60000);
          ...
          if($("#tableDetailPermintaanPlastikHd").length > 0){
            datatablesDetailPermintaanPlastikHd();
          }

          if($("#alertKembalianSablon").length > 0){
            alertKembalianSablon();
          }

          if($("#alertKembalianSablonCampur").length > 0){
            alertKembalianSablonCampur();
          }
          ...
          $(".number").inputmask("decimal",{rightAlign: false,radixPoint: ".",groupSeparator: ",",digits: 5,autoGroup: true});
...
<!--===============================================General Function (Start) ===============================================-->
      ...
      function modalEditHistory(param1,param2,param3,param4,param5,param6=""){
        if(param6 != ""){
          ...
          var jenisGudang = param1+"_"+param6;
        }else{
          var jnsPermintaan = "";
          var jenisGudang = param1;
        }
        $("#modalEditHistoryMasukGudangHasil").modal({
          backdrop : "static"
        });
        $("#cmbJenisGudang").val(jenisGudang);
        $("#cmbUkuran6").select2({
        ...
        $.ajax({
          ...
          success : function(response){
            $.each(response,function(AvIndex,AvValue){
              ...
              $("#txtBeratMasukHistory").val(parseFloat(AvValue.jumlah_berat).toLocaleString());
              $("#txtLembarMasukHistory").val(parseFloat(AvValue.jumlah_lembar).toLocaleString());
              if(AvValue.jumlah_terkirim != null){
                $("#trJumlahPengiriman").removeAttr("style");
                $("#txtJumlahPengiriman").val(parseFloat(AvValue.jumlah_terkirim).toLocaleString());
      ...
      function modalPengambilanSablon(param,param2=""){
        ...
        $("#h4ModalPengambilanSablon").text("Formulir Pengambilan Barang Ke Sablon");
        $("#tdUkuranBarangSablon").text("Ukuran Barang Sablon (Buffer)");
        $("#h4HeaderTable").text("Daftar Pengambilan Sablon Di Gudang Hasil ( "+param+" )");
        var placeholder = param.replace("_"," ");
        $("#cmbUkuran2").select2({
          placeholder : "Pilih Hasil ("+placeholder+")",
      ...
      function modalPengambilanKanvas(param,param2="", param3=""){
        ...
        $("#cmbUkuran2").select2({
          ...
          allowClear:true,
          ajax:{
            url : "<?php echo base_url(); ?>_gudanghasil/main/getComboBoxValueHasil/"+param+"/"+param3,
            dataType : "JSON",
            delay : 0,
            processResults : function(data){
              return{
      ...
      function modalPembelianBarangHd(){
        ...
        $.ajax({
          ...
          success : function(response){
            $("#cmbUkuran5").empty();
            $.each(response, function(AvIndex, AvValue){
              $("#cmbUkuran5").append("<option value='"+AvValue.kd_gd_hasil+"'>"+AvValue.ukuran+" | "+AvValue.merek+" | "+AvValue.warna_plastik+" | "+AvValue.jns_brg+" | "+AvValue.sts_brg+" | "+AvValue.jns_permintaan+" | "+AvValue.tebal+"</option>");
            });
      ...
      function modalPermintaanBarangHd(){
        $("input").val("");
        $(".date").datepicker("setDate",null);
        $.ajax({
          url : "<?php echo base_url(); ?>_gudanghasil/main/getDataUntukPermintaanPlastikHD",
          dataType : "JSON",
          success : function(response){
            $("#cmbUkuran8").empty();
            $.each(response.DataPlastik, function(AvIndex, AvValue){
              $("#cmbUkuran8").append("<option value='"+AvValue.kd_gd_hasil+"'>"+AvValue.ukuran+" | "+AvValue.merek+" | "+AvValue.warna_plastik+" | "+AvValue.jns_brg+" | "+AvValue.sts_brg+" | "+AvValue.jns_permintaan+" | "+AvValue.tebal+"</option>");
            });
            $("#txtKodePermintaan").val(response.KodePRHD);

            $("#btnAddPermintaanHd").attr("onclick","saveAddPermintaanHd()");
            $("#btnSavePermintaanHd").attr("onclick","savePermintaanHd()");
            tableListPermintaanBarangHd();
          }
        });
      }
        ...
        $.ajax({
          ...
          success : function(response){
            $.each(response, function(AvIndex, AvValue){
              ...
              $("#txtNamaCustomer").val(AvValue.customer);
              $("#txtJumlahOrder").val(parseFloat(AvValue.jumlah_pesanan).toLocaleString());
              $("#txtJumlahPerKg").val(parseFloat(AvValue.jumlah_kg).toLocaleString());
              $("#txtJumlahPerLembar").val(parseFloat(AvValue.jumlah_lembar).toLocaleString());
              $("#txtJumlahDikirim").val(parseFloat(AvValue.jumlah_terkirim).toLocaleString());
              $("#txtKeterangan").val(AvValue.keterangan);
              ...
              $("#txtJumlahSebelum").val(parseFloat(AvValue.jumlah_terkirim).toLocaleString());
            });
          }
        });
      }
      ...
      function modalKoreksi(param){
        ...
        $("#cmbKeterangan").on("change",function(){
          if(this.value == "CUSTOM"){
            $("#cmbKeterangan").css("display","none");
            $(".textKeterangan").css("display","block");
          }else{
            $("#cmbKeterangan").css("display","block");
            $(".textKeterangan").css("display","none");
          }
        });
      ...
      function modalShowOrderDeadline(){
        ...
        $('#tableListPesananLewatTglEstimasi').dataTable({
          ...
          "sAjaxSource":"<?php echo base_url(); ?>_gudanghasil/main/getOrderDeadline",
          "columns":[
          ...
          "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
            $("td:eq(0)",nRow).html("<a href='#' data-toggle='modal' data-target='#modal-lihat-detail-pesanan' data-backdrop='static' onclick=lihatDetailPesanan('"+aData['no_order']+"') class='bg-blue'>"+aData['no_order']+"</a>");
            ...
            $("td:eq(13)",nRow).html("<button class='btn btn-md btn-flat btn-default'>Anda Tidak Memiliki Akses Ubah Tanggal</button>")
            // if(aData["approve_6"] == "FALSE"){
            //   $("td:eq(13)",nRow).text("");
            // }else{
      ...
      function modalTerimaPlastikSetengah(param, param2){
        $(".trJumlahPermintaan").css("display","table-row");
        $("#btnTerima").attr("onclick","terimaPlastikSetengah('"+param+"','"+param2+"')");
        $("#modalInputPenerimaanBarang").modal({
          backdrop : "static"
        });
      }

      function modalTerimaPlastikFull(param, param2){
        $(".trJumlahPermintaan").css("display","none");
        $("#btnTerima").attr("onclick","terimaPlastikFull('"+param+"','"+param2+"')");
        $("#modalInputPenerimaanBarang").modal({
          backdrop : "static"
        });
      }

      function modalEditHistoryCat(param,param2,param3,param4,param5){
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudanghasil/main/getDetailTransaksiGudangBahan",
          dataType : "JSON",
          data : {id:param2},
          success : function(response){
      ...
      function saveAddPengirimanBaruTemp(){
        ...
        if(tglPengiriman1==""||customer1==""||jumlahPesanan1==""||jumlahBerat1==""||
           ...
           idDp1==""||warna1==""||jumlahDikirim1==""
            ...
            if(jumlahDikirim1 > sisa1){
              if(confirm("Jumlah Pengiriman Melebihi Sisa, Ingin Melanjutkan Pengiriman?")){
                booleanFlag = true;
              }
            }else{
              booleanFlag = true;
      ...
      function savePengambilanKanvasTemp(param){
        ...
        if(tanggal1=="" || kdGdHasil1=="" || jumlahLembar1=="" || jumlahBerat1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudanghasil/main/addPengambilanKanvas",
            dataType : "TEXT",
            data : {kdGdHasil     : kdGdHasil1,
                    kdGdSablonBuffer : kdGdSablonBuffer1,
                    tanggal       : tanggal1,
      ...
      function savePengambilanKanvas(param){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudanghasil/main/savePengambilanKanvas",
            data : {
              jnsGudang : param
            },
            dataType : "TEXT",
      ...
      function saveCartKoreksi(param){
        ...
        var jenisKoreksi1 = $("#cmbJenisKoreksi").val();
        if($("#cmbKeterangan").val() == "CUSTOM"){
          if($("#txtKeterangan2").val().toUpperCase().indexOf("KOREKSI") != -1){
            var keterangan1 = $("#txtKeterangan2").val().toUpperCase();
          }else{
            var keterangan1 = "KOREKSI "+ $("#txtKeterangan2").val().toUpperCase();
          }
        }else{
      ...
      function terimaPlastikFull(param, param2){
        var namaSupplier = $("#txtNamaSupplier").val();
        var tglTerima = $("#txtTglTerima").val();
        ...
        if(namaSupplier=="" || tglTerima==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/terimaPlastikFull'); ?>",
            dataType : "TEXT",
            data : {
              idDpp         : param,
              idPermintaan  : param2,
      ...
      function terimaPlastikSetengah(param, param2){
        var namaSupplier = $("#txtNamaSupplier").val();
        var tglTerima = $("#txtTglTerima").val();
        var jumlahBeratTerima = $("#txtJumlahBeratPenerimaan").val().replace(/,/gi,"");
        var jumlahLembarTerima = $("#txtJumlahLembarPenerimaan").val().replace(/,/gi,"");

        if(namaSupplier=="" || tglTerima=="" || jumlahBeratTerima=="" || jumlahLembarTerima==""){
          $("#modal-notif").addClass("modal-warning");
          $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
          $("#modal-notif").modal("show");
          setTimeout(function(){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/terimaPlastikSetengah'); ?>",
            dataType : "TEXT",
            data : {
              idDpp              : param,
              idPermintaan       : param2,
              namaSupplier       : namaSupplier,
              tglTerima          : tglTerima,
              jumlahBeratTerima  : jumlahBeratTerima,
              jumlahLembarTerima : jumlahLembarTerima
            },
            success : function(response){
              if($.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
      ...
      function saveAddPermintaanHd(){
        var kodePermintaan = $("#txtKodePermintaan").val();
        var kdGdHasil1 = $("#cmbUkuran8").val();
        var tanggal1 = $("#txtTanggalPermintaan").val();
        var jumlahBerat1 = $("#txtBeratPermintaan").val().replace(/,/g,"");
        var jumlahLembar1 = $("#txtLembarPermintaan").val().replace(/,/g,"");
        if(kdGdHasil1 != null){
          var dataText = $("#cmbUkuran8 option:selected").text();
          var arrDataText = dataText.split(" | ");
          var ukuran = arrDataText[0];
          var merek = arrDataText[1];
          var warna_plastik = arrDataText[2];
          var tebal = arrDataText[6];
        }else{
          var ukuran = "";
          var merek = "";
          var warna_plastik = "";
        ...
        if(kdGdHasil1==""||tanggal1==""||jumlahBerat1==""||jumlahLembar1==""){
          $("#modal-notif").addClass("modal-warning");
          $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
          $("#modal-notif").modal("show");
          setTimeout(function(){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudanghasil/main/saveAddPermintaanHd",
            dataType : "TEXT",
            data : {
      ...
      function savePermintaanHd(){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            url : "<?php echo base_url('_gudanghasil/main/savePermintaanHd'); ?>",
            dataType : "TEXT",
            success : function(response){
              if($.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
      ...
      function selesaiPermintaanPlastik(param, param2){
        if(confirm("Apakah Anda Yaki Ingin Menyelesaikan Pesanan Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/selesaiPermintaanPlastik'); ?>",
            dataType : "TEXT",
            data : {
              idDpp : param,
              idPermintaan : param2
            ...
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                ...
                setTimeout(function(){
                  ...
                  $("#btnRefreshTableHistory").click();
                  $(".active a[aria-controls='tableHistoryGudangHasilKeluar']").click();
                },2000);
              }else if(jQuery.trim(response) === "Gagal"){
                $("#modal-notif").addClass("modal-danger");
      ...
      function editHistoryGudangBahan(param,param2,param3,param4){
        ...
        if(id1==""||tglTransaksi1==""||jumlah1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudanghasil/main/editHistoryGudangBahan",
            dataType : "TEXT",
      ...
      function deletePengambilanKanvasTemp(param, param2){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudanghasil/main/deleteAndRestorePengambilanKanvasTemp",
            dataType : "TEXT",
            data : {idPengambilanKanvas : param, deleted : "TRUE"},
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
                $("#modalNotifContent").text("Data Berhasil Dihapus");
      ...
      function deleteAndRestoreDetailPermintaanBarang(param, param2, param3){
        ...
        if(confirm(teksKonfirmasi)){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/deleteAndRestoreDetailPermintaanBarang'); ?>",
            dataType : "TEXT",
            data : {
              idTransaksi  : param,
              kdPermintaan : param2,
      ...
      function deletePermintaanPlastikHdTemp(param,param2){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url() ?>_gudanghasil/main/removePembelianTemp",
            ...
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
                $("#modalNotifContent").text("Permintaan Berhasil Dihapus");
                $("#modal-notif").modal("show");
                setTimeout(function(){
                  $("#modal-notif").modal("hide");
                  $("#modal-notif").removeClass("modal-info");
      ...
      function deleteAndRestoreDetailPermintaanPlastik(param, param2, param3){
        if(param3 == "TRUE"){
          teksKonfirmasi = "Apakah Anda Yakin Ingin Menghapus Permintaan Ini?";
          textBerhasil = "Data Berhasil Dihapus";
          textGagal = "Data Gagal Dihapus";
        ...
        if(confirm(teksKonfirmasi)){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/deleteAndRestoreDetailPermintaanPlastik'); ?>",
            dataType : "TEXT",
            data : {
              idTransaksi  : param,
              kdPermintaan : param2,
      ...
      function reloadCounterOrderDeadline(){
        $.ajax({
          url : "<?php echo base_url('_gudanghasil/main/getCountOrderDeadline'); ?>",
          dataType : "JSON",
          success : function(response){
      ...
      function lihatDetailPesanan(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudanghasil/main/getLihatPesanan",
          dataType : "JSON",
          data : {no_order : param},
          success : function(response){
            ...
            $("#tabel-lihat-pesanan-detail").dataTable({
              ...
              "sAjaxSource" : "<?php echo base_url(); ?>_gudanghasil/main/getLihatPesananDetail?no_order="+param,
              "columns" : [
      ...
      function searchDataKartuStokCat(){
        var tglAwal = $("#txtTglAwal").val();
        var tglAkhir = $("#txtTglAkhir").val();
        var jenis = $("#cmbJenis").val();

        tableCekKartuStokCat(tglAwal,tglAkhir,jenis);
        $("#btnSortir").attr("onclick","searchDataKartuStokCat('"+tglAwal+"','"+tglAkhir+"','"+jenis+"')");
        $("#modalCariKartuStok").modal("hide");
      }
      ...
      function datatableListPengirimanBaru(param1){
        ...
        $("#tableDataPengirimanBaru").dataTable({
          ...
          "fnRowCallback" : function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            $("td:eq(1)",nRow).html(aData["ukuran"]+
                                    "<label class='text-red'>["+aData["jns_brg"]+"]</label>"+
                                    "<label class='text-green'>["+aData["sts_pesanan"]+"]</label>"+
                                    "<label class='text-purple'>["+aData["sts_kirim"]+"]</label>");
      ...
      function datatableListPesananTerkirim(param1){
        ...
        $("#tableDataOrderTerkirim").dataTable({
          ...
          "fnRowCallback" : function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            $("td:eq(3)",nRow).html(aData["ukuran"]+
                                    "<label class='text-red'>["+aData["jns_brg"]+"]</label>"+
                                    "<label class='text-green'>["+aData["sts_pesanan"]+"]</label>"+
                                    "<label class='text-purple'>["+aData["sts_kirim"]+"]</label>");
            ...
            $.each(response,function(index,value){
              $("#tableListPengirimanBaruTemp > tbody:last-child").append(
                "<tr>"+
                  ...
                  "<td>"+ value.ukuran+"</td>"+
                  "<td>"+ parseFloat(value.jumlah_pesanan).toLocaleString()+"</td>"+
                  "<td>"+ parseFloat(value.jumlah_terkirim).toLocaleString()+"</td>"+
                  "<td>"+ parseFloat(value.jumlah_kg).toLocaleString()+"</td>"+
      ...
      function tableListDetailPengiriman(param){
        $.ajax({
          ...
          success : function(response){
            ...
            $.each(response,function(index,value){
              if(value.sts_kirim == "TERKIRIM" && value.tgl_kirim != null){
                var attr1 = "disabled";
                var attr2 = "disabled";
              }else{
                var attr1 = "onclick=modalEditDataOrderTerkirim('"+value.id_detail_pengiriman+"')";
                var attr2 = "onclick=deleteDataOrderTerkirim('"+value.id_detail_pengiriman+"')";
              }
              $("#tableListDetailPengiriman > tbody:last-child").append(
                "<tr>"+
                  ...
                  "<td>"+value.status+"</td>"+
                  "<td>"+
                    "<button class='btn btn-md btn-flat btn-warning' "+attr1+">Ubah</button>"+
                    "<button class='btn btn-md btn-flat btn-danger' "+attr2+">Hapus</button>"+
                  "</td>"+
                "</tr>"
              )
            });
      ...
      function datatableListGudangHasil(param1,param2,param3=""){
        ...
        $(param1).dataTable({
          ...
          "columns" : [
            ...
            {"data" : "ukuran", "name" : "merek"},
            {"data" : "tebal", "name" : "warna_plastik"},
          ...
          "fnRowCallback" : function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            $("td:eq(9)",nRow).html("<button class='btn btn-md btn-flat btn-warning' onclick=modalEditBarangGudangHasil('"+aData["kd_gd_hasil"]+"')><i class='fa fa-edit'></i> Ubah</button>"+
        ...
        $("#tableHistoryGudangHasilKeluar").dataTable({
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            if(aData["status_lock"] == "TRUE"){
              ...
              if(aData["keterangan_history"].toUpperCase().indexOf("PENGAMBILAN") == -1){
                $("td:eq(4)",nRow).html("<button class='btn btn-md btn-flat btn-success' onclick=modalEditHistory('"+param+"','"+aData['id_permintaan_jadi']+"','"+tglAwal+"','"+tglAkhir+"','"+kdGdHasil+"')><span class='fa fa-edit'></span> Ubah</button>");
              }else{
                $("td:eq(4)",nRow).html("<button class='btn btn-md btn-flat btn-success' onclick=modalEditHistory('"+param+"','"+aData['id_permintaan_jadi']+"','"+tglAwal+"','"+tglAkhir+"','"+kdGdHasil+"')><span class='fa fa-edit'></span> Ubah</button>"+
                                        "<button class='btn btn-md btn-flat btn-danger' onclick=deleteTransaksiGudangHasil('"+param+"','"+aData['id_permintaan_jadi']+"','"+tglAwal+"','"+tglAkhir+"','"+kdGdHasil+"')><span class='fa fa-trash'></span> Hapus</button>");
            ...
            if(aData["keterangan"] !=null){
              ...
              $("td:eq(3)",nRow).html(aData["keterangan_history"] +" <b>[ "+aData["keterangan_barang"]+" ]</b> ");
            }
          }
        });
      ...
      function datatableTrashHistoryGudangHasil(){
        ...
        $("#tableTrashTransaksi").dataTable({
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            $("td:eq(2)",nRow).text(parseFloat(aData["jumlah_berat"]).toLocaleString());
            $("td:eq(3)",nRow).text(parseFloat(aData["jumlah_lembar"]).toLocaleString());
      ...
      function tableListPengambilanKanvasTemp(param){
        $.ajax({
          type : "GET",
          url : "<?php echo base_url(); ?>_gudanghasil/main/getListPengambilanKanvasTemp",
          data : {
            jnsGudang : param
          },
          dataType : "JSON",
      ...
      function tableListPermintaanBarangHd(){
        $.ajax({
          url : "<?php echo base_url(); ?>_gudanghasil/main/getPermintaanPlastikHdTemp",
          dataType : "JSON",
          success : function(response){
            $("#tableListPermintaanBarangHd > tbody > tr").empty();
            $.each(response, function(AvIndex, AvValue){
              $("#tableListPermintaanBarangHd > tbody:last-child").append(
                "<tr>"+
                  "<td>"+ ++AvIndex +"</td>"+
                  "<td>"+AvValue.tgl_permintaan+"</td>"+
                  "<td>"+AvValue.ukuran+"("+AvValue.tebal+")"+"</td>"+
                  "<td>"+AvValue.jumlah_berat_permintaan+"</td>"+
                  "<td>"+AvValue.jumlah_lembar_permintaan+"</td>"+
                  "<td>"+AvValue.warna_plastik+"</td>"+
                  "<td>"+AvValue.merek+"</td>"+
                  "<td>"+
                    "<button class='btn btn-sm btn-flat btn-danger' onclick=deletePermintaanPlastikHdTemp('"+AvValue.rowid+"')><i class='fa fa-trash'></i> Hapus</button>"+
                  "</td>"+
                "</tr>"
              );
            });
      ...
      function tableCekKartuStokCat(param, param2, param3){
        var group = "<?php echo $this->session->userdata('fabricationGroup'); ?>";
        var havingStokMaster = $("#cmbStokMaster").val();
        var havingStokAwal = $("#cmbStokAwal").val();
        var havingStokAkhir = $("#cmbStokAkhir").val();
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url('_gudanghasil/main/getCekKartuStokCat'); ?>",
          dataType : "JSON",
          data : {
            tglAwal : param,
            tglAkhir : param2,
          ...
          success : function(response){
            ...
            $.each(response.saldoAwal, function(AvIndex, AvValue){
              var kdGdBahan = AvValue.kd_gd_bahan;

              var attr = "onclick=checkedAndUncheckedBahan(this,'TRUE','','"+periode+"')";
              var icon = "<i class='fa fa-square-o'></i>";

              $.each(response.dataCheklist, function(AvIndex2, AvValue2){
                if(AvValue2.kd_gd_bahan == kdGdBahan){
                  if(AvValue2.ceklis == "FALSE"){
                    if(group == "gudang hasil"){
                      attr = "";
                    }else{
                      attr = "onclick=checkedAndUncheckedBahan(this,'TRUE','"+AvValue2.id_ceklis_gb+"','"+periode+"')";
                    }
                    icon = "<i class='fa fa-square-o'></i>";
                  }else{
                    if(group == "gudang hasil"){
                      ...
                      attr = "onclick=checkedAndUncheckedBahan(this,'FALSE','"+AvValue2.id_ceklis_gb+"','"+periode+"')";
                    }
                    icon = "<i class='fa fa-check-square-o'></i>";
                  }
                }
              ...
              totalJumlahBeratMasukPerPeriode += parseFloat(AvValue.beratMasukPerPeriode);
              // totalJumlahLembarMasukPerPeriode += parseFloat(AvValue.totalLembarMasukPerPeriode);
              totalJumlahBeratKeluarPerPeriode += parseFloat(AvValue.beratKeluarPerPeriode);
              // totalJumlahLembarKeluarPerPeriode += parseFloat(AvValue.totalLembarKeluarPerPeriode);
              if(parseFloat(AvValue.beratMasukPerPeriode) > 0 ||
                 parseFloat(AvValue.beratKeluarPerPeriode) > 0 ||
                 parseFloat(AvValue.saldoAwal) > 0
              ){
               $("#tableDataKartuStok > tbody:last-child").append(
                 "<tr>"+
                   "<td>"+ ++AvIndex +"</td>"+
                   ...
                   // "<td>"+ parseFloat(AvValue.stok_lembar).toLocaleString() +"</td>"+
                   "<td>"+ parseFloat(AvValue.saldoAwal).toLocaleString() +"</td>"+
                   // "<td>"+ parseFloat(AvValue.saldoAwalLembar).toLocaleString() +"</td>"+
                   "<td>"+ parseFloat(AvValue.beratMasukPerPeriode).toLocaleString() +"</td>"+
                   // "<td>"+ parseFloat(AvValue.totalLembarMasukPerPeriode).toLocaleString() +"</td>"+
                   "<td>"+ parseFloat(AvValue.beratKeluarPerPeriode).toLocaleString() +"</td>"+
                   // "<td>"+ parseFloat(AvValue.totalLembarKeluarPerPeriode).toLocaleString() +"</td>"+
                   "<td>"+ parseFloat(AvValue.saldoAkhir).toLocaleString() +"</td>"+
                   // "<td>"+ parseFloat(AvValue.saldoAkhirLembar).toLocaleString() +"</td>"+
                   "<td><button class='btn btn-sm btn-default btn-flat' "+attr+" id='"+AvValue.kd_gd_bahan+"'>"+icon+"</button></td>"+
                 "</tr>"
               );
              }
      ...
      function datatablesDetailPermintaanPlastikHd(param=""){
        $("#tableDetailPermintaanPlastikHd").dataTable().fnDestroy();
        $("#tableDetailPermintaanPlastikHd").dataTable({
          // "fixedHeader" : true,
          "autoWidth" : false,
          "ordering" : false,
          "bProcessing" : true,
          ...
          // "scrollY" : "720px",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudanghasil/main/getDetailPermintaanPlastikHdBaru",
          "columns":[
            {"data" : "id_dpp","name":"TDPP.id_dpp"},
            {"data" : "merek","name":"GH.nm_barang"},
            {"data" : "ukuran","name":"GH.nm_barang"},
            {"data" : "warna_plastik","name":"GH.warna"},
            {"data" : "tebal","name":"GH.warna"},
            {"data" : "tgl_permintaan","name":"TPP.tgl_permintaan"},
            {"data" : "jumlah_berat_permintaan","name":"TDPP.jumlah_berat_permintaan"},
            {"data" : "jumlah_lembar_permintaan","name":"TDPP.jumlah_lembar_permintaan"},
            {"data" : "sisaBeratPermintaan","name":"(TDPP.jumlah_berat_permintaan - TDPP.jumlah_berat_terima)"},
            {"data" : "sisaLembarPermintaan","name":"(TDPP.jumlah_lembar_permintaan - TDPP.jumlah_lembar_terima)"},
            {"data" : "keterangan","name":"TDPP.keterangan"},
            {"data" : "status_permintaan","name":"TDPP.status_permintaan"},
            {"data" : "id_dpp","name":"TDPP.id_dpp"}
          ],
          "fnServerData": function (sSource, aoData, fnCallback){
            aoData.push({"name":"idPermintaan","value":param});
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            $("td:eq(0)",nRow).text(++iDisplayIndex);
            $("td:eq(6)",nRow).text(parseFloat(aData["jumlah_berat_permintaan"]).toLocaleString());
            $("td:eq(7)",nRow).text(parseFloat(aData["jumlah_lembar_permintaan"]).toLocaleString());
            $("td:eq(8)",nRow).text(parseFloat(aData["sisaBeratPermintaan"]).toLocaleString());
            $("td:eq(9)",nRow).text(parseFloat(aData["sisaLembarPermintaan"]).toLocaleString());
            if(aData["status_permintaan"] == "PENDING"){
              $("td:eq(12)",nRow).html("<button class='btn btn-md btn-flat btn-default'><i class='fa fa-lock'></i> Permintaan Belum Disetujui Oleh Purchasing</button>"+
                                       "<button class='btn btn-md btn-flat btn-danger' onclick=deleteAndRestoreDetailPermintaanPlastik('"+aData["id_dpp"]+"','"+aData["kd_permintaan_plastik"]+"','TRUE')>Batal Minta</button>"+
                                       "<a href='<?php echo base_url('_gudanghasil/main/printBonPermintaanPlastik/') ?>"+aData["kd_permintaan_plastik"]+"' target='_blank' class='btn btn-md btn-flat bg-purple'>Cetak Bon Permintaan</a>");
            }else if(aData["status_permintaan"] == "CANCEL"){
              $("td:eq(12)",nRow).html("<button class='btn btn-md btn-flat btn-default'><i class='fa fa-lock'></i> Permintaan Dibatalkan Oleh Purchasing</button>");
            }else{
              $("td:eq(12)",nRow).html("<button class='btn btn-md btn-flat btn-warning' onclick=modalTerimaPlastikSetengah('"+aData["id_dpp"]+"','"+aData["kd_permintaan_plastik"]+"')>Terima Setengah</button>"+
                                       "<button class='btn btn-md btn-flat btn-success' onclick=modalTerimaPlastikFull('"+aData["id_dpp"]+"','"+aData["kd_permintaan_plastik"]+"')>Terima Full</button>"+
                                       // "<button class='btn btn-md btn-flat btn-danger' onclick=batalkanPermintaan('"+aData["id_dpb"]+"','"+aData["kd_permintaan_barang"]+"')>Batal Minta</button>"+
                                       "<button class='btn btn-md btn-flat btn-primary' onclick=selesaiPermintaanPlastik('"+aData["id_dpp"]+"','"+aData["kd_permintaan_plastik"]+"')>Selesai Permintaan</button>"+
                                       "<a href='<?php echo base_url('_gudanghasil/main/printBonPermintaanPlastik/') ?>"+aData["kd_permintaan_plastik"]+"' target='_blank' class='btn btn-md btn-flat bg-purple'>Cetak Bon Permintaan</a>");
            }

            if(aData["status_permintaan"] == "CANCEL" && (aData["keterangan_purchasing"] != null && aData["keterangan_purchasing"] != "")){
              $("td:eq(11)",nRow).html("<label class='text-red'>["+aData["status_permintaan"]+"]</label><br>"+
                                       "<label class='text-blue'>["+aData["keterangan_purchasing"]+"]</label>");
            }else{
              $("td:eq(11)",nRow).text(aData["status_permintaan"]);
            }
          }
        });
      }
      ...
      <script type="text/javascript">
        function modalKembalianHDSablon(param){
          // $("#modalApproveKembalianHDSablon").modal('show');
          datatableKembalianHDSablon(param);
        }
      </script>

      <script type="text/javascript">
        function datatableKembalianHDSablon(param){
          ...
          $("#tableListKembalianHDSablon").dataTable({
            ...
            "bServerSide" : true,
            "sPaginationType": "full_numbers",
            "sAjaxSource":"<?php echo base_url(); ?>_gudanghasil/main/getListKembalianSablon",
            "columns":[
              {"data" : "id_permintaan_jadi","name":"id_permintaan_jadi"},
              {"data" : "tgl_transaksi","name":"tgl_transaksi"},
              {"data" : "ukuran","name":"ukuran"},
            ...
            "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
              $("td:eq(0)",nRow).text(++iDisplayIndex);
              $("td:eq(5)",nRow).text(parseFloat(aData["jumlah_berat"]).toLocaleString());
              $("td:eq(6)",nRow).text(parseFloat(aData["jumlah_lembar"]).toLocaleString());
      ...
      <script type="text/javascript">
        ...
        function alertKembalianSablon(){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/getCounterKembalianSablon'); ?>",
            dataType : "JSON",
            success : function(response){
              if(parseInt(response.Counter) > 0){
                $("#alertKembalianSablon").show();
              }else{
                $("#alertKembalianSablon").hide();
              }
            }
          });
        }

        function alertKembalianSablonCampur(){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/getCounterKembalianSablonCampur'); ?>",
            dataType : "JSON",
            success : function(response){
              if(parseInt(response.Counter) > 0){
                $("#alertKembalianSablonCampur").show();
              }else{
                $("#alertKembalianSablonCampur").hide();
              }
            }
          });
        }
      ...
      <script type="text/javascript">
        ...
        function checkedAndUnchecked(param, param2, param3="", param4=""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/updateCheckList'); ?>",
            dataType : "TEXT",
            data : {
              kdGdHasil : param.id,
              ceklis : param2,
        ...
        function checkedAndUncheckedBahan(param, param2, param3="", param4=""){
          if(param2 == "TRUE"){
            $("#"+param.id).html("<i class='fa fa-check-square-o'></i>").attr("onclick","checkedAndUncheckedBahan(this,'FALSE','"+param3+"','"+param4+"')");
          }else{
            $("#"+param.id).html("<i class='fa fa-square-o'></i>").attr("onclick","checkedAndUncheckedBahan(this,'TRUE','"+param3+"','"+param4+"')");
          }
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudanghasil/main/updateCheckListBahan'); ?>",
            dataType : "TEXT",
            data : {
              kdGdBahan : param.id,
              ceklis : param2,
        ...
        function perbaruiStokMaster(){
  				...
  				if(arrValue.length > 0){
  					if(confirm("Apakah Anda Yakin Ingin Perbarui Stok Master?")){
  						$.ajax({
  							type : "POST",
  							url : "<?php echo base_url('_gudanghasil/main/perbaruiStokMaster'); ?>",
  							dataType : "TEXT",
  							data : {
  								arrValue : arrValue
  							},
        ...
        function ubahJenisGudang(){
          var jenisGudang = $("#cmbJenisGudang").val();
          if(jenisGudang.indexOf("_") == -1){
            var param1 = jenisGudang;
            var jnsPermintaan = "";
          }else{
            var arrJenisGudang = jenisGudang.split("_");
            var param1 = arrJenisGudang[0];
            var jnsPermintaan = "/"+arrJenisGudang[1];
          }
          $("#cmbUkuran6").val("").change();
          $("#cmbUkuran6").select2({
            placeholder : "Pilih Hasil ("+param1+")",
            dropdownParent: $('#modalEditHistoryMasukGudangHasil'),
            width : "100%",
