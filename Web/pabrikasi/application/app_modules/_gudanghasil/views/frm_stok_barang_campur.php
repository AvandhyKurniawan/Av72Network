  ...
  <section class="content-header">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <?php
            if(strtolower($this->session->userdata("fabricationGroup")) != "gudang hasil"){
              $TambahBarangBaru = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahGudangHasil" onclick=modalTambahBarangBaru("CAMPUR");><i class="fa fa-plus"></i> Tambah Barang Baru</button>';
              $TambahDataAwal = '<button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahDataAwal" onclick=modalTambahDataAwalGudangHasil("CAMPUR")><i class="fa fa-plus"></i> Tambah Data Awal</button>';
            }else{
              $TambahBarangBaru = '';
              $TambahDataAwal='';
            }
          ?>
          <?php echo $TambahBarangBaru;?>
          ...
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengambilanSablon" onclick="modalPengambilanKanvas('CAMPUR','KANVAS')"><i class="fa fa-plus"></i> Tambah Pengambilan Kanvas</button>
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengambilanSablon" onclick="modalPengambilanKanvas('CAMPUR','ONLINE')"><i class="fa fa-plus"></i> Tambah Pengambilan Online</button>
          ...
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-backdrop="static" data-target="#modalPermintaanHd" onclick="modalPermintaanBarangHd()"><i class="fa fa-plus"></i> Tambah Permintaan HD</button>
          <?php echo $TambahDataAwal;?>
        ...
        <div class="col-md-12" style="margin-top:10px;">
          ...
          <div class="col-md-6" style="display: none; cursor: pointer;" id="alertKembalianSablonCampur">
            <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalKembalianSablonCampur" onclick="modalKembalianHDSablon('CAMPUR')">
            <div class="alert alert-info">
              <h4>
                  Ada Kembalian Barang Dari Sablon
              </h4>
            </div>
            </a>
          </div>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <select class="form-control" id="cmbKeteranganPengembalian">
                            ...
                            <option value="PENGEMBALIAN CAMPUR (TRANSFER)">TRANSFER</option>
                          </select>
                        </div>
                      </td>
                    </tr>
            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-responsive">
                    <tr>
                      <td width="20%">Pindah Gudang</td>
                      <td width="1%">:</td>
                      <td>
                        <div class="form-group">
                          <select class="form-control" id="cmbJenisGudang" onchange="ubahJenisGudang();">
                            <option value="">Pilih Gudang</option>
                            <option value="CAMPUR">CAMPUR</option>
                            <option value="SABLON_POLOS">SABLON POLOS</option>
                            <option value="SABLON_CETAK">SABLON CETAK</option>
      ...
      <div class="modal fade" id="modalPermintaanHd" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" data-target="#modalPermintaanHd">&times;</button>
              <h4 class="modal-title text-blue">Formulir Permintaan Barang HD</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-responsive">
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" id="txtKodePermintaan" class="form-control" placeholder="Masukan Kode Permintaan" readonly>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <select class="form-control" id="cmbUkuran8">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <div class="input-group date">
                            <input type="text" id="txtTanggalPermintaan" class="form-control" placeholder="Masukan Tanggal Permintaan" readonly>
                            <div class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" id="txtBeratPermintaan" class="form-control number" placeholder="Masukan Jumlah Berat Permintaan">
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" id="txtLembarPermintaan" class="form-control number" placeholder="Masukan Jumlah Lembar Permintaan">
                        </div>
                      </td>
                    </tr>
                  </table>
                  <button type="button" class="btn btn-md btn-flat btn-primary pull-right" id="btnAddPermintaanHd"><i class="fa fa-plus"></i> Tambah</button>
                </div>
                <div class="col-md-12">
                  <table class="table table-responsive table-striped" id="tableListPermintaanBarangHd">
                    <thead>
                      <th>No.</th>
                      <th>Tanggal</th>
                      <th>Ukuran</th>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" id="btnSavePermintaanHd"><i class="fa fa-check"></i> Simpan</button>
            </div>
          </div>
        </div>
      </div>

      <div id="modalKembalianSablonCampur" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-lg" style="width: 1050px;margin: auto; padding-top: 20px;">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header" style="background-color:#00a65a;">
              ...
              <h3 class="modal-title" style="text-align: center; color: black;">&nbsp;&nbsp;Daftar Kembalian Barang Gudang Campur<span id="title_barang"></span></h3>
            </div>
            <!-- body modal -->
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
            <div class="content">
            ...
            <div class="modal-footer" style="text-align: center; color: black;">
              <button class="btn btn-flat bg-navy margin" onclick="approveKembalianHDSablon('CAMPUR')" style="margin: auto; width:30%; position: relative;">APPROVE</button>
            </div>
          </div>
        </div>
      </div>
