                        ...
                        <div id="bobinPayung" class="col-md-6" style="display:none;">
                          <table class="table table-responsibe">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-group has-warning">
                                  <input type="text" id="txtRumusRollBobinPayung_Payung" class="form-control number" placeholder="Masukan Rumus Roll Payung">
                                </div>
                              </td>
                            </tr>
                            <tr>
                          ...
                          <div class="col-md-6">
                            <table class="table table-responsive">
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="form-group has-warning">
                                    <input type="text" id="txtBPKP_Rumus" class="form-control number" placeholder="Masukan Rumus">
                                  </div>
                                </td>
                              </tr>
                            </table>
                          ...
                          <div class="col-md-6">
                            <table class="table table-responsive">
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="form-group has-warning">
                                    <input type="text" id="txtBPKP_RumusPayung" class="form-control number" placeholder="Masukan Rumus Payung">
                                  </div>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="form-group has-warning">
                                    <input type="text" id="txtBPKP_RumusPayungKuning" class="form-control number" placeholder="Masukan Rumus Payung Kuning">
                                  </div>
                                </td>
                              </tr>
                            </table>
