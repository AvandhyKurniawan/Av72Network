  ...
  <section class="content-header">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <?php
            if(strtoupper($this->session->userdata("fabricationGroup")) == "ADMINISTRATOR" || strtoupper($this->session->userdata("fabricationGroup")) == "IT_DEPARTMENT"){
          ?>
          <!-- <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahGudangHasil" onclick="modalTambahBarangBaru('ONLINE')"><i class="fa fa-plus"></i> Tambah Barang Baru</button> -->
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahGudangHasil" onclick="modalTambahBarangBaru('KANVAS')"><i class="fa fa-plus"></i> Tambah Barang Baru</button>
          <?php
            }
          ?>
          <button type="button" class="btn btn-md btn-flat btn-warning" data-toggle="modal" data-backdrop="static" data-target="#modalCariHistory" onclick="modalCariHistory('KANVAS')"><i class="fa fa-search"></i> Cari History</button>
          <!-- <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-backdrop="static" data-target="#modalPengambilanSablon" onclick="modalPengambilanSablon('KANVAS')"><i class="fa fa-plus"></i> Tambah Pengambilan Sablon</button> -->
          <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-backdrop="static" data-target="#modalKoreksiGudangHasil" onclick="modalKoreksiGudangHasil('KANVAS')"><i class="fa fa-pencil"></i> Koreksi Kanvas</button>
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengambilanSablon" onclick="modalPengambilanKanvas('KANVAS','ONLINE')"><i class="fa fa-plus"></i> Tambah Pengambilan Online</button>
          <!-- <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-backdrop="static" data-target="#modalPengembalianCampur" onclick="modalPengembalianBarang('KANVAS')"><i class="fa fa-plus"></i> Tambah Pengembalian Sablon</button> -->
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengembalianStandard" onclick="modalPengembalianBarangStandard('KANVAS','','STANDARD')"><i class="fa fa-plus"></i> Tambah Pengembalian Ke Standard</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-backdrop="static" data-target="#modalPengembalianStandard" onclick="modalPengembalianBarangStandard('KANVAS','','CAMPUR')"><i class="fa fa-plus"></i> Tambah Pengembalian Ke Campur</button>
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalPengembalianStandard" onclick="modalPengembalianBarangStandard('KANVAS','','SABLON')" style="margin-top:5px;"><i class="fa fa-plus"></i> Tambah Pengembalian Ke Sablon</button>
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahDataAwal" onclick="modalTambahDataAwalGudangHasil('KANVAS')" style="margin-top:5px;"><i class="fa fa-plus"></i> Tambah Data Awal</button>

          <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-backdrop="static" data-target="#modalAnekaMacam" onclick="modalJadiAnekaMacam('KANVAS')" style="margin-top:5px;"><i class="fa fa-plus"></i> Aneka Macam</button>
      ...
      <div class="modal fade" id="modalCariHistory" role="dialog" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="cariHistoryGudangHasilBuffer('KANVAS')"><i class="fa fa-search"></i> Cari History</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue" id="h4ModalPengambilanSablon">Formulir Pengambilan Barang Ke Sablon</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-responsive">
                    ...
                    <tr>
                      <td id="tdUkuranBarangSablon">Ukuran Barang Sablon (Buffer)</td>
                      <td>:</td>
                      <td>
                        <div class="form-group has-warning">
                ...
                <div class="col-md-12">
                  <h4 class="text-primary" id="h4HeaderTable">Daftar Pengambilan Sablon Di Gudang Hasil Standard</h4>
    ...
    <!-- BUAT PACKING -->
    <div class="modal fade" id="modalAnekaMacam" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" data-target="#modalAnekaMacam">&times;</button>
              <h4 class="modal-title text-blue">Formulir Pembuatan Barang Aneka Macam</h4>
            </div>
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-responsive">
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <div class="input-group date">
                            <input type="text" id="txtTglAneka" class="form-control" placeholder="Masukan Tanggal Pembuatan" readonly>
                            <div class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <select class="form-control" id="cmbTujuan">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" id="txtBeratAneka" class="form-control number" placeholder="Masukan Jumlah Berat">
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" id="txtLembarAneka" class="form-control number" placeholder="Masukan Jumlah Lembar">
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>:</td>
                      <td>
                        <input type="text" id="txtKeteranganAneka" class="form-control" placeholder="Masukan Ketarangan">
                      </td>
                    </tr>
                  </table>
                  <button type="button" class="btn btn-md btn-flat btn-danger pull-right" onclick="resetFormKoreksiGudangBuffer('SABLON');"><i class="fa fa-remove"></i> Batal</button>
                  <button type="button" id="btnAddBarangAneka" class="btn btn-md btn-flat btn-primary pull-right"><i class="fa fa-plus"></i> Tambah</button>
                </div>
                <div class="col-md-12">
                  <table class="table table-responsive" id="tableListKoreksiGudangBufferTemp">
                    <thead>
            ...
            <div class="modal-footer">
              <button type="button" id="btnSaveBarangAneka" class="btn btn-md btn-flat btn-success"><i class="fa fa-check"></i> Selesai</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content" style="width:1120px; margin-left:5px;">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Silahkan Approve Kiriman Dari Gudang Standard</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <div class="row">
                <div class="col-md-12">
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="#STANDARD" data-toggle="tab" aria-expanded="true" onclick="modalKirimanUntukGudangKanvas('STANDARD')">Dari Gudang Standard</a></li>
                      <li><a href="#CAMPUR" data-toggle="tab" aria-expanded="true" onclick="modalKirimanUntukGudangKanvas('CAMPUR')">Dari Gudang Campur</a></li>
                      <li><a href="#SABLON" data-toggle="tab" aria-expanded="true" onclick="modalKirimanUntukGudangKanvas('SABLON')">Dari Gudang Sablon</a></li>
                    </ul>
                    <div class="tab-content">
                      <div class="tab-pane active" id="STANDARD">
                        <div class="row">
                          <div class="col-md-12">
                            <table class="table table-responsive table-striped" id="tableListKirimanDariGudangStandard_STANDARD">
                              <thead>
                                <th>No.</th>
                                <th>Tanggal</th>
                                <th>Ukuran</th>
                      ...
                      <div class="tab-pane" id="CAMPUR">
                        <div class="row">
                          <div class="col-md-12">
                            <table class="table table-responsive table-striped" id="tableListKirimanDariGudangStandard_CAMPUR">
                              <thead>
                                <th>No.</th>
                                <th>Tanggal</th>
                                <th>Ukuran</th>
                      ...
                      <div class="tab-pane" id="SABLON">
                        <div class="row">
                          <div class="col-md-12">
                            <table class="table table-responsive table-striped" id="tableListKirimanDariGudangStandard_SABLON">
                              <thead>
                                <th>No.</th>
                                <th>Tanggal</th>
                                <th>Ukuran</th>
                            ...
                            <div style="margin-top:10px;">
                              <button type="button" class="btn btn-md btn-flat btn-danger pull-right" disabled title="Fitur Ini Belum Tersedia"><i class="fa fa-undo"></i> Kirim Balik Ke Potong</button>
                              <button type="button" class="btn btn-md btn-flat btn-primary pull-right" onclick="saveApproveKirimanUntukBufferSablon('SABLON')"><i class="fa fa-check"></i> Approve All</button>
                            </div>
                          </div>
                        </div>
                      </div>
