      ...
      <script type="text/javascript">
        $(function () {
          ...
          if($("#tableDataMasterGudangHasilBuffer").length){
            datatableListGudangHasil("#tableDataMasterGudangHasilBuffer","KANVAS");
            if($("#alertKirimanBahanSablon").length){
              alertKirimanBahanSablon();
            }
          }
          if($("#tableDataMasterGudangOnline").length){
            datatableListGudangHasil("#tableDataMasterGudangOnline","ONLINE");
            if($("#alertKirimanBahanSablon").length){
              alertKirimanBahanSablon();
            }
          }
          ...
          if($("#tableDataMasterBarangPack").length > 0){
            datatableListBarangPack("#tableDataMasterBarangPack");
          }
...
<!--===============================================General Function (Start) ===============================================-->
      ...
      function modalLihatNote(param,param2=""){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getNotePesanan",
          dataType : "JSON",
          data : {noOrder : param,
                  idDP : param2},
      ...
      function modalKirimPesanan(param){
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getPesananDetailData",
          dataType : "JSON",
          data : {idDp : param},
          success : function(response){
      ...
      function modalEditBarangGudangHasil(param){
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getDetailBarangGudangHasil",
          dataType : "JSON",
      ...
      function modalCariHistory(param,param2=""){
        ...
        $("#cmbUkuran1").select2({
          ...
          allowClear:true,
          ajax:{
            url : "<?php echo base_url(); ?>_gudangkanvas/main/getComboBoxValueHasil/"+param+"/"+param2,
            dataType : "JSON",
            delay : 0,
            processResults : function(data){
              return{
                results : $.map(data, function(item){
                  return{
                    text:item.kd_gd_hasil+" | "+item.ukuran+" | "+item.merek+" | "+item.warna_plastik+" | "+item.jns_permintaan+" | "+item.sts_brg+" | "+item.tebal,
                    id:item.kd_gd_hasil
                  }
                })
              };
      ...
      function modalCariHistoryAnekaMacam(param){
        // $("input").val("");
        // $(".date").datepicker("setDate",null);
        $("#cmbAnekaMacam").val("").trigger("change");
        var placeholder = param.replace("_"," ");
        $("#cmbAnekaMacam").select2({
          placeholder : "Pilih Hasil ("+placeholder+")",
          dropdownParent: $('#modalCariHistoryAnekaMacam'),
          width : "100%",
          cache:true,
          allowClear:true,
          ajax:{
            url : "<?php echo base_url(); ?>_gudangkanvas/main/getComboBoxValueAneka/",
            dataType : "JSON",
            delay : 0,
            processResults : function(data){
              return{
      ...
      function modalTambahStock(){
        // $("input").val("");
        // $(".date").datepicker("setDate",null);
        $("#cmbAnekaMacam_stock").val("").trigger("change");
        $("#cmbAnekaMacam_stock").select2({
          placeholder : "Pilih Hasil Pack",
          dropdownParent: $('#modalTambahStockPack'),
          width : "100%",
          cache:true,
          allowClear:true,
          ajax:{
      ...
      function tambahStockPack(){
        var kdPack = $("#cmbAnekaMacam_stock").val();
        var jumlah_pack = $("#jumlah_pack").val();
        var jumlah_berat = $("#jumlah_berat").val();
        var jumlah_lembar = $("#jumlah_lembar").val();
        if(jumlah_pack != '' || jumlah_pack.length > 0){
          $.post("<?=base_url('_gudangkanvas/main/tambahStockPack')?>",
          {
            kdPack:kdPack,
            jumlahPack:jumlah_pack,
            jumlahBerat:jumlah_berat,
            jumlahLembar:jumlah_lembar
          }, function(response){
          ...
          alert("Jumlah pack masih kosong!");
        }
      }
      function modalEditHistory(param1,param2,param3,param4,param5,param6=""){
        ...
        $("#cmbUkuran6").select2({
          ...
          allowClear:true,
          ajax:{
            url : "<?php echo base_url(); ?>_gudangkanvas/main/getComboBoxValueHasil/"+param1+jnsPermintaan,
            dataType : "JSON",
            delay : 0,
            processResults : function(data){
              return{
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getDetailTransaksiGudangHasil",
          dataType : "JSON",
      ...
      function modalEditHistoryPack(param1,param2,param3,param4,param5,param6=""){
        if(param6 != ""){
          var jnsPermintaan = "/"+param6;
        }else{
          var jnsPermintaan = "";
        }
        $("#modalEditHistoryPack").modal({
          backdrop : "static"
        });
        $("#cmbUkuran6").select2({
          placeholder : "Pilih Hasil ("+param1+")",
          dropdownParent: $('#modalEditHistoryPack'),
          width : "100%",
          cache:true,
          allowClear:true,
          ajax:{
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getDetailTransaksiPack",
          dataType : "JSON",
          data : {idTransaksi : param2},
          success : function(response){
            $.each(response,function(AvIndex,AvValue){
              ...
              $("#cmbUkuran6").val(AvValue.kd_gd_hasil).trigger("change");
              $("#txtBeratMasukHistory").val(AvValue.jumlah_berat);
              $("#txtLembarMasukHistory").val(AvValue.jumlah_kirim);
              if(AvValue.jumlah_terkirim != null){
                $("#trJumlahPengiriman").removeAttr("style");
                $("#txtJumlahPengiriman").val(AvValue.jumlah_terkirim);
                $("#txtSatuan").text(AvValue.satuan);
            ...
            $("#btnSaveEditHistoryPack").attr("onclick","editTransaksiPack('"+param2+"','"+param3+"','"+param4+"','"+param5+"')");
          },
          error : function(response){
            $("#modal-notif").addClass("modal-danger");
            $("#modalNotifContent").text("Server Fault Error Code ( "+response.status+" ) "+response.statusText);
      ...
      function modalPengambilanSablon(param,param2=""){
        ...
        $("#cmbUkuran2").on("select2:select",function(){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/getListComboBoxCustom",
            dataType : "JSON",
            data : {
              ukuran : ukuran,
              warna : warna,
      ...
      function modalEditPengirimanGudangTemp(param, param2){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getDetailPengirimanGudangTemp",
          dataType : "JSON",
      ...
      function modalKirimApal(){
        ...
        $(".date").datepicker("setDate",null);
        $.ajax({
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getComboBoxValuetGudangApal",
          dataType : "JSON",
          success : function(response){
            $("#cmbJenisApal").empty();
            $.each(response,function(AvIndex, AvValue){
      ...
      function modalPembelianBarangHd(){
        ...
        $(".date").datepicker("setDate",null);
        $.ajax({
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getComboBoxValueHasilHd",
          dataType : "JSON",
          success : function(response){
            $("#cmbUkuran5").empty();
            $.each(response, function(AvIndex, AvValue){
              $("#cmbUkuran5").append("<option value='"+AvValue.kd_gd_hasil+"'>"+AvValue.ukuran+" | "+AvValue.merek+" | "+AvValue.warna_plastik+" | "+AvValue.jns_brg+" | "+AvValue.sts_brg+" | "+AvValue.jns_permintaan+" | "+item.tebal+"</option>");
            });
      ...
      function modalKoreksiGudangHasil(param1, param2=""){
        ...
        $("#cmbUkuran3").select2({
          ...
          allowClear:true,
          ajax:{
            url : "<?php echo base_url(); ?>_gudangkanvas/main/getComboBoxValueHasil/"+param1+"/"+param2,
            dataType : "JSON",
            delay : 0,
            processResults : function(data){
              return{
      ...
      function modalKoreksiPack(param1, param2=""){
        $("input").val("");
        $(".date").datepicker("setDate",null);
        $("#cmbJenisKoreksi").val("PLUS");
        $("#cmbUkuran3").val("").trigger("change");
        tableListKoreksiPackTemp();
        var placeholder = param1.replace("_"," ");
        $("#cmbUkuran3").select2({
          placeholder : "Pilih Hasil ("+placeholder+")",
          dropdownParent: $('#modalKoreksiPack'),
          width : "100%",
          cache:true,
          allowClear:true,
          ajax:{
        ...
        $("#btnAddKoreksiGudangHasil").attr("onclick","saveAddKoreksiPack('"+param1+"')");
        $("#btnSaveKoreksiGudangHasil").attr("onclick","saveKoreksiPack()");
      }


      function modalJadiAnekaMacam(param1, param2=""){
        $("input").val("");
        $(".date").datepicker("setDate",null);
        $("#cmbUkuran4").val("").trigger("change");
        tableListKoreksiGudangBufferTemp();
        ...
        $("#cmbUkuran4").select2({
          placeholder : "Pilih Hasil ("+placeholder+")",
          dropdownParent: $('#modalAnekaMacam'),
          width : "100%",
          cache:true,
          allowClear:true,
          ajax:{
        ...
        $.get("<?=base_url('_gudangkanvas/main/getComboBoxValueAneka')?>", function(response){
          $.each(response,function(AvIndex,AvValue){
              $("#cmbTujuan").append(
                "<option value='"+AvValue.kd_produk+"'>"+AvValue.kd_produk+" | "+AvValue.nama_produk+"</option>"
              );
            });
        }, "JSON");
        $("#btnAddBarangAneka").attr("onclick","saveAddBuatAnekaMacam('"+param1+"')");
        $("#btnSaveBarangAneka").attr("onclick","saveKoreksiGudangBuffer()");
      }
      ...
      function modalEditKoreksiPack(param){
        var jnsKoreksi = "";
        var kdPack = "";
        $.ajax({
          type : "POST",
          ...
          success : function(response){
            $.each(response,function(AvIndex,AvValue){
              kdPack = String(AvValue.kd_pack);
              $("#txtTglKoreksi").val(AvValue.tgl_transaksi);
              $("#cmbUkuran3").val(kdPack).trigger("change");
              $("#txtBeratKoreksi").val(AvValue.jumlah_berat);
              $("#txtPackKoreksi").val(AvValue.jumlah_kirim);
              (AvValue.status_history == "MASUK") ? jnsKoreksi="PLUS" : jnsKoreksi="MINUS";
              $("#cmbJenisKoreksi").val(jnsKoreksi);
              $("#txtKeterangan").val(AvValue.keterangan);
              $("#btnAddKoreksiGudangHasil").attr("onclick","editKoreksiPackTemp('"+AvValue.sts_barang+"','"+AvValue.id_transaksi+"')").html("<i class='fa fa-pencil'></i> Ubah");
            });
          },
          error : function(response){
            $("#modal-notif").addClass("modal-danger");
      ...
      function modalPengembalianBarangStandard(param1, param2="",param3){
        resetFormPengembalianKeStandard(param1, param3);
        tableListPengembalianGudangBuffer(param3);
        var placeholder = param1.replace("_"," ");
        $("#cmbUkuran5").select2({
          placeholder : "Pilih Hasil ("+placeholder+")",
        ...
        $("#cmbUkuran5").on("select2:select",function(){
          ...
          $("#cmbUkuran5_1").select2({
            placeholder : "Pilih Hasil ("+jnsBarang+")",
            dropdownParent: $('#modalPengembalianStandard'),
            width : "100%",
            cache:true,
            allowClear:true,
      ...
      function modalKirimanUntukGudangKanvas(param){
        datatableKirimanUntukGudangKanvas(param);
      }
      ...
      function modalEditDataOrderTerkirim(param){
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url('_gudangkanvas/main/getDetailDataOrderTerkirim'); ?>",
          dataType : "JSON",
          data : {
            idTransaksi : param
          },
      ...
      function modalEditGudangBahan(param){
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url() ?>_gudangkanvas/main/getDetailBarangBahan",
          dataType : "JSON",
      ...
      function modalTambahPembelianBahanBaku(param){
        ...
        $.ajax({
          url : "<?php echo base_url('_gudangkanvas/main/getGeneratedRequestCode'); ?>",
          dataType : "JSON",
          success : function(response){
        ...
        $("#cmbGudangBahan").select2({
          ...
          allowClear:true,
          ajax:{
            url : "<?php echo base_url(); ?>_gudangkanvas/main/getComboBoxValueBahan/"+param,
            dataType : "JSON",
            delay : 0,
            processResults : function(data){
              return{
      ...
      function modalEditPembelianBahanTemp(param, param2){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getDetailItemPembelianGudangBahanTemp",
          dataType : "JSON",
          data : {rowId:param},
          success:function(response){
      ...
      function modalEditKoreksiTemp(param,param2){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getDetailKoreksi",
          dataType : "JSON",
          data : {id : param},
          success : function(response){
      ...
      function modalEditPengeluaranTemp(param,param2){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getDetailPengeluaran",
          dataType : "JSON",
          data : {id:param},
          success : function(response){
      ...
      function modalTambahDataAwalGudangHasil(param, param2=""){
        ...
        $("#cmbNamaBarang").on("select2:select",function(){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/getDetailDataAwalGudangHasil",
            dataType : "JSON",
            data : {kdGdHasil:id},
            success : function(response){
              if(response.length > 0){
      ...
      function modalPengambilanKanvas(param,param2="", param3=""){
        $("input").val("");
        $(".date").datepicker("setDate",null);
        $("#cmbUkuran2").val("").trigger("change");
        $("#cmbUkuranBarangSablon").empty();
        $("#h4ModalPengambilanSablon").text("Formulir Pengambilan Barang Ke "+param2);
        $("#tdUkuranBarangSablon").text("Ukuran Barang "+param2);
        $("#h4HeaderTable").text("Daftar Pengambilan "+param2+" Di Gudang Hasil ( "+param+" )");
        var placeholder = param.replace("_"," ");
        $("#cmbUkuran2").select2({
          placeholder : "Pilih Hasil ("+placeholder+")",
          dropdownParent: $('#modalPengambilanSablon'),
          ...
          allowClear:true,
          ajax:{
            url : "<?php echo base_url(); ?>_gudangkanvas/main/getComboBoxValueHasil/"+param+"/"+param3,
            dataType : "JSON",
            delay : 0,
            processResults : function(data){
              return{
        ...
        $("#btnAddPengambilanCampur").attr("onclick","savePengambilanKanvasTemp('"+param2+"')");
        $("#btnSavePengambilanCampur").attr("onclick","savePengambilanKanvas('"+param2+"')");
        tableListPengambilanKanvasTemp(param2);
      }
      //============================================MODAL METHOD (Finish)============================================//
      ...
      function updateDataOrderTerkirim(){
        ...
        $.ajax({
          type : "POST",
          url  : "<?php echo site_url('_gudangkanvas/main/updateDataOrderTerkirim'); ?>",
          dataType : "TEXT",
          data : {id:id,
      ...
      function saveAddPengirimanBaruTemp(){
        ...
        if(tglPengiriman1==""||customer1==""||jumlahPesanan1==""||jumlahBerat1==""||
           ...
           idDp1==""||jumlahDikirim1==""
            ...
            $.ajax({
              type : "POST",
              url : "<?php echo base_url(); ?>_gudangkanvas/main/addPengirimanBaru",
              dataType : "TEXT",
              ...
              success : function(response){
                if(jQuery.trim(response) === "Berhasil"){
                  ...
                  $("#modal-notif").addClass("modal-warning");
                  $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosonga!");
                  $("#modal-notif").modal("show");
                  setTimeout(function(){
                    $("#modal-notif").modal("hide");
                    $("#modal-notif").removeClass("modal-warning");
      ...
      function savePengirimanBaru(){
        if(confirm("Apakah Anda Yakin Semua Sudah Sesuai Dan Tidak Ada Yang Salah?")){
          $.ajax({
            url : "<?php echo base_url(); ?>_gudangkanvas/main/savePengirimanBaru",
            dataType : "TEXT",
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
      ...
      function saveBarangBaru(param){
           ...
           stokBerat1==""||stokLembar1==""||merek1==""||jnsPermintaan1==""||stsBarang1==""||jnsBarang1=="")
        {
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveBarangBaruGudangHasil",
            dataType : "TEXT",
            data : {kdGdHasil : kdGdHasil1,
      ...
      function savePengambilanSablonTemp(){
        ...
        if(tanggal1=="" || kdGdHasil1=="" || jumlahLembar1=="" || jumlahBerat1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/addPengambilanSablon",
            dataType : "TEXT",
            data : {kdGdHasil     : kdGdHasil1,
      ...
      function savePengambilanSablon(){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            url : "<?php echo base_url(); ?>_gudangkanvas/main/savePengambilanSablon",
            dataType : "TEXT",
            success : function(response) {
              if(jQuery.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
      ...
      function savePengirimanGudangTemp(param){
        ...
        if(tanggal1=="" || customer1=="" || kdGdHasil1=="" || jumlahBerat1=="" ||
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/saveAddPengirimanGudangTemp",
             dataType : "TEXT",
      ...
      function savePengirimanGudang(param){
        if(confirm("Apakah Anda Yakin Sudah Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/savePengirimanGudang",
            dataType : "TEXT",
      ...
      function saveAddKirimanApalTemp(){
        ...
        if(tanggal1=="" || kdGdApal1=="" || jumlahApal1=="" || keterangan1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveAddKirimanApalTemp",
            dataType : "TEXT",
            data : {
      ...
      function saveKirimanApal(){
        if(confirm("Apakah Anda Yakin Tidak Ada Data Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveKirimanApal",
            dataType : "TEXT",
            success : function(response){
              if(jQuery.trim(response)==="Berhasil"){
                $("#modal-notif").addClass("modal-info");
      ...
      function saveAddKembalianGudangTemp(param){
        ...
        if(kdGdHasil1=="" || namaCustomer1=="" || tanggal1=="" || jumlahBerat1=="" ||
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/saveAddPengembalianGudang",
             dataType : "TEXT",
             data : {
               kdGdHasil        : kdGdHasil1,
      ...
      function saveKembalianGudang(param){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveKembalianGudang",
            dataType : "TEXT",
      ...
      function saveAddPembelianHd(){
        ...
        if(kdGdHasil1==""||namaCustomer1==""||tanggal1==""||jumlahBerat1==""||jumlahLembar1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveAddPembelianHd",
            dataType : "TEXT",
            data : {
              kdGdHasil       : kdGdHasil1,
              ukuran          : ukuran1,
      ...
      function savePembelianHd(){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            url : "<?php echo base_url(); ?>_gudangkanvas/main/savePembelianHd",
            dataType : "TEXT",
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
      ...
      function saveJadiAnekaMacam(){
        if(confirm("Apakah Anda Yakin Sudah Tidak Ada Yang Salah?")){
          $.ajax({
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveKoreksiGudangBuffer",
            dataType : "TEXT",
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
      ...
      function saveAddBuatAnekaMacam(param){
        var kdGdHasil1 = $("#cmbUkuran4").val();
        var jumlahBerat1 = $("#txtBeratAneka").val().replace(/,/g, "");
        var jumlahLembar1 = $("#txtLembarAneka").val().replace(/,/g, "");
        var tglTransaksi1 = $("#txtTglAneka").val();
        var jenisKoreksi1 = "MINUS";
        var keterangan1 = $("#txtKeteranganAneka").val();
        var dataText = $("#cmbUkuran4").select2("data")[0]["text"];
        var arrDataText = dataText.split(" | ");
        var ukuran1 = arrDataText[1];
        var warna1 = arrDataText[3];
        var merek1 = arrDataText[2];
        var jnsPermintaan1 = arrDataText[4];
        var untuk = $("#cmbTujuan").val();
        var stsBarang1 = param;
        console.log("KD:" + kdGdHasil1);
        console.log("jumlahBerat1:" + jumlahBerat1);
        console.log("jumlahLembar1:" + jumlahLembar1);
        console.log("tglTransaksi1:" + tglTransaksi1);
        console.log("jenisKoreksi1:" + jenisKoreksi1);
        ...
        if(kdGdHasil1=="" || jumlahBerat1=="" || jumlahLembar1=="" ||
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/saveAddJadiAnekaMacam",
             dataType : "TEXT",
             data : {
               kdGdHasil      : kdGdHasil1,
               ukuran         : ukuran1,
      ...
      function saveAddKoreksiGudangBuffer(param){
        ...
        if(kdGdHasil1=="" || jumlahBerat1=="" || jumlahLembar1=="" ||
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/saveAddKoreksiGudangBuffer",
             dataType : "TEXT",
             data : {
               kdGdHasil      : kdGdHasil1,
               ukuran         : ukuran1,
      ...
      function saveAddKoreksiPack(param){
        var kdPack = $("#cmbUkuran3").val();
        var jumlahBerat1 = $("#txtBeratKoreksi").val().replace(/,/g, "");
        var jumlahPack = $("#txtPackKoreksi").val().replace(/,/g, "");
        var tglTransaksi1 = $("#txtTglKoreksi").val();
        var jenisKoreksi1 = $("#cmbJenisKoreksi").val();
        var keterangan1 = $("#txtKeterangan").val();
        var stsBarang1 = 'ANEKA MACAM';
        var jns_permintaan = 'POLOS';

        if(kdPack=="" || jumlahBerat1=="" || jumlahPack=="" ||
           tglTransaksi1=="" || jenisKoreksi1==""
         ){
           $("#modal-notif").addClass("modal-warning");
           $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/saveAddKoreksiPack",
             dataType : "TEXT",
             data : {
              kdPack          : kdPack,
               jumlahBerat    : jumlahBerat1,
               jumlahPack     : jumlahPack,
               tglTransaksi   : tglTransaksi1,
               stsBarang      : stsBarang1,
               jenisKoreksi   : jenisKoreksi1,
               keterangan     : keterangan1,
      ...
      function saveKoreksiPack(){
        if(confirm("Apakah Anda Yakin Sudah Tidak Ada Yang Salah?")){
          $.ajax({
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveKoreksiPack",
            dataType : "TEXT",
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                $("#modal-notif").addClass("modal-info");
      ...
      function saveAddPengembalianKeStandard(param,param2){
        ...
        if(kdGudangSablon1=="" || kdGudangStandard1=="" || namaCustomer1=="" ||
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/saveAddPengembalianKeGudangStandard",
             dataType : "TEXT",
             data : {
             ...
             success : function(response){
               if(jQuery.trim(response) === "Berhasil"){
                 ...
                 setTimeout(function(){
                   ...
                   $("#modal-notif").removeClass("modal-info");
                   $("#modalNotifContent").text("");
                   resetFormPengembalianKeStandard(param,param2);
                   tableListPengembalianGudangBuffer(param2);
                 },2000);
               }else if(jQuery.trim(response) === "Gagal"){
                 $("#modal-notif").addClass("modal-danger");
                 $("#modalNotifContent").text("Data Baru Gagal Disimpan");
      ...
      function savePengembalianKeGudangStandard(param){
        if(confirm("Apakah Anda Yakin Sudah Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/savePengembalianKeGudangStandard",
            dataType : "TEXT",
            data : {
              stsBarang : param
            },
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                ...
                setTimeout(function(){
                  ...
                  $("#modal-notif").removeClass("modal-info");
                  $("#modalNotifContent").text("");
                  tableListPengembalianGudangBuffer(param);
                },2000);
              }else if(jQuery.trim(response) === "Gagal"){
                $("#modal-notif").addClass("modal-danger");
      ...
      function saveApproveKirimanDariBagian(param, param2, param3=""){
        if(confirm("Apakah Anda Yakin Sudah Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/saveApproveKirimanDariBagian'); ?>",
            dataType : "TEXT",
            data : {
              stsBarang : param,
              bagian : param2,
      ...
      function saveApproveKirimanUntukBufferSablon(param){
        if(confirm("Apakah Anda Yakin Sudah Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/saveApproveKirimanUntukBufferSablon'); ?>",
            dataType : "TEXT",
            data : {
              stsBarang : param
            },
      ...
      function saveBahanBaku(param){
        ...
        if(kdGdBahan1=="" || nmBarang1=="" || stok1=="" ||
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveGudangBahan",
            dataType : "TEXT",
      ...
      function saveCartPembelian(param){
        ...
        if(tanggal1==""||kdGdBahan1==""||jumlahPermintaan1==""||kdPermintaan1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/addPembelianGudangBahanTemp",
            dataType : "TEXT",
      ...
      function saveDanKirimPermintaan(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/savePembelianGudangBahan",
          dataType : "TEXT",
          data : {
            jenis : param
          },
      ...
      function saveCartKoreksi(param){
        ...
        if(tglKoreksi1 =="" || kdGdBahan1 == "" || nmBahanBaku1 == "" ||
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/addKoreksiTemp",
            dataType : "TEXT",
      ...
      function savePengeluaranTemp(param){
        ...
        if(tanggal1=="" || kdGdBahan1 =="" || jumlah1 ==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/addPengeluaran",
            dataType : "TEXT",
      ...
      function savePengeluaran(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/savePengeluaran",
          dataType : "TEXT",
          data : {jenis:param},
          success : function(response){
            if(jQuery.trim(response) === "Berhasil") {
      ...
      function saveKoreksi(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/saveKoreksi",
          dataType : "TEXT",
          data : {jenis:param},
          success : function(response){
            if(jQuery.trim(response) === "Berhasil"){
      ...
      function terimaBarangFull(param, param2){
        ...
        if(namaSupplier=="" || tglTerima==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/terimaBarangFull'); ?>",
            dataType : "TEXT",
            data : {
              idDpb         : param,
              idPermintaan  : param2,
      ...
      function terimaBarangSetengah(param, param2){
        ...
        if(namaSupplier=="" || tglTerima=="" || jumlahTerima==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/terimaBarangSetengah'); ?>",
            dataType : "TEXT",
            data : {
              idDpb         : param,
              idPermintaan  : param2,
      ...
      function selesaiPermintaan(param, param2){
        if(confirm("Apakah Anda Yaki Ingin Menyelesaikan Pesanan Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/selesaiPermintaan'); ?>",
            dataType : "TEXT",
            data : {
              idDpb : param,
              idPermintaan : param2
      ...
      function saveApproveTransaksiGudangBahan(param,param2){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/saveApproveTransaksiGudangBahan",
            dataType : "TEXT",
            data : {bagian  : param,
                    jenis   : param2},
            success : function(response){
      ...
      function addDataAwal(param){
        ...
        if(kdGdBahan=="" || jumlahDataAwal==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/addDataAwal'); ?>",
            dataType : "TEXT",
            data : {
              kdGdBahan : kdGdBahan,
      ...
      function saveDataAwal(param){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url("_gudangkanvas/main/saveDataAwal") ?>",
            dataType : "TEXT",
            data : {
      ...
      function addDataAwalGudangHasil(param){
        ...
        if(kdGdHasil=="" || jumlahBerat=="" || jumlahLembar==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/addDataAwalGudangHasil'); ?>",
            dataType : "TEXT",
            data : {
              kdGdHasil : kdGdHasil,
      ...
      function saveDataAwalGudangHasil(param){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/saveDataAwalGudangHasil') ?>",
            dataType : "TEXT",
            data : {
              stsBarang : param
            },
      ...
      function savePengambilanKanvasTemp(param){
        var tanggal1 = $("#txtTanggalPengambilan").val();
        var kdGdHasil1 = $("#cmbUkuran2").val();
        var kdGdSablonBuffer1 = $("#cmbUkuranBarangSablon").val();
        var jumlahLembar1 = $("#txtLembarPengambilan").val().replace(/,/g,"");
        ...
        if(tanggal1=="" || kdGdHasil1=="" || jumlahLembar1=="" || jumlahBerat1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/addPengambilanKanvas",
            dataType : "TEXT",
            data : {kdGdHasil     : kdGdHasil1,
                    kdGdSablonBuffer : kdGdSablonBuffer1,
                    tanggal       : tanggal1,
            ...
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
                ...
                setTimeout(function(){
                  ...
                  $(".date").datepicker("setDate",null);
                  $("#cmbUkuran2").val("").trigger("change");
                  tableListPengambilanKanvasTemp(param);
                },2000);
              }else if(jQuery.trim(response) === "Gagal"){
                $("#modal-notif").addClass("modal-danger");
                $("#modalNotifContent").text("Data Baru Gagal Disimpan");
      ...
      function savePengambilanKanvas(param){
        if(confirm("Apakah Anda Yakin Tidak Ada Yang Salah?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/savePengambilanKanvas",
            data : {
              jnsGudang : param
            },
            dataType : "TEXT",
      ...
      function editBarangGudangHasil(){
           ...
           merek1==""||jnsPermintaan1==""||stsBarang1=="")
        {
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/editBarangGudangHasil",
            dataType : "TEXT",
            data : {kdGdHasil : kdGdHasil1,
                    kdAccurate : kdAccurate1,
                    tglBuat : tglBuat1,
      ...
      function editTransaksiGudangHasil(param1,param2,param3,param4){
        ...
        if(kdGdHasil2 != null){
          var dataText = $("#cmbUkuran6").select2("data")[0]["text"];
          var arrDataText = dataText.split(" | ");
          var ukuran = arrDataText[1];
          var merek = arrDataText[2];
          var warnaPlastik = arrDataText[3];
          var jnsPermintaan = arrDataText[4];
        }else{
          var ukuran = "";
          var merek = "";
        ...
        if(tanggal1==""||berat1==""||lembar1==""||idTransaksi1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/editHistoryGudangHasil",
            dataType : "TEXT",
      ...
      function editTransaksiPack(param1,param2,param3,param4){
        var tanggal1 = $("#txtTglHistoryMasuk").val();
        var kdPackBaru = $("#cmbUkuran6").val();
        var berat1 = $("#txtBeratMasukHistory").val().replace(/,/g, "");
        var pack = $("#txtLembarMasukHistory").val().replace(/,/g, "");
        var jumlahPengiriman1 = $("txtJumlahPengiriman").val();
        var idTransaksi1 = param1;

        if(tanggal1==""||berat1==""||pack==""||idTransaksi1==""){
          $("#modal-notif").addClass("modal-warning");
          $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Tidak Boleh Kosong!");
          $("#modal-notif").modal("show");
          setTimeout(function(){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/editHistoryPack",
            dataType : "TEXT",
            data : {idTransaksi       : idTransaksi1,
                    kdPack            : param4,
                    kdPackBaru        : kdPackBaru,
                    tanggal           : tanggal1,
                    berat             : berat1,
                    pack              : pack,
                    tglAwal           : param2,
      ...
      function editPengirimanGudangTemp(param1, param2){
        ...
        if(idTransaksi1=="" || tanggal1=="" || customer1=="" ||
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/editPengirimanGudangTemp",
             dataType : "TEXT",
             data : {
      ...
      function editKoreksiGudangBufferTemp(param,param2){
        ...
        if(jumlahBerat1=="" || jumlahLembar1=="" ||
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/editKoreksiGudangBufferTemp",
             dataType : "TEXT",
             data : {
               idTransaksi    : param2,
               kdGdHasil      : kdGdHasil1,
      ...
      function editKoreksiPackTemp(param,param2){
        var kdPack = $("#cmbUkuran3").val();
        var jumlahBerat1 = $("#txtBeratKoreksi").val().replace(/,/g, "");
        var jumlahKirim = $("#txtPackKoreksi").val().replace(/,/g, "");
        var tglTransaksi1 = $("#txtTglKoreksi").val();
        var jenisKoreksi1 = $("#cmbJenisKoreksi").val();
        var keterangan1 = $("#txtKeterangan").val();
        if(kdPack=="" || kdPack==null){
          var dataText = "";
        }else{
          var dataText = $("#cmbUkuran3").select2("data")[0]["text"];
        }
        ...
        if(jumlahBerat1=="" || jumlahKirim=="" ||
           ...
           $.ajax({
             type : "POST",
             url : "<?php echo base_url(); ?>_gudangkanvas/main/editKoreksiPackTemp",
             dataType : "TEXT",
             data : {
               idTransaksi    : param2,
               kdPack         : kdPack,
               jumlahBerat    : jumlahBerat1,
               jumlahPack     : jumlahKirim,
               tglTransaksi   : tglTransaksi1,
               jnsPermintaan  : "POLOS",
               stsBarang      : stsBarang1,
               jenisKoreksi   : jenisKoreksi1,
      ...
      function editBahanBaku(){
        ...
        if(kdGdBahan1=="" || nmBarang1=="" || stok1=="" ||
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/editGudangBahan",
            dataType : "TEXT",
            data : {kdGdBahan:kdGdBahan1,kdAccurate:kdAccurate1,nmBarang:nmBarang1,
      ...
      function editPembelianGudangBahanTemp(param, param2){
        ...
        if(tanggal1==""||jumlahPermintaan1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/editPembelianGudangBahanTemp",
            dataType : "TEXT",
            data : {kdGdBahan         : kdGdBahan1,
                    tanggal           : tanggal1,
                    jumlahPermintaan  : jumlahPermintaan1,
      ...
      function editKoreksiTemp(param,param2){
        ...
        if(tglKoreksi1 =="" || namaBahan1 == "" ||
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/editKoreksiTemp",
            dataType : "TEXT",
            data :{
                   id : param,
      ...
      function editPengeluaran(param,param2){
        ...
        if(param==""||tanggal1==""||jumlah1==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/editPengeluaran",
            dataType : "TEXT",
      ...
      function editDataAwal(param, param2){
        ...
        if(jumlah==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/editDataAwal') ?>",
            dataType : "TEXT",
            data : {
              idTransaksi : param,
              kdBarang : param2,
      ...
      function editDataAwalGudangHasil(param, param2){
        ...
        if(jumlahBerat=="" || jumlahLembar==""){
          ...
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/editDataAwalGudangHasil') ?>",
            dataType : "TEXT",
            data : {
              idTransaksi : param,
              kdBarang : param2,
      ...
      function deletePengirimanBaruTemp(param){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deletePengirimanBaruTemp",
            dataType : "TEXT",
      ...
      function deleteBarangGudangHasil(param){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Barang Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteAndRestoreBarangGudangHasil",
            dataType : "TEXT",
      ...
      function deleteTransaksiGudangHasil(param1,param2,param3,param4,param5){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteAndRestoreTransaksiGudangHasil",
            dataType : "TEXT",
            data : {idTransaksi : param2,
                    tglAwal : param3,
                    tglAkhir : param4,
      ...
      function deleteTransaksiPack(param1,param2,param3,param4,param5){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteAndRestoreTransaksiPack",
            dataType : "TEXT",
            data : {idTransaksi : param2,
                    tglAwal : param3,
                    tglAkhir : param4,
            ...
            success : function(response){
              if(jQuery.trim(response)==="Berhasil"){
                ...
                setTimeout(function(){
                  ...
                  $("#modal-notif").removeClass("modal-info");
                  $("#modalNotifContent").text("");
                  datatableSearchHistoryAnekaMacamMasuk(param1,param3,param4,param5);
                  tableListKoreksiPackTemp();
                  reloadTrashGudangHasil();
                },2000);
              }else{
      ...
      function deletePengambilanSablonTemp(param){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteAndRestorePengambilanSablonTemp",
            dataType : "TEXT",
      ...
      function deletePengirimanGudangTemp(param1, param2){
        if(confirm("Apakah Anda Yakin Menghapus Transaksi Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteAndRestorePengirimanGudangTemp",
            dataType : "TEXT",
            data : {
              idTransaksi : param2,
              deleted : "TRUE"
      ...
      function deletePengirimanApalTemp(param){
        if (confirm("Apakah Anda Yakin Ingin Menghapus Transaksi Ini?")) {
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deletedAndRestoreTransaksiDetailHistoryApalTemp",
            dataType : "TEXT",
      ...
      function deletePengembalianGudangHasil(param1, param2){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Transaksi Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteAndRestorePengembalianGudangHasil",
            dataType : "TEXT",
      ...
      function deleteTransaksiGudangBuffer(param){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Transaksi Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteAndRestoreTransaksiGudangBufferTemp",
            dataType : "TEXT",
            data : {idTransaksi : param, deleted:"TRUE"},
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
      ...
      function deleteGudangBahan(param){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteGudangBahan",
            dataType : "TEXT",
      ...
      function deletePembelianTemp(param,param2){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url() ?>_gudangkanvas/main/removePembelianTemp",
            dataType : "TEXT",
            data : {rowId:param},
            success : function(response){
              if(jQuery.trim(response) === "Berhasil"){
      ...
      function deleteKoreksiTemp(param,param2){
        if(confirm("Apakah Anda Yakin Ingin Menghapus Data Ini?")){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url(); ?>_gudangkanvas/main/deleteTransaksiGudangBahan",
            dataType : "TEXT",
            data : {id:param},
            success : function(response){
              if(jQuery.trim(response)==="Berhasil"){
      ...
      function deleteAndRestorePermintaanBarang(param, param2){
        ...
        if(confirm(teksKonfirmasi)){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/deleteAndRestorePermintaanBarang'); ?>",
            dataType : "TEXT",
            data : {
              idTransaksi : param,
              deleted     : param2
      ...
      function deleteAndRestoreListDataAwalPending(param, param2, param3){
        ...
        if(confirm(teksKonfirmasi)){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/deleteAndRestoreListDataAwalPending'); ?>",
            dataType : "TEXT",
            data : {
              id : param,
              deleted : param3
      ...
      function deleteAndRestoreDataAwalGudangHasilPending(param, param2, param3){
        ...
        if(confirm(teksKonfirmasi)){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/deleteAndRestoreDataAwalGudangHasilPending'); ?>",
            dataType : "TEXT",
            data : {
              id : param,
              deleted : param3
      ...
      function deleteAndRestoreDetailPermintaanBarang(param, param2, param3){
        ...
        if(confirm(teksKonfirmasi)){
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/deleteAndRestoreDetailPermintaanBarang'); ?>",
            dataType : "TEXT",
            data : {
              idTransaksi  : param,
              kdPermintaan : param2,
      ...
      function resetFormTambahBarangBaru(param,param2=""){
        ...
        $(".date").datepicker("setDate",null);
        $("#txtStokBerat1").removeAttr("readonly");
        $("#txtStokLembar1").removeAttr("readonly");
        $("#btnClose").click();
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getGeneratedGudangHasilCode",
          dataType : "JSON",
          data : {
            jns_brg        : param,
      ...
      function resetFormPengembalianKeStandard(param, param2=""){
        $("input").val("");
        $('#txtKeteranganPengembalian').val("PENGEMBALIAN KE GUDANG "+param2);
        $(".date").datepicker("setDate",null);
        $("#cmbUkuran5").val("").trigger("change");
        $("#btnAddPengembalianBarangStandard").attr("onclick","saveAddPengembalianKeStandard('"+param+"','"+param2+"')").html("<i class='fa fa-plus'></i> Tambah");
        $("#btnSavePengembalianStandard").attr("onclick","savePengembalianKeGudangStandard('"+param2+"')");
      }
      ...
      function resetFormTambahBahanBaku(){
        ...
        $.ajax({
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getGeneratedGudangBahanCode",
          dataType : "JSON",
          success : function(response){
      ...
      function reloadTrashGudangHasil(){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getCountTrashGudangHasil",
          dataType : "JSON",
          success : function(response){
      ...
      function reloadAlert(param,param2,param3){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getCountAlert",
          dataType : "JSON",
      ...
      function reloadAlertPembelian(param,param2){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getCountAlertPembelianGudangBahan",
          dataType : "JSON",
          data : {jenis : param},
          success : function(response){
            if(response[0].Jumlah > 0){
      ...
      function alertPermintaanCatSablon(){
        $.ajax({
          type : "POST",
          url  : "<?php echo site_url('_gudangkanvas/main/countPermintaanCatSablon'); ?>",
          success:function(response){
            if (response>0) {
      ...
      function cariHistoryAnekaMacam(param){
        tglAwal = $("#txtTglAwal1").val();
        tglAkhir = $("#txtTglAkhir1").val();
        kdPack = $("#cmbAnekaMacam").val();
        if(kdPack=="" || kdPack==null){
          $("#modal-notif").addClass("modal-warning");
          $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Dan Bahan Baku Tidak Boleh Kosong!");
          $("#modal-notif").modal("show");
          ...
          var dataText = $("#cmbAnekaMacam").select2("data")[0]["text"];
          var arrDataText = dataText.split(" | ");
          var arrTglAwal = tglAwal.split("-");
          var arrTglAkhir = tglAkhir.split("-");
          var arrMonth = ["Januari","Februari","Maret","April","Mei","Juni",
        ...
        if(tglAwal=="" || tglAkhir=="" || kdPack==""){
          ...
          datatableSearchHistoryAnekaMacamKeluar(param,tglAwal,tglAkhir,kdPack);
          datatableSearchHistoryAnekaMacamMasuk(param,tglAwal,tglAkhir,kdPack);
          $("#modalCariHistoryAnekaMacam").modal("hide");
          $("#masterContainerHasil").css("display","none");
          $("#historyContainerApal").css("display","none");
          $("#historyContainerHasil").css("display","block");
          $("#txtDetailHistory").text("Detail History Masuk Aneka ( "+
                                       arrDataText[1]+" ) Tanggal "+
                                       dateTglAwal.getDate() + " " +
                                       arrMonth[dateTglAwal.getMonth()] + " "+
                                       dateTglAwal.getFullYear() +" - " +
                                       dateTglAkhir.getDate() + " " +
                                       arrMonth[dateTglAkhir.getMonth()] + " "+
                                       dateTglAkhir.getFullYear());
          $("#txtDetailHistory2").text("Detail History Keluar Aneka ( "+
                                       arrDataText[1]+" ) Tanggal "+
                                       dateTglAwal.getDate() + " " +
                                       arrMonth[dateTglAwal.getMonth()] + " "+
                                       dateTglAwal.getFullYear() +" - " +
                                       ...
                                       arrMonth[dateTglAkhir.getMonth()] + " "+
                                       dateTglAkhir.getFullYear());
          $("#btnRefreshTableHistory").attr("onclick","datatableSearchHistoryAnekaMacamMasuk('"+param+"','"+tglAwal+"','"+tglAkhir+"','"+kdPack+"')");
        }
      }
      ...
      function searchDataKartuStok(){
        ...
        if(tglAwal=="" || tglAkhir==""){
          ...
          tableCekKartuStok(tglAwal, tglAkhir);
          $("#btnSortir").attr("onclick","searchDataKartuStokSort('"+tglAwal+"','"+tglAkhir+"')");
          $("#modalCariKartuStok").modal("hide");
        }
      }

      function searchDataKartuStokSort(param, param2){
        if(param=="" || param2==""){
          $("#modal-notif").addClass("modal-warning");
          $("#modalNotifContent").text("Semua Kolom Berwarna Kuning Dan Bahan Baku Tidak Boleh Kosong!");
          $("#modal-notif").modal("show");
          ...
          tableCekKartuStokSort(param, param2);
        }
      }
      ...
      function datatableListPengirimanBaru(param1){
        ...
        $("#tableDataPengirimanBaru").dataTable({
          ...
          "sAjaxSource" : "<?php echo base_url(); ?>_gudangkanvas/main/getListPengirimanBaruDatatable",
          "columns" : [
          ...
          "fnRowCallback" : function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            if(aData["jumlah_kirim"] == 0){
              $("td:eq(10)",nRow).css("background-color","#00c0ef");
            }

            $("td:eq(9)",nRow).text(parseFloat(aData["jumlah"]).toLocaleString()+" "+aData["satuan"]);
            $("td:eq(10)",nRow).text(parseFloat(aData["jumlah_kirim"]).toLocaleString()+" "+aData["satuan"]);
            ...
            $("td:eq(13)",nRow).html("<button class='btn btn-md btn-flat btn-primary margin' onclick=modalKirimPesanan('"+aData["id_dp"]+"')>Kirim</button><button class='btn btn-md btn-flat btn-primary margin' onclick=modalEditStatus('"+aData["id_dp"]+"')>Edit Status</button>");
            if(aData["note"]==null || aData["note"]==""){
              $("td:eq(12)",nRow).html(aData["keterangan"]);
            }else{
              $("td:eq(12)",nRow).html(aData["note"]);
            }
          }
        });
      }
      ...
      function updateStatus(){
        ...
        $.ajax({
          type : "POST",
          url  : "<?php echo site_url('_gudangkanvas/main/updateStatus'); ?>",
      ...
      function datatableListPesananTerkirim(param1){
        ...
        $("#tableDataOrderTerkirim").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType" : "full_numbers",
          "sAjaxSource" : "<?php echo base_url(); ?>_gudangkanvas/main/getListPesananTerkirim",
          "columns" : [
            {"data" : "no_order", "name" : "P.no_order"},
            {"data" : "tgl_pesan", "name" : "P.tgl_pesan"},
            {"data" : "nm_pemesan", "name" : "P.nm_pemesan"},
      ...
      function datatableListPesananBelumTerkirim(){
        ...
        $("#tableDataSisaOrderBelumTerkirim").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType" : "full_numbers",
          "sAjaxSource" : "<?php echo base_url(); ?>_gudangkanvas/main/getListPesananBelumTerkirim",
          "columns" : [
            {"data" : "no_order", "name" : "P.no_order"},
            {"data" : "tgl_pesan", "name" : "P.tgl_pesan"},
      ...
      function tableListPengirimanBaruTemp(){
        $.ajax({
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListPengirimanBaruTemp",
          dataType : "JSON",
          success : function(response){
      ...
      function tableListDetailPengiriman(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListDetailPesananTerkirim",
          dataType : "JSON",
          data : {idDp : param},
          success : function(response){
      ...
      function tabelDaftarBarangAnekaPlastikModal(kd){
          ...
          $.get("<?= base_url('_gudangkanvas/main/getDaftarBarangAnekaPlastik'); ?>",
      ...
      function datatableListBarangPack(param1){
        ...
        $(param1).dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType" : "full_numbers",
          "sAjaxSource" : "<?php echo base_url(); ?>_gudangkanvas/main/getListPack",
          "columns" : [
            {"data" : "kd_produk", "name" : "kd_produk"},
          ...
          "fnRowCallback" : function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            $("td:eq(4)",nRow).html("<button class='btn btn-md btn-flat btn-warning' data-toggle='modal' data-target='#modalEditDataAwal' onclick=modalEditStokPak('"+aData["kd_produk"]+"')><i class='fa fa-edit'></i>Ubah Stock</button>"+
                                    "<button class='btn btn-md btn-flat btn-danger' data-toggle='modal' data-target='#daftarAnekaItem' onclick=tabelDaftarBarangAnekaPlastikModal('"+aData["kd_produk"]+"')><i class='fa fa-list'></i>Daftar Item</button>");
          }
        });
      }

      function modalEditStokPak(kode_produk){
        $.get("<?=base_url('_gudangkanvas/main/getDataAwalPack')?>", {kd_produk:kode_produk}, function(response){
          $.each(response, function(key, value){
            console.log(value);
            console.log(kode_produk);
            $("#kd_pack_awal").val(kode_produk);
            $("#jumlah_pack_awal").val(value.stock);
            $("#jumlah_berat_awal").val(value.berat);
          });
        }, "JSON");
      }
      function updateStockPack(){
        var kd_produk = $("#kode_produk").val();
        var stock = $("#stok-pack").val();

        if(stock == ''){
          alert("tidak boleh kosong");
        } else {
          $.post("<?=base_url('_gudangkanvas/main/updateStockPack')?>", {kd_produk:kd_produk, stock:stock}, function(response){
      ...
      function EditDataAwalPack(){
        var kd_pack = $('#kd_pack_awal').val();
        var jumlah_pack = $('#jumlah_pack_awal').val();
        var jumlah_berat = $('#jumlah_berat_awal').val();
        console.log(jumlah_pack);
        if(jumlah_pack != '' || jumlah_pack.length > 0){
          $.post("<?=base_url('_gudangkanvas/main/updateStockPack')?>",{
            kdPack:kd_pack,
            jumlah_packing:jumlah_pack,
            jumlah_berat:jumlah_berat,
          }, function(response){
            if(response.code == 200){
              alert(response.Text);
      ...
      function datatableListGudangHasil(param1,param2,param3=""){
        ...
        $(param1).dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType" : "full_numbers",
          "sAjaxSource" : "<?php echo base_url(); ?>_gudangkanvas/main/getListGudangHasil",
          "columns" : [
      ...
      function datatableTrashListGudangHasil(){
        ...
        $("#tableTrashGudangHasil").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType" : "full_numbers",
          "sAjaxSource" : "<?php echo base_url(); ?>_gudangkanvas/main/getTrashListGudangHasil",
          "columns" : [
            {"data" : "kd_gd_hasil", "name" : "kd_gd_hasil"},
            {"data" : "ukuran", "name" : "ukuran"},
            {"data" : "stok_berat", "name" : "stok_berat"},
      ...
      function datatableSearchHistoryGudangHasilMasuk(param,tglAwal,tglAkhir,kdGdHasil){
        ...
        $("#tableHistoryGudangHasilMasuk").dataTable({
          ...
          "scrollX" : "100%",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryGudangHasilMasukDatatable",
          "columns":[
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getSaldoAwalGudangHasil",
          dataType : "JSON",
        ...
        $.ajax({
          type : "POST",
          url  : "<?php echo site_url('_gudangkanvas/main/getDataStokMaster'); ?>",
      ...
      function datatableSearchHistoryGudangHasilBufferMasuk(param,tglAwal,tglAkhir,kdGdHasil){
        ...
        $("#tableHistoryGudangHasilMasuk").dataTable({
          ...
          "scrollX" : "100%",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryGudangHasilBufferMasukDatatable",
          "columns":[
            {"data" : "tgl_transaksi","name":"tgl_transaksi"},
            {"data" : "jumlah_berat","name":"jumlah_berat"},
            {"data" : "jumlah_lembar","name":"jumlah_lembar"},
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getSaldoAwalGudangHasilBuffer",
          dataType : "JSON",
          data : {tglAwal:tglAwal,tglAkhir:tglAkhir,kdGdHasil:kdGdHasil},
          success : function(response){
            $("#textSaldoAwalBerat").text("BERAT : "+response.saldoAwalBerat);
            ...
            $("#textKeluarBerat").text("BERAT : "+response.saldoKeluarBerat);
            $("#textKeluarLembar").text("LEMBAR : "+response.saldoKeluarLembar);
            $("#textBeratStok").text("BERAT : "+response.saldoBerat);
            $("#textLembarStok").text("LEMBAR : "+response.saldoLembar);
          }
        });
      }
      function datatableSearchHistoryAnekaMacamMasuk(param,tglAwal,tglAkhir,kdPack){
        $("#tableHistoryAnekaMacamMasuk").css("font-size","14px");
        $("#tableHistoryAnekaMacamMasuk").dataTable().fnDestroy();
        $("#tableHistoryAnekaMacamMasuk").dataTable({
          // "fixedHeader" : true,
          "autoWidth" : false,
          "ordering" : false,
          "bProcessing" : true,
          ...
          "scrollX" : "100%",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryAnekaMacamMasukDatatable",
          "columns":[
            {"data" : "tgl_transaksi","name":"tgl_transaksi"},
            {"data" : "jumlah_berat","name":"jumlah_berat"},
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            if(aData["status_lock"] == "TRUE"){
              ...
              $("td:eq(4)",nRow).html("<button class='btn btn-md btn-flat btn-success' onclick=modalEditHistoryPack('"+param+"','"+aData['id_transaksi']+"','"+tglAwal+"','"+tglAkhir+"','"+kdPack+"')><span class='fa fa-edit'></span> Ubah</button>"+
                                      "<button class='btn btn-md btn-flat btn-danger' onclick=deleteTransaksiPack('ANEKA MACAM','"+aData['id_transaksi']+"','"+tglAwal+"','"+tglAkhir+"','"+kdPack+"')><span class='fa fa-trash'></span> Hapus</button>");
            }
            $("td:eq(4)",nRow).css("background-color","f4f4f4");
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getSaldoAwalAnekaMacam",
          dataType : "JSON",
          data : {tglAwal:tglAwal,tglAkhir:tglAkhir,kdPack:kdPack},
          success : function(response){
            console.log(response);
            $("#textSaldoAwalBerat").text("BERAT : "+response.saldoAwalBerat);
            $("#textSaldoAwalLembar").text("PACK : "+response.saldoAwalKirim);
            $("#textSaldoAkhirBerat").text("BERAT : "+response.saldoAkhirBerat);
            $("#textSaldoAkhirLembar").text("PACK : "+response.saldoAkhirKirim);
            $("#textMasukBerat").text("BERAT : "+response.saldoMasukBerat);
            $("#textMasukLembar").text("PACK : "+response.saldoMasukKirim);
            $("#textKeluarBerat").text("BERAT : "+response.saldoKeluarBerat);
            $("#textKeluarLembar").text("PACK : "+response.saldoKeluarLembar);
          }
        });
      }
      function datatableSearchHistoryGudangHasilKeluar(param,tglAwal,tglAkhir,kdGdHasil){
        ...
        $("#tableHistoryGudangHasilKeluar").dataTable({
          ...
          "scrollX" : "100%",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryGudangHasilKeluarDatatable",
          "columns":[
            {"data" : "tgl_transaksi","name":"tgl_transaksi"},
            {"data" : "jumlah_berat","name":"jumlah_berat"},
            {"data" : "jumlah_lembar","name":"jumlah_lembar"},
      ...
      function datatableSearchHistoryGudangBufferKeluar(param,tglAwal,tglAkhir,kdGdHasil){
        ...
        $("#tableHistoryGudangHasilKeluar").dataTable({
          ...
          "scrollX" : "100%",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryGudangBufferKeluarDatatable",
          "columns":[
            {"data" : "tgl_transaksi","name":"tgl_transaksi"},
            {"data" : "jumlah_berat","name":"jumlah_berat"},
            {"data" : "jumlah_lembar","name":"jumlah_lembar"},
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            if(aData["keterangan"] !="" || aData["keterangan"] !=null ){
              $("td:eq(3)",nRow).html(aData["keterangan_history"]+" <b>[ "+aData["keterangan_barang"]+" ]</b> " + " <b>[ "+aData["customer"]+" ]</b> " + " [ "+aData["keterangan"] + " ]");
            }else{
              $("td:eq(3)",nRow).html(aData["keterangan_history"]+" <b>[ "+aData["customer"]+" ]</b> ");
            }
          }
        });
      ...
      function datatableSearchHistoryAnekaMacamKeluar(param,tglAwal,tglAkhir,kdPack){
        $("#tableHistoryGudangHasilKeluar").css("font-size","14px");
        $("#tableHistoryGudangHasilKeluar").dataTable().fnDestroy();
        $("#tableHistoryGudangHasilKeluar").dataTable({
          // "fixedHeader" : true,
          ...
          "scrollX" : "100%",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryAnekaMacamKeluarDatatable",
          "columns":[
            {"data" : "tgl_transaksi","name":"tgl_transaksi"},
            {"data" : "jumlah_berat","name":"jumlah_berat"},
            {"data" : "jumlah_kirim","name":"jumlah_kirim"},
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            if(aData["status_lock"] == "TRUE"){
              ...
              $("td:eq(4)",nRow).html("<button class='btn btn-md btn-flat btn-success' onclick=modalEditHistoryPack('"+param+"','"+aData['id_transaksi']+"','"+tglAwal+"','"+tglAkhir+"','"+kdPack+"')><span class='fa fa-edit'></span> Ubah</button>"+
                                      "<button class='btn btn-md btn-flat btn-danger' disabled='disabled' onclick=deleteTransaksiGudangHasil('"+param+"','"+aData['id_transaksi']+"','"+tglAwal+"','"+tglAkhir+"','"+kdPack+"')><span class='fa fa-trash'></span> Hapus</button>");
            }
            $("td:eq(4)",nRow).css("background-color","f4f4f4");
        ...
        $.ajax({
          ...
          success : function(response){
            ...
            $("#textMasukLembar").text("PACK : "+response.saldoMasukKirim);
            $("#textKeluarBerat").text("BERAT : "+response.saldoKeluarBerat);
            $("#textKeluarLembar").text("PACK : "+response.saldoKeluarKirim);
          }
        });
      }
      function datatableTrashHistoryGudangHasil(){
        ...
        $("#tableTrashTransaksi").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getTrashListTransaksiGudangHasil",
          "columns":[
            {"data" : "tgl_transaksi","name":"tgl_transaksi"},
            {"data" : "merek","name":"merek"},
            {"data" : "jumlah_berat","name":"jumlah_berat"},
      ...
      function tableListPengambilanSablonTemp(){
        $.ajax({
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListPengambilanSablonTemp",
          dataType : "JSON",
          success : function(response){
      ...
      function tableListPengirimanGudangTemp(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListPengirimanGudangTemp",
          dataType : "JSON",
          data : {stsPengiriman : param},
          success : function(response){
      ...
      function tableListPengirimanApalTemp(){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListKirimanApalTemp",
          dataType : "JSON",
          success : function(response){
      ...
      function tableListPengembalianGudangHasil(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListPengembalianBarang",
          dataType : "JSON",
          data : {statusBarang : param},
          success : function(response){
      ...
      function tableListPembelianBarangHd(){
        $.ajax({
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListPembelianBarangHdTemp",
          dataType : "JSON",
          success : function(response){
      ...
      function datatableSearchHistoryGudangApal(tglAwal,tglAkhir,kdGudangApal){
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getSaldoAwalBulanGudangApal",
          dataType : "JSON",
      ...
      function tableListKoreksiGudangBufferTemp(){
        $.ajax({
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListKoreksiGudangBufferTemp",
          dataType : "JSON",
          success : function(response){
      ...
      function tableListKoreksiPackTemp(){
        $.ajax({
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListKoreksiPackTemp",
          dataType : "JSON",
          success : function(response){
            $("#tableListKoreksiPackTemp > tbody > tr").empty();
            $.each(response, function(AvIndex, AvValue){
              $("#tableListKoreksiPackTemp > tbody:last-child").append(
                "<tr>"+
                  "<td>"+ ++AvIndex +"</td>"+
                  "<td>"+AvValue.tgl_transaksi+"</td>"+
                  "<td>"+AvValue.jumlah_berat+"</td>"+
                  "<td>"+AvValue.jumlah_kirim+"</td>"+
                  "<td>"+AvValue.keterangan_history+"</td>"+
                  "<td>"+
                    "<button class='btn btn-md btn-flat btn-warning' onclick=modalEditKoreksiPack('"+AvValue.id_transaksi+"')>Ubah</button>"+
                    "<button class='btn btn-md btn-flat btn-danger' onclick=deleteTransaksiPack('','"+AvValue.id_transaksi+"')>Hapus</button>"+
                  "</td>"+
                "</tr>"
              );
            });
      ...
      function tableListPengembalianGudangBuffer(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url() ?>_gudangkanvas/main/getListPengembalianBarangGudangBufferKeStandardTemp",
          dataType : "JSON",
          data : {
            jnsGudang : param
          },
      ...
      function datatableListPengeluaranGudangHasil(param1, param2, param3=""){
        ...
        $(param1).dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListPengeluaranGudangHasil",
          "columns":[
      ...
      function datatableKirimanDariBagian(param1, param2, param3=""){
        ...
        $("#tableListKirimanDariBagian"+param2).dataTable({
          ...
          "autoWidth" : false,
					...
					"sPaginationType" : "full_numbers",
					"scrollX" : "100%",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListKirimanDariBagian",
          "columns":[
            {"data" : "id_permintaan_jadi","name":"id_permintaan_jadi"},
            {"data" : "tgl_transaksi","name":"tgl_transaksi"},
            {"data" : "ukuran","name":"ukuran"},
      ...
      function datatableKirimanUntukGudangKanvas(param1){
        $("#tableListKirimanDariGudangStandard_"+param1).css("font-size","14px");
        $("#tableListKirimanDariGudangStandard_"+param1).dataTable().fnDestroy();
        $("#tableListKirimanDariGudangStandard_"+param1).dataTable({
          // "fixedHeader" : true,
          "autoWidth" : false,
					"ordering" : false,
					"bProcessing" : true,
					...
					"sPaginationType" : "full_numbers",
					"scrollX" : "100%",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListKirimanUntukGudangKanvas",
          "columns":[
            {"data" : "id_permintaan_jadi","name":"id_permintaan_jadi"},
            {"data" : "tgl_transaksi","name":"tgl_transaksi"},
            {"data" : "ukuran","name":"ukuran"},
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            $("td:eq(0)",nRow).text(++iDisplayIndex);
            $("td:eq(3)",nRow).text(parseFloat(aData["jumlah_berat"]).toLocaleString());
            $("td:eq(4)",nRow).text(parseFloat(aData["jumlah_lembar"]).toLocaleString());
      ...
      function datatableListCatMurni(){
        ...
        $("#tableDataMasterCatMurni").dataTable({
          ...
          "scrollY" : "500px",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListGudangBahanDatatable",
          "columns":[
      ...
      function tableListPembelianBahanBakuTemp(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getPembelianGudangBahanTemp",
          dataType : "JSON",
          data : {
            jenis : param
          },
      ...
      function datatableSearchHistoryCatMurni(tglAwal,tglAkhir,kdBahanBaku){
        ...
        $("#tableDataHistoryCatMurni").dataTable({
          ...
          "scrollY" : "500px",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryGudangBahan",
          "columns":[
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            if(aData["status_lock"] == "TRUE"){
              ...
              $("td:eq(3)",nRow).html("<button class='btn btn-md btn-flat btn-success' onclick=modalEditHistoryCat('CAT_MURNI','"+aData['id']+"','"+tglAwal+"','"+tglAkhir+"','"+kdBahanBaku+"')><span class='fa fa-edit'></span> Ubah</button>"+
        ...
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getSaldoAwalBulanGudangBahan",
          dataType : "JSON",
      ...
      function tableListKoreksi(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getKoreksiTemp",
          dataType : "JSON",
          data : {jenis:param},
          success : function(response){
      ...
      function tablePengeluaranGudangBahan(param){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getPengeluaranGudangBahanTemp",
          dataType : "JSON",
          data : {jenis:param},
          success : function(response){
      ...
      function datatableDataPermintaan(){
        ...
        $("#tableDataPermintaan").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getPermintaanBarang",
          "columns":[
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            $("td:eq(5)",nRow).html("<button class='btn btn-md btn-flat btn-primary' onclick=modalLihatDetailPermintaan('"+aData["kd_permintaan_barang"]+"')>Lihat Permintaan</button>"+
                                    "<a href='<?php echo base_url('_gudangkanvas/main/printBonPermintaanBarang/') ?>"+aData["kd_permintaan_barang"]+"' target='_blank' class='btn btn-md btn-flat btn-success'>Cetak Bon Permintaan</a>"+
      ...
      function datatablesDetailPermintaan(param=""){
        ...
        $("#tableDetailPermintaan").dataTable({
          ...
          "scrollY" : "720px",
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getDetailPermintaanBaru",
          "columns":[
          ...
          "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            ...
            if(aData["status_permintaan"] == "PENDING"){
              $("td:eq(8)",nRow).html("<button class='btn btn-md btn-flat btn-default'><i class='fa fa-lock'></i> Permintaan Belum Disetujui Oleh Purchasing</button>"+
                                      ...
                                      "<a href='<?php echo base_url('_gudangkanvas/main/printBonPermintaanBarang/') ?>"+aData["kd_permintaan_barang"]+"' target='_blank' class='btn btn-md btn-flat bg-purple'>Cetak Bon Permintaan</a>");
      ...
      function datatableListApproveBahanBakuExtruder(param,param2){
        ...
        $("#tableDataApproveGudangBahan").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getTransaksiGudangBahanForApproveDataTable",
          "columns":[
      ...
      function tableCekKartuStok(param, param2){
        var group = "<?php echo $this->session->userdata('fabricationGroup');?>";
        $.ajax({
          type : "POST",
          url : "<?php echo base_url('_gudangkanvas/main/getCekKartuStok'); ?>",
          dataType : "JSON",
          data : {
            tglAwal : param,
            tglAkhir : param2
          ...
          success : function(response){
            var totalJumlahBeratMasukPerPeriode = 0;
            var totalJumlahLembarMasukPerPeriode = 0;

            var totalJumlahBeratKeluarPerPeriode = 0;
            var totalJumlahLembarKeluarPerPeriode = 0;
            var arrTglPeriode = param2.split("-");
            var periode = arrTglPeriode[0]+"-"+arrTglPeriode[1];
            ...
            $.each(response.dataMaster, function(AvIndex, AvValue){
              ...
              var attr = "onclick=checkedAndUnchecked(this,'TRUE','','"+periode+"')";
              var icon = "<i class='fa fa-square-o'></i>";

              $.each(response.dataCheklist, function(AvIndex2, AvValue2){
                if(AvValue2.kd_gd_hasil == kdGdHasil){
                  if(AvValue2.ceklis == "FALSE"){
                    if(group == "gudang hasil"){
                      attr = "";
                    }else{
                      attr = "onclick=checkedAndUnchecked(this,'TRUE','"+AvValue2.id_ceklis_gh+"','"+periode+"')";
                    }
                    ...
                    if(group == "gudang hasil"){
                      ...
                      attr = "onclick=checkedAndUnchecked(this,'FALSE','"+AvValue2.id_ceklis_gh+"','"+periode+"')";
                    }
              ...
              $.each(response.saldoPerPeriode, function(AvIndex3, AvValue3){
                if(AvValue3.kd_gd_hasil == kdGdHasil){
                  ...
                  totalJumlahBeratMasukPerPeriode += totalBeratMasukPerPeriode;
                  totalJumlahLembarMasukPerPeriode += totalLembarMasukPerPeriode;
                  totalJumlahBeratKeluarPerPeriode += totalBeratKeluarPerPeriode;
                  totalJumlahLembarKeluarPerPeriode += totalLembarKeluarPerPeriode;
                }
              });

              if(totalBeratMasukPerPeriode > 0 ||
                 totalLembarMasukPerPeriode > 0 ||
                 totalBeratKeluarPerPeriode > 0 ||
                 totalLembarKeluarPerPeriode > 0 ||
                 saldoAwalBerat > 0 ||
                 saldoAwalLembar > 0
               ){
               $("#tableDataKartuStok > tbody:last-child").append(
                 "<tr>"+
                   ...
                   "<td>"+
                     "<input type='checkbox' name='ceklis' value='"+AvValue.kd_gd_hasil+"|"+saldoAkhirBerat+"|"+saldoAkhirLembar+"'> "+
                     "<button class='btn btn-sm btn-default btn-flat' "+attr+" id='"+AvValue.kd_gd_hasil+"'>"+icon+"</button>"+
                   "</td>"+
                 "</tr>"
               );
              }
            ...
            $("#tableDataKartuStok > tbody:last-child").append(
              "<tr style='background-color : rgba(0, 44, 253, 0.7); color : #FFF;'>"+
                "<td></td>"+
                "<td></td>"+
                "<td></td>"+
                "<td></td>"+
                "<td></td>"+
                "<td></td>"+
                "<td>"+ totalJumlahBeratMasukPerPeriode.toLocaleString() +"</td>"+
                "<td>"+ totalJumlahLembarMasukPerPeriode.toLocaleString() +"</td>"+
                "<td>"+ totalJumlahBeratKeluarPerPeriode.toLocaleString() +"</td>"+
                "<td>"+ totalJumlahLembarKeluarPerPeriode.toLocaleString() +"</td>"+
                "<td></td>"+
                "<td></td>"+
              "</tr>"
            );
      ...
      function tableListTambahBahanSablon(){
        $.ajax({
          url : "<?php echo base_url() ?>_gudangkanvas/main/getTempDataBahanSablon",
          dataType : "JSON",
          success : function(response){
      ...
      function datatableBahanSablon(){
        ...
        $("#tableDataBahanSablon").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListBahanSablon",
          "columns":[
      ...
      function datatableHistoryBahanSablonKeluar(param1,param2,param3){
        ...
        $("#tableHistoryBahanSablonKeluar").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryBahanSablonKeluar",
          "columns":[
      ...
      function datatableHistoryBahanSablonMasuk(param1,param2,param3){
        ...
        $("#tableHistoryBahanSablonMasuk").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListHistoryBahanSablonMasuk",
          "columns":[
            {"data" : "kd_gd_bahan","name":"kd_gd_bahan"},
            {"data" : "tgl_permintaan","name":"tgl_permintaan"},
            {"data" : "jumlah_permintaan","name":"jumlah_permintaan"},
      ...
      function tableListPermintaanBahanSablon(){
        $.ajax({
          url : "<?php echo base_url() ?>_gudangkanvas/main/getTempDataPermintaanBahanSablon",
          dataType : "JSON",
          success : function(response){
      ...
      function datatableDetailHasilJadi(param1,param2){
        ...
        $("#tableDetailHasilJadi").dataTable({
          ...
          "bServerSide" : true,
          "sPaginationType": "full_numbers",
          "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListDetailHasilJadi",
      ...
      function tableListDataAwalPending(jenis){
        $.ajax({
          type : "POST",
          url  : "<?php echo base_url() ?>_gudangkanvas/main/getListDataAwalPending",
          data : {jenis:jenis},
          dataType : "JSON",
          success : function(response){
      ...
      function tableListDataAwalGudangHasilPending(jenis){
        $.ajax({
          type : "POST",
          url : "<?php echo base_url('_gudangkanvas/main/getListDataAwalGudangHasilPending'); ?>",
          dataType : "JSON",
          data : {
            stsBarang : jenis
          },
      ...
      function tableCekKartuStokSort(param, param2){
        var group = "<?php echo $this->session->userdata('fabricationGroup'); ?>";
        ...
        if(havingStokMaster=="" && havingStokAwal=="" && havingStokAkhir==""){
          tableCekKartuStok(param, param2);
        }else{
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/getCekKartuStokSort'); ?>",
            dataType : "JSON",
            data : {
              tglAwal : param,
              tglAkhir : param2,
            ...
            success : function(response){
              ...
              var arrTglAkhir = param2.split("-");
              var periode = arrTglAkhir[0]+"-"+arrTglAkhir[1];
              $("#tableDataKartuStok > tbody > tr").empty();
              $.each(response.saldo, function(AvIndex, AvValue){
                ...
                totalJumlahBeratMasukPerPeriode += parseFloat(AvValue.totalBeratMasukPerPeriode);
                totalJumlahLembarMasukPerPeriode += parseFloat(AvValue.totalLembarMasukPerPeriode);
                totalJumlahBeratKeluarPerPeriode += parseFloat(AvValue.totalBeratKeluarPerPeriode);
                totalJumlahLembarKeluarPerPeriode += parseFloat(AvValue.totalLembarKeluarPerPeriode);

                if(parseFloat(AvValue.totalBeratMasukPerPeriode) > 0 ||
                   parseFloat(AvValue.totalLembarMasukPerPeriode) > 0 ||
                   parseFloat(AvValue.totalBeratKeluarPerPeriode) > 0 ||
                   parseFloat(AvValue.totalLembarKeluarPerPeriode) > 0 ||
                   parseFloat(AvValue.saldoAwalBerat) > 0 ||
                   parseFloat(AvValue.saldoAwalLembar) > 0
                 ){
                 $("#tableDataKartuStok > tbody:last-child").append(
                   "<tr>"+
                     "<td>"+ ++AvIndex +"</td>"+
                     ...
                     "<td>"+
                       "<input type='checkbox' name='ceklis' value='"+AvValue.kd_gd_hasil+"|"+AvValue.saldoAkhirBerat+"|"+AvValue.saldoAkhirLembar+"'> "+
                       "<button class='btn btn-sm btn-default btn-flat' "+attr+" id='"+AvValue.kd_gd_hasil+"'>"+icon+"</button>"+
                     "</td>"+
                   "</tr>"
                 );
      ...
      function tableListPengambilanKanvasTemp(param){
        $.ajax({
          type : "GET",
          url : "<?php echo base_url(); ?>_gudangkanvas/main/getListPengambilanKanvasTemp",
          data : {
            jnsGudang : param
          },
          dataType : "JSON",
            ...
            $.each(response,function(index,value){
              $("#tablePengambilanSablonTemp > tbody:last-child").append(
                "<tr>"+
                  ...
                  "<td>"+value.tgl_pengambilan+"</td>"+
                  "<td>"+value.ukuran+"</td>"+
                  "<td>"+parseFloat(value.jumlah_berat).toLocaleString()+"</td>"+
                  "<td>"+parseFloat(value.jumlah_lembar).toLocaleString()+"</td>"+
                  "<td>"+value.warna_plastik+"</td>"+
                  "<td>"+value.merek+"</td>"+
                  "<td>"+value.jns_permintaan+"</td>"+
                  "<td><button class='btn btn-md btn-flat btn-danger' onclick=deletePengambilanKanvasTemp('"+value.id_pengambilan_kanvas+"','"+param+"')><i class='fa fa-trash'></i> Hapus</button></td>"+
                "</tr>"
              )
            });
          },
      ...
      <script type="text/javascript">
        function datatableKembalianHDSablon(){
          ...
          $("#tableListKembalianHDSablon").dataTable({
            ...
            "bServerSide" : true,
            "sPaginationType": "full_numbers",
            "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListKembalianHDSablon",
            "columns":[
              {"data" : "id_permintaan_jadi","name":"id_permintaan_jadi"},
              {"data" : "tgl_transaksi","name":"tgl_transaksi"},
              {"data" : "ukuran","name":"ukuran"},
      ...
      <script type="text/javascript">
        function approveKembalianHDSablon(){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/approveKembalianHDSablon'); ?>",
            data :{},
            success:function(response){
              if (jQuery.trim(response) == "Success") {
                datatableKembalianHDSablon();
      ...
      <script type="text/javascript">
        function datatableBarangRetur(param){
          ...
          $("#tableDataBarangRetur").dataTable({
            ...
            "bServerSide" : true,
            "sPaginationType": "full_numbers",
            "sAjaxSource":"<?php echo base_url(); ?>_gudangkanvas/main/getListDataBarangRetur",
            "columns":[
              {"data" : "id_permintaan_jadi","name":"id_permintaan_jadi"},
              {"data" : "tgl_transaksi","name":"tgl_transaksi"},
              {"data" : "customer","name":"customer"},
      ...
      <script type="text/javascript">
        function approve_returBarang(param){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/approveReturBarang'); ?>",
            data : {param:param},
            success:function(response){
              if (jQuery.trim(response) == "Success") {
      ...
      <script type="text/javascript">
        function alertReturBarang(jenis){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/countReturBarang'); ?>",
            data : {jenis:jenis},
            success:function(response){
              if (response>0) {
      ...
      <script type="text/javascript">
        ...
        function deletedListRetur(id){
          ...
          if (r==true) {
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('_gudangkanvas/main/deletedListRetur'); ?>",
              data : {id:id},
              success:function(response){
                if (jQuery.trim(response)=="Success"){
                  alertReturBarang(param);
      ...
      <script type="text/javascript">
        function getKodeBahanSablon(){
          ...
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/genKodeBahanSablon'); ?>",
            success:function(response){
        ...
        function getBahanSablon(){
          ...
          if (!jenis) {
            ...
            $("#namaBahanSablon").select2({
              ...
              allowClear:true,
              ajax:{
                url : "<?php echo base_url(); ?>_gudangkanvas/main/getBahanSablon/"+jenis,
                dataType : "JSON",
                delay : 0,
                processResults : function(data){
                  return{
        ...
        function addBahanSablon(){
          ...
          if (!kode||!jenis||!nama||!stok||!tgl) {
            ...
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('_gudangkanvas/main/addBahanSablon'); ?>",
        ...
        function deleteListTempBahanSablon(id){
          ...
          if (r==true) {
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('_gudangkanvas/main/deleteListTempBahanSablon'); ?>",
              data : {id:id},
              success:function(response){
                if (jQuery.trim(response)=="Success"){
                  getKodeBahanSablon()
        ...
        function saveBahanSablon(){
          $.ajax({
            type : "POST",
            url  : "<?php site_url("_gudangkanvas/main/countListTambahBahanSablon"); ?>",
            success:function(num){
              if (num>0) {
                $.ajax({
                  type : "POST",
                  url  : "<?php echo site_url('_gudangkanvas/main/saveBahanSablon'); ?>",
                  success:function(response){
                    if (jQuery.trim(response)=="Success"){
                      datatableBahanSablon()
        ...
        function alertKirimanBahanSablon(){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/countKirimanBahanSablon') ?>",
            success:function(response){
              if (response>0) {
        ...
        function modalKirimanBahanSablon(){
          $.ajax({
            url : "<?php echo base_url() ?>_gudangkanvas/main/getDataKirimanBahanSablon",
            dataType : "JSON",
            success : function(response){
        ...
        function approveKirimanBahanSablon(){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url("_gudangkanvas/main/approveKirimanBahanSablon"); ?>",
            success:function(response){
              if (jQuery.trim(response)=="Success"){
                datatableBahanSablon()
                alertKirimanBahanSablon()
        ...
        function deleteBahanSablon(id){
          ...
          if (r==true) {
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('_gudangkanvas/main/deleteBahanSablon'); ?>",
              data : {id:id},
              success:function(response){
                if (jQuery.trim(response)=="Success"){
                  datatableBahanSablon()
        ...
        function editListBahanSablon(id){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/editListBahanSablon') ?>",
            data : {id:id},
            dataType : "JSON",
            success:function(response){
        ...
        function updateListBahanSablon(){
          ...
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/updateListBahanSablon'); ?>",
        ...
        $("#cariJenis").on("change",function(){
          ...
          if (!jenis) {
            ...
            $("#cariBahan").select2({
              ...
              allowClear:true,
              ajax:{
                url : "<?php echo base_url(); ?>_gudangkanvas/main/getBahanSablonFull/"+jenis,
                dataType : "JSON",
                delay : 0,
                processResults : function(data){
                  return{
        ...
        function cariHistoryBahanSablon(){
          ...
          if (!tglAwal||!tglAkhir||!jenis||!bahan) {
            ...
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url("_gudangkanvas/main/getDetailHistoryBahanSablon"); ?>",
        ...
        function getPermintaanBahanSablon(){
          ...
          if (!jenis) {
            ...
            $("#BahanSablon").select2({
              ...
              allowClear:true,
              ajax:{
                url : "<?php echo base_url(); ?>_gudangkanvas/main/getPermintaanBahanSablon/"+jenis,
                dataType : "JSON",
                delay : 0,
                processResults : function(data){
                  return{
        ...
        function addPermintaanBahanSablon(){
          ...
          if (!jenis||!nmBahan||!jumlah||!tanggal) {
            ...
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('_gudangkanvas/main/addPermintaanBahanSablon'); ?>",
        ...
        function deleteListPermintaanBahanSablon(id){
          ...
          if (r==true) {
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('_gudangkanvas/main/deleteListPermintaanBahanSablon'); ?>",
              data : {id:id},
              success:function(response){
                if (jQuery.trim(response)=="Success"){
                  tableListPermintaanBahanSablon()
        ...
        function kirimPermintaanBahanSablon(){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url("_gudangkanvas/main/countPermintaanBahanSablonPending") ?>",
            success:function(num){
              if (num>0) {
                $.ajax({
                  type : "POST",
                  url  : "<?php echo site_url('_gudangkanvas/main/kirimPermintaanBahanSablon'); ?>",
                  success:function(response){
                    if (jQuery.trim(response)=="Success"){
                      tableListPermintaanBahanSablon()
        ...
        function editKekuranganKelebihan(id){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/getKirimanPotongPerId');?>",
            data : {id:id},
            dataType : "JSON",
            success:function(response){
        ...
        function kirimBalikKiriman(){
          ...
          if (!note) {
            ...
            $.ajax({
            type : "POST",
            url  : "<?Php echo site_url('_gudangkanvas/main/kirimBalikKiriman'); ?>",
        ...
        function alertKirimanBarangKeGudangBuffer(){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/countKirimanBarangKeGudangBuffer'); ?>",
            success:function(num){
              if (num>0) {
        ...
        function alertKirimanBarang(param1,param2,param3=""){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/countKirimanBarang');?>",
        ...
        function alertKembalianHDSablon(){
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('_gudangkanvas/main/countKembalianHDSablon') ?>",
            success:function(response){
              if (response>0) {
        ...
        function deleteDataOrderTerkirim(id){
          ...
          if (confirm("Hapus data terkirim..?")) {
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('_gudangkanvas/main/deleteDataOrderTerkirim') ?>",
              data : {id:id},
              success:function(response){
                if(jQuery.trim(response) === "Success"){
                  datatableListPesananTerkirim(param="");
        ...
        function checkedAndUnchecked(param, param2, param3="", param4=""){
          if(param2 == "TRUE"){
            $("#"+param.id).html("<i class='fa fa-check-square-o'></i>").attr("onclick","checkedAndUnchecked(this,'FALSE','"+param3+"','"+param4+"')");
          }else{
            $("#"+param.id).html("<i class='fa fa-square-o'></i>").attr("onclick","checkedAndUnchecked(this,'TRUE','"+param3+"','"+param4+"')");
          }
          $.ajax({
            type : "POST",
            url : "<?php echo base_url('_gudangkanvas/main/updateCheckList'); ?>",
            dataType : "TEXT",
            data : {
              kdGdHasil : param.id,
              ceklis : param2,
        ...
        function perbaruiStokMaster(){
  				var arrValue = $("input[name='ceklis']:checked").serializeArray();
  				if(arrValue.length > 0){
  					if(confirm("Apakah Anda Yakin Ingin Perbarui Stok Master?")){
  						$.ajax({
  							type : "POST",
  							url : "<?php echo base_url('_gudangkanvas/main/perbaruiStokMaster'); ?>",
  							dataType : "TEXT",
  							data : {
  								arrValue : arrValue
  							},
  							success : function(response){
  								if($.trim(response) === "Berhasil"){
  									$("#modal-notif").addClass("modal-info");
  									$("#modalNotifContent").text("Data Stok Master Telah Diperbarui");
  									$("#modal-notif").modal("show");
  									setTimeout(function(){
  										$("#modal-notif").modal("hide");
  										$("#modal-notif").removeClass("modal-info");
  									...
  									$("#modal-notif").addClass("modal-danger");
  									$("#modalNotifContent").text("Data Stok Master Gagal Diperbarui");
  									$("#modal-notif").modal("show");
  									setTimeout(function(){
  										$("#modal-notif").modal("hide");
  										$("#modal-notif").removeClass("modal-danger");
  					...
  					$("#modal-notif").addClass("modal-warning");
  					$("#modalNotifContent").text("Anda Belum Memilih Barang Apapun!");
  					$("#modal-notif").modal("show");
  					setTimeout(function(){
  						$("#modal-notif").modal("hide");
  						$("#modal-notif").removeClass("modal-warning");
