    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          ...
          ?>
          <button type="button" class="btn btn-md btn-flat btn-warning" data-toggle="modal" data-backdrop="static" data-target="#modalCariHistory" onclick="modalCariHistory('ONLINE')"><i class="fa fa-search"></i> Cari History</button>
          ...
          <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-backdrop="static" data-target="#modalKoreksiGudangHasil" onclick="modalKoreksiGudangHasil('ONLINE')"><i class="fa fa-pencil"></i> Koreksi Online</button>
          ...
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-backdrop="static" data-target="#modalPengembalianStandard" onclick="modalPengembalianBarangStandard('ONLINE','','STANDARD')"><i class="fa fa-plus"></i> Tambah Pengembalian Ke Standard</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-backdrop="static" data-target="#modalPengembalianStandard" onclick="modalPengembalianBarangStandard('ONLINE','','CAMPUR')"><i class="fa fa-plus"></i> Tambah Pengembalian Ke Campur</button>
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalPengembalianStandard" onclick="modalPengembalianBarangStandard('ONLINE','','SABLON')" style="margin-top:5px;"><i class="fa fa-plus"></i> Tambah Pengembalian Ke Sablon</button>
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahDataAwal" onclick="modalTambahDataAwalGudangHasil('ONLINE')" style="margin-top:5px;"><i class="fa fa-plus"></i> Tambah Data Awal</button>
        ...
        <div class="col-md-12" style="margin-top:10px;"  id="masterContainerHasil">
          <h3>Stok Plastik</h3>
          <table class="table table-responsive table-striped" id="tableDataMasterGudangOnline">
            <thead>
              <th>Kode</th>
              <th>Ukuran</th>
              <th>Merek</th>
