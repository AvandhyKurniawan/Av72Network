                  ...
                  <fieldset>
                    ...
                    <table class="table table-responsive">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtJumlahOrder" class="form-control numberFive" placeholder="Jumlah Order" readonly>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtJumlahPerKg" class="form-control numberFive" placeholder="Satuan KG">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtJumlahPerLembar" class="form-control numberFive" placeholder="Satuan Lembar">
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="form-group has-warning">
                            <input type="text" id="txtJumlahDikirim" class="form-control numberFive" placeholder="Satuan Sesuai Pesanan">
                          </div>
                        </td>
                      </tr>
                      <tr>
                    ...
                    <input type="hidden" id="txtKdPack" value="">
                  </fieldset>
                </div>
                <div class="col-md-12">
                  <fieldset>
